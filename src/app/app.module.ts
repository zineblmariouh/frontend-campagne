...
import {ArchivableChercheurRoutingModule} from './module/chercheur/view/archivable/archivable-routing.module';
import {ArchivableAdminRoutingModule} from './module/admin/view/archivable/archivable-routing.module';
@NgModule({
  imports: [
    ButtonModule,
    PasswordModule,
