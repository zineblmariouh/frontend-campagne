...
public async archiverCommanditaire(commanditaire:CommanditaireVo){
const isPermistted = await this.roleService.isPermitted('Commanditaire', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Commanditaire) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.commanditaireService.archiver(commanditaire).subscribe(status=>{
const myIndex = this.commanditaires.indexOf(commanditaire);
this.commanditaires[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Commanditaire archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverCommanditaire(commanditaire:CommanditaireVo){
const isPermistted = await this.roleService.isPermitted('Commanditaire', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Commanditaire) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.commanditaireService.desarchiver(commanditaire).subscribe(status=>{
const myIndex = this.commanditaires.indexOf(commanditaire);
this.commanditaires[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Commanditaire désarchivé',
life: 3000
});
},error=>console.log(error))
 }
