...
@Component({
  ...
  templateUrl: './commission-scientifique-edit-admin.component.html',
  styleUrls: ['./commission-scientifique-edit-admin.component.css']
})
export class CommissionScientifiqueEditAdminComponent implements OnInit {
