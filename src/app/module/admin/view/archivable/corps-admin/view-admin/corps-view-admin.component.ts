...
@Component({
  selector: 'app-corps-view-admin',
  templateUrl: './corps-view-admin.component.html',
  styleUrls: ['./corps-view-admin.component.css']
})
export class CorpsViewAdminComponent implements OnInit {
