...
public async archiverDepartementScientifique(departementScientifique:DepartementScientifiqueVo){
const isPermistted = await this.roleService.isPermitted('DepartementScientifique', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Departement scientifique) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.departementScientifiqueService.archiver(departementScientifique).subscribe(status=>{
const myIndex = this.departementScientifiques.indexOf(departementScientifique);
this.departementScientifiques[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Departement scientifique archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverDepartementScientifique(departementScientifique:DepartementScientifiqueVo){
const isPermistted = await this.roleService.isPermitted('DepartementScientifique', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Departement scientifique) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.departementScientifiqueService.desarchiver(departementScientifique).subscribe(status=>{
const myIndex = this.departementScientifiques.indexOf(departementScientifique);
this.departementScientifiques[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Departement scientifique désarchivé',
life: 3000
});
},error=>console.log(error))
 }
