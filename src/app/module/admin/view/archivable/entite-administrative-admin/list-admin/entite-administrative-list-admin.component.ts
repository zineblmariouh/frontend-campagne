...
public async archiverEntiteAdministrative(entiteAdministrative:EntiteAdministrativeVo){
const isPermistted = await this.roleService.isPermitted('EntiteAdministrative', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Entite administrative) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.entiteAdministrativeService.archiver(entiteAdministrative).subscribe(status=>{
const myIndex = this.entiteAdministratives.indexOf(entiteAdministrative);
this.entiteAdministratives[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Entite administrative archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverEntiteAdministrative(entiteAdministrative:EntiteAdministrativeVo){
const isPermistted = await this.roleService.isPermitted('EntiteAdministrative', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Entite administrative) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.entiteAdministrativeService.desarchiver(entiteAdministrative).subscribe(status=>{
const myIndex = this.entiteAdministratives.indexOf(entiteAdministrative);
this.entiteAdministratives[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Entite administrative désarchivé',
life: 3000
});
},error=>console.log(error))
 }
