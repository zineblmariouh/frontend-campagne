...
public async archiverEtablissementProjet(etablissementProjet:EtablissementProjetVo){
const isPermistted = await this.roleService.isPermitted('EtablissementProjet', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Etablissement projet) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.etablissementProjetService.archiver(etablissementProjet).subscribe(status=>{
const myIndex = this.etablissementProjets.indexOf(etablissementProjet);
this.etablissementProjets[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Etablissement projet archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverEtablissementProjet(etablissementProjet:EtablissementProjetVo){
const isPermistted = await this.roleService.isPermitted('EtablissementProjet', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Etablissement projet) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.etablissementProjetService.desarchiver(etablissementProjet).subscribe(status=>{
const myIndex = this.etablissementProjets.indexOf(etablissementProjet);
this.etablissementProjets[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Etablissement projet désarchivé',
life: 3000
});
},error=>console.log(error))
 }
