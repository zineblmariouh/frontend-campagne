...
public async archiverFinancementDoctorant(financementDoctorant:FinancementDoctorantVo){
const isPermistted = await this.roleService.isPermitted('FinancementDoctorant', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Financement doctorant) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.financementDoctorantService.archiver(financementDoctorant).subscribe(status=>{
const myIndex = this.financementDoctorants.indexOf(financementDoctorant);
this.financementDoctorants[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Financement doctorant archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverFinancementDoctorant(financementDoctorant:FinancementDoctorantVo){
const isPermistted = await this.roleService.isPermitted('FinancementDoctorant', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Financement doctorant) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.financementDoctorantService.desarchiver(financementDoctorant).subscribe(status=>{
const myIndex = this.financementDoctorants.indexOf(financementDoctorant);
this.financementDoctorants[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Financement doctorant désarchivé',
life: 3000
});
},error=>console.log(error))
 }
