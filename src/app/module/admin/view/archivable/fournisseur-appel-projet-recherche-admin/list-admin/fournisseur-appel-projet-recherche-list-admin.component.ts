...
@Component({
  ...
  templateUrl: './fournisseur-appel-projet-recherche-list-admin.component.html',
  styleUrls: ['./fournisseur-appel-projet-recherche-list-admin.component.css']
})
...
public async archiverFournisseurAppelProjetRecherche(fournisseurAppelProjetRecherche:FournisseurAppelProjetRechercheVo){
const isPermistted = await this.roleService.isPermitted('FournisseurAppelProjetRecherche', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Fournisseur appel projet recherche) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.fournisseurAppelProjetRechercheService.archiver(fournisseurAppelProjetRecherche).subscribe(status=>{
const myIndex = this.fournisseurAppelProjetRecherches.indexOf(fournisseurAppelProjetRecherche);
this.fournisseurAppelProjetRecherches[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Fournisseur appel projet recherche archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverFournisseurAppelProjetRecherche(fournisseurAppelProjetRecherche:FournisseurAppelProjetRechercheVo){
const isPermistted = await this.roleService.isPermitted('FournisseurAppelProjetRecherche', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Fournisseur appel projet recherche) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.fournisseurAppelProjetRechercheService.desarchiver(fournisseurAppelProjetRecherche).subscribe(status=>{
const myIndex = this.fournisseurAppelProjetRecherches.indexOf(fournisseurAppelProjetRecherche);
this.fournisseurAppelProjetRecherches[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Fournisseur appel projet recherche désarchivé',
life: 3000
});
},error=>console.log(error))
 }
