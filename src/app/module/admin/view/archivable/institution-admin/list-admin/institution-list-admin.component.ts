...
public async archiverInstitution(institution:InstitutionVo){
const isPermistted = await this.roleService.isPermitted('Institution', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Institution) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.institutionService.archiver(institution).subscribe(status=>{
const myIndex = this.institutions.indexOf(institution);
this.institutions[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Institution archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverInstitution(institution:InstitutionVo){
const isPermistted = await this.roleService.isPermitted('Institution', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Institution) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.institutionService.desarchiver(institution).subscribe(status=>{
const myIndex = this.institutions.indexOf(institution);
this.institutions[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Institution désarchivé',
life: 3000
});
},error=>console.log(error))
 }
