...
public async archiverMasterInternational(masterInternational:MasterInternationalVo){
const isPermistted = await this.roleService.isPermitted('MasterInternational', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Master international) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.masterInternationalService.archiver(masterInternational).subscribe(status=>{
const myIndex = this.masterInternationals.indexOf(masterInternational);
this.masterInternationals[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Master international archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverMasterInternational(masterInternational:MasterInternationalVo){
const isPermistted = await this.roleService.isPermitted('MasterInternational', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Master international) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.masterInternationalService.desarchiver(masterInternational).subscribe(status=>{
const myIndex = this.masterInternationals.indexOf(masterInternational);
this.masterInternationals[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Master international désarchivé',
life: 3000
});
},error=>console.log(error))
 }
