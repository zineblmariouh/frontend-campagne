...
@Component({
  selector: 'app-nature-expertise-view-admin',
  templateUrl: './nature-expertise-view-admin.component.html',
  styleUrls: ['./nature-expertise-view-admin.component.css']
})
export class NatureExpertiseViewAdminComponent implements OnInit {
