...
public async archiverNiveauFormationPostBac(niveauFormationPostBac:NiveauFormationPostBacVo){
const isPermistted = await this.roleService.isPermitted('NiveauFormationPostBac', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Niveau formation post bac) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.niveauFormationPostBacService.archiver(niveauFormationPostBac).subscribe(status=>{
const myIndex = this.niveauFormationPostBacs.indexOf(niveauFormationPostBac);
this.niveauFormationPostBacs[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Niveau formation post bac archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverNiveauFormationPostBac(niveauFormationPostBac:NiveauFormationPostBacVo){
const isPermistted = await this.roleService.isPermitted('NiveauFormationPostBac', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Niveau formation post bac) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.niveauFormationPostBacService.desarchiver(niveauFormationPostBac).subscribe(status=>{
const myIndex = this.niveauFormationPostBacs.indexOf(niveauFormationPostBac);
this.niveauFormationPostBacs[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Niveau formation post bac désarchivé',
life: 3000
});
},error=>console.log(error))
 }
