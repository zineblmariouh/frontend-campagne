...
@Component({
  selector: 'app-publique-formation-list-admin',
  templateUrl: './publique-formation-list-admin.component.html',
  styleUrls: ['./publique-formation-list-admin.component.css']
})
export class PubliqueFormationListAdminComponent implements OnInit {
   // declarations
...
public async archiverPubliqueFormation(publiqueFormation:PubliqueFormationVo){
const isPermistted = await this.roleService.isPermitted('PubliqueFormation', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Publique formation) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.publiqueFormationService.archiver(publiqueFormation).subscribe(status=>{
const myIndex = this.publiqueFormations.indexOf(publiqueFormation);
this.publiqueFormations[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Publique formation archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverPubliqueFormation(publiqueFormation:PubliqueFormationVo){
const isPermistted = await this.roleService.isPermitted('PubliqueFormation', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Publique formation) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.publiqueFormationService.desarchiver(publiqueFormation).subscribe(status=>{
const myIndex = this.publiqueFormations.indexOf(publiqueFormation);
this.publiqueFormations[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Publique formation désarchivé',
life: 3000
});
},error=>console.log(error))
 }
