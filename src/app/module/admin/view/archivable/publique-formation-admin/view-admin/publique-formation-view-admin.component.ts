...
@Component({
  selector: 'app-publique-formation-view-admin',
  templateUrl: './publique-formation-view-admin.component.html',
  styleUrls: ['./publique-formation-view-admin.component.css']
})
export class PubliqueFormationViewAdminComponent implements OnInit {
