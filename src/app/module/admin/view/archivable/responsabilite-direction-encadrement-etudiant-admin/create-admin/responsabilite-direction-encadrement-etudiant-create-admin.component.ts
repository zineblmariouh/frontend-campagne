...
@Component({
  selector: 'app-responsabilite-direction-encadrement-etudiant-create-admin',
  templateUrl: './responsabilite-direction-encadrement-etudiant-create-admin.component.html',
  styleUrls: ['./responsabilite-direction-encadrement-etudiant-create-admin.component.css']
})
export class ResponsabiliteDirectionEncadrementEtudiantCreateAdminComponent implements OnInit {
