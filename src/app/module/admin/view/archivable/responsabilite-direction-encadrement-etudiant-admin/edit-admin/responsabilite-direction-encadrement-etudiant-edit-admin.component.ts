...
@Component({
  selector: 'app-responsabilite-direction-encadrement-etudiant-edit-admin',
  templateUrl: './responsabilite-direction-encadrement-etudiant-edit-admin.component.html',
  styleUrls: ['./responsabilite-direction-encadrement-etudiant-edit-admin.component.css']
})
export class ResponsabiliteDirectionEncadrementEtudiantEditAdminComponent implements OnInit {
