...
@Component({
  selector: 'app-responsabilite-direction-encadrement-etudiant-list-admin',
  templateUrl: './responsabilite-direction-encadrement-etudiant-list-admin.component.html',
  styleUrls: ['./responsabilite-direction-encadrement-etudiant-list-admin.component.css']
})
export class ResponsabiliteDirectionEncadrementEtudiantListAdminComponent implements OnInit {
   // declarations
...
public async archiverResponsabiliteDirectionEncadrementEtudiant(responsabiliteDirectionEncadrementEtudiant:ResponsabiliteDirectionEncadrementEtudiantVo){
const isPermistted = await this.roleService.isPermitted('ResponsabiliteDirectionEncadrementEtudiant', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Responsabilite direction encadrement etudiant) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.responsabiliteDirectionEncadrementEtudiantService.archiver(responsabiliteDirectionEncadrementEtudiant).subscribe(status=>{
const myIndex = this.responsabiliteDirectionEncadrementEtudiants.indexOf(responsabiliteDirectionEncadrementEtudiant);
this.responsabiliteDirectionEncadrementEtudiants[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Responsabilite direction encadrement etudiant archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverResponsabiliteDirectionEncadrementEtudiant(responsabiliteDirectionEncadrementEtudiant:ResponsabiliteDirectionEncadrementEtudiantVo){
const isPermistted = await this.roleService.isPermitted('ResponsabiliteDirectionEncadrementEtudiant', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Responsabilite direction encadrement etudiant) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.responsabiliteDirectionEncadrementEtudiantService.desarchiver(responsabiliteDirectionEncadrementEtudiant).subscribe(status=>{
const myIndex = this.responsabiliteDirectionEncadrementEtudiants.indexOf(responsabiliteDirectionEncadrementEtudiant);
this.responsabiliteDirectionEncadrementEtudiants[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Responsabilite direction encadrement etudiant désarchivé',
life: 3000
});
},error=>console.log(error))
 }
