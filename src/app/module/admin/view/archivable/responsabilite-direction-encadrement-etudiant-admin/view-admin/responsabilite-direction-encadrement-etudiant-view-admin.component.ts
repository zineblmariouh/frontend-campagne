...
@Component({
  selector: 'app-responsabilite-direction-encadrement-etudiant-view-admin',
  templateUrl: './responsabilite-direction-encadrement-etudiant-view-admin.component.html',
  styleUrls: ['./responsabilite-direction-encadrement-etudiant-view-admin.component.css']
})
export class ResponsabiliteDirectionEncadrementEtudiantViewAdminComponent implements OnInit {
