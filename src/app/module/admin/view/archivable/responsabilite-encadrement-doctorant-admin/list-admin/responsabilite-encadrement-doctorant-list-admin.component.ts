...
@Component({
  ...
  templateUrl: './responsabilite-encadrement-doctorant-list-admin.component.html',
  styleUrls: ['./responsabilite-encadrement-doctorant-list-admin.component.css']
})
...
public async archiverResponsabiliteEncadrementDoctorant(responsabiliteEncadrementDoctorant:ResponsabiliteEncadrementDoctorantVo){
const isPermistted = await this.roleService.isPermitted('ResponsabiliteEncadrementDoctorant', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Responsabilite encadrement doctorant) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.responsabiliteEncadrementDoctorantService.archiver(responsabiliteEncadrementDoctorant).subscribe(status=>{
const myIndex = this.responsabiliteEncadrementDoctorants.indexOf(responsabiliteEncadrementDoctorant);
this.responsabiliteEncadrementDoctorants[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Responsabilite encadrement doctorant archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverResponsabiliteEncadrementDoctorant(responsabiliteEncadrementDoctorant:ResponsabiliteEncadrementDoctorantVo){
const isPermistted = await this.roleService.isPermitted('ResponsabiliteEncadrementDoctorant', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Responsabilite encadrement doctorant) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.responsabiliteEncadrementDoctorantService.desarchiver(responsabiliteEncadrementDoctorant).subscribe(status=>{
const myIndex = this.responsabiliteEncadrementDoctorants.indexOf(responsabiliteEncadrementDoctorant);
this.responsabiliteEncadrementDoctorants[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Responsabilite encadrement doctorant désarchivé',
life: 3000
});
},error=>console.log(error))
 }
