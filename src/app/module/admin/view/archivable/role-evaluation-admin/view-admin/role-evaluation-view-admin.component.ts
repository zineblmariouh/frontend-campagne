...
@Component({
  selector: 'app-role-evaluation-view-admin',
  templateUrl: './role-evaluation-view-admin.component.html',
  styleUrls: ['./role-evaluation-view-admin.component.css']
})
export class RoleEvaluationViewAdminComponent implements OnInit {
