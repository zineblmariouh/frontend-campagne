...
public async archiverRoleProjet(roleProjet:RoleProjetVo){
const isPermistted = await this.roleService.isPermitted('RoleProjet', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Role projet) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.roleProjetService.archiver(roleProjet).subscribe(status=>{
const myIndex = this.roleProjets.indexOf(roleProjet);
this.roleProjets[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Role projet archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverRoleProjet(roleProjet:RoleProjetVo){
const isPermistted = await this.roleService.isPermitted('RoleProjet', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Role projet) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.roleProjetService.desarchiver(roleProjet).subscribe(status=>{
const myIndex = this.roleProjets.indexOf(roleProjet);
this.roleProjets[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Role projet désarchivé',
life: 3000
});
},error=>console.log(error))
 }
