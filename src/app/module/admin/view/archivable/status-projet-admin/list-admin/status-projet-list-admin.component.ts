...
public async archiverStatusProjet(statusProjet:StatusProjetVo){
const isPermistted = await this.roleService.isPermitted('StatusProjet', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Status projet) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.statusProjetService.archiver(statusProjet).subscribe(status=>{
const myIndex = this.statusProjets.indexOf(statusProjet);
this.statusProjets[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Status projet archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverStatusProjet(statusProjet:StatusProjetVo){
const isPermistted = await this.roleService.isPermitted('StatusProjet', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Status projet) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.statusProjetService.desarchiver(statusProjet).subscribe(status=>{
const myIndex = this.statusProjets.indexOf(statusProjet);
this.statusProjets[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Status projet désarchivé',
life: 3000
});
},error=>console.log(error))
 }
