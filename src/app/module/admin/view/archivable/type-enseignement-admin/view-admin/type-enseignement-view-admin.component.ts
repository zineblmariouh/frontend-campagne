...
@Component({
  selector: 'app-type-enseignement-view-admin',
  templateUrl: './type-enseignement-view-admin.component.html',
  styleUrls: ['./type-enseignement-view-admin.component.css']
})
export class TypeEnseignementViewAdminComponent implements OnInit {
