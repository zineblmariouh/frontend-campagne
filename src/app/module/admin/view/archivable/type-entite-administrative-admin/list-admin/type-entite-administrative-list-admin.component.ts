...
public async archiverTypeEntiteAdministrative(typeEntiteAdministrative:TypeEntiteAdministrativeVo){
const isPermistted = await this.roleService.isPermitted('TypeEntiteAdministrative', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Type entite administrative) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeEntiteAdministrativeService.archiver(typeEntiteAdministrative).subscribe(status=>{
const myIndex = this.typeEntiteAdministratives.indexOf(typeEntiteAdministrative);
this.typeEntiteAdministratives[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type entite administrative archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverTypeEntiteAdministrative(typeEntiteAdministrative:TypeEntiteAdministrativeVo){
const isPermistted = await this.roleService.isPermitted('TypeEntiteAdministrative', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Type entite administrative) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeEntiteAdministrativeService.desarchiver(typeEntiteAdministrative).subscribe(status=>{
const myIndex = this.typeEntiteAdministratives.indexOf(typeEntiteAdministrative);
this.typeEntiteAdministratives[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type entite administrative désarchivé',
life: 3000
});
},error=>console.log(error))
 }
