...
public async archiverTypeEtude(typeEtude:TypeEtudeVo){
const isPermistted = await this.roleService.isPermitted('TypeEtude', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Type etude) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeEtudeService.archiver(typeEtude).subscribe(status=>{
const myIndex = this.typeEtudes.indexOf(typeEtude);
this.typeEtudes[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type etude archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverTypeEtude(typeEtude:TypeEtudeVo){
const isPermistted = await this.roleService.isPermitted('TypeEtude', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Type etude) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeEtudeService.desarchiver(typeEtude).subscribe(status=>{
const myIndex = this.typeEtudes.indexOf(typeEtude);
this.typeEtudes[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type etude désarchivé',
life: 3000
});
},error=>console.log(error))
 }
