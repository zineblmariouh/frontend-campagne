...
public async archiverTypeExpert(typeExpert:TypeExpertVo){
const isPermistted = await this.roleService.isPermitted('TypeExpert', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Type expert) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeExpertService.archiver(typeExpert).subscribe(status=>{
const myIndex = this.typeExperts.indexOf(typeExpert);
this.typeExperts[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type expert archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverTypeExpert(typeExpert:TypeExpertVo){
const isPermistted = await this.roleService.isPermitted('TypeExpert', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Type expert) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeExpertService.desarchiver(typeExpert).subscribe(status=>{
const myIndex = this.typeExperts.indexOf(typeExpert);
this.typeExperts[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type expert désarchivé',
life: 3000
});
},error=>console.log(error))
 }
