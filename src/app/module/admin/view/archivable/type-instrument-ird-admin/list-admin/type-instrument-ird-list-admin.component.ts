...
public async archiverTypeInstrumentIrd(typeInstrumentIrd:TypeInstrumentIrdVo){
const isPermistted = await this.roleService.isPermitted('TypeInstrumentIrd', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Type instrument ird) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeInstrumentIrdService.archiver(typeInstrumentIrd).subscribe(status=>{
const myIndex = this.typeInstrumentIrds.indexOf(typeInstrumentIrd);
this.typeInstrumentIrds[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type instrument ird archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverTypeInstrumentIrd(typeInstrumentIrd:TypeInstrumentIrdVo){
const isPermistted = await this.roleService.isPermitted('TypeInstrumentIrd', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Type instrument ird) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeInstrumentIrdService.desarchiver(typeInstrumentIrd).subscribe(status=>{
const myIndex = this.typeInstrumentIrds.indexOf(typeInstrumentIrd);
this.typeInstrumentIrds[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type instrument ird désarchivé',
life: 3000
});
},error=>console.log(error))
 }
