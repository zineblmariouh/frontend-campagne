...
@Component({
  selector: 'app-type-publique-culture-scientifique-create-admin',
  templateUrl: './type-publique-culture-scientifique-create-admin.component.html',
  styleUrls: ['./type-publique-culture-scientifique-create-admin.component.css']
})
export class TypePubliqueCultureScientifiqueCreateAdminComponent implements OnInit {
