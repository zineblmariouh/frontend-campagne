...
public async archiverTypeReclamation(typeReclamation:TypeReclamationVo){
const isPermistted = await this.roleService.isPermitted('TypeReclamation', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Type reclamation) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeReclamationService.archiver(typeReclamation).subscribe(status=>{
const myIndex = this.typeReclamations.indexOf(typeReclamation);
this.typeReclamations[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type reclamation archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverTypeReclamation(typeReclamation:TypeReclamationVo){
const isPermistted = await this.roleService.isPermitted('TypeReclamation', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Type reclamation) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeReclamationService.desarchiver(typeReclamation).subscribe(status=>{
const myIndex = this.typeReclamations.indexOf(typeReclamation);
this.typeReclamations[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type reclamation désarchivé',
life: 3000
});
},error=>console.log(error))
 }
