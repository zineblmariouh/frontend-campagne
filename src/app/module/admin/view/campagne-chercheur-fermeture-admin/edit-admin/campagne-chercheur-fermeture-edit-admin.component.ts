...
@Component({
  selector: 'app-campagne-chercheur-fermeture-edit-admin',
  templateUrl: './campagne-chercheur-fermeture-edit-admin.component.html',
  styleUrls: ['./campagne-chercheur-fermeture-edit-admin.component.css']
})
export class CampagneChercheurFermetureEditAdminComponent implements OnInit {
