...
@Component({
  selector: 'app-campagne-chercheur-fermeture-list-admin',
  templateUrl: './campagne-chercheur-fermeture-list-admin.component.html',
  styleUrls: ['./campagne-chercheur-fermeture-list-admin.component.css']
})
export class CampagneChercheurFermetureListAdminComponent implements OnInit {
   // declarations
