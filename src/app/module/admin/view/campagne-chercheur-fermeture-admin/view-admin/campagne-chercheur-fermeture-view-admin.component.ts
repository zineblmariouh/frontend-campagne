...
@Component({
  selector: 'app-campagne-chercheur-fermeture-view-admin',
  templateUrl: './campagne-chercheur-fermeture-view-admin.component.html',
  styleUrls: ['./campagne-chercheur-fermeture-view-admin.component.css']
})
export class CampagneChercheurFermetureViewAdminComponent implements OnInit {
