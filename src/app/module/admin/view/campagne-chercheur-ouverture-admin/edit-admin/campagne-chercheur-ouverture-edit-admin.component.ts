...
@Component({
  selector: 'app-campagne-chercheur-ouverture-edit-admin',
  templateUrl: './campagne-chercheur-ouverture-edit-admin.component.html',
  styleUrls: ['./campagne-chercheur-ouverture-edit-admin.component.css']
})
export class CampagneChercheurOuvertureEditAdminComponent implements OnInit {
