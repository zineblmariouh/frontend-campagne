...
@Component({
  selector: 'app-campagne-chercheur-ouverture-list-admin',
  templateUrl: './campagne-chercheur-ouverture-list-admin.component.html',
  styleUrls: ['./campagne-chercheur-ouverture-list-admin.component.css']
})
export class CampagneChercheurOuvertureListAdminComponent implements OnInit {
   // declarations
