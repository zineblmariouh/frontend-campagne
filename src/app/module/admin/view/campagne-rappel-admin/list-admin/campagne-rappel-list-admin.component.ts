...
@Component({
  selector: 'app-campagne-rappel-list-admin',
  templateUrl: './campagne-rappel-list-admin.component.html',
  styleUrls: ['./campagne-rappel-list-admin.component.css']
})
export class CampagneRappelListAdminComponent implements OnInit {
   // declarations
