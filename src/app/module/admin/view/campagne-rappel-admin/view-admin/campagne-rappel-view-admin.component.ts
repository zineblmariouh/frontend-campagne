...
@Component({
  selector: 'app-campagne-rappel-view-admin',
  templateUrl: './campagne-rappel-view-admin.component.html',
  styleUrls: ['./campagne-rappel-view-admin.component.css']
})
export class CampagneRappelViewAdminComponent implements OnInit {
