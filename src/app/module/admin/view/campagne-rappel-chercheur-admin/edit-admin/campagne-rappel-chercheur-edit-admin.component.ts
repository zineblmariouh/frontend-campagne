...
@Component({
  selector: 'app-campagne-rappel-chercheur-edit-admin',
  templateUrl: './campagne-rappel-chercheur-edit-admin.component.html',
  styleUrls: ['./campagne-rappel-chercheur-edit-admin.component.css']
})
export class CampagneRappelChercheurEditAdminComponent implements OnInit {
