...
@Component({
  selector: 'app-campagne-rappel-chercheur-list-admin',
  templateUrl: './campagne-rappel-chercheur-list-admin.component.html',
  styleUrls: ['./campagne-rappel-chercheur-list-admin.component.css']
})
export class CampagneRappelChercheurListAdminComponent implements OnInit {
   // declarations
