...
@Component({
  selector: 'app-campagne-relance-list-admin',
  templateUrl: './campagne-relance-list-admin.component.html',
  styleUrls: ['./campagne-relance-list-admin.component.css']
})
export class CampagneRelanceListAdminComponent implements OnInit {
   // declarations
