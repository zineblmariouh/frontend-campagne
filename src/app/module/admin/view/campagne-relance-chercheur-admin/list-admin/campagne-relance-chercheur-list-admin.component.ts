...
@Component({
  selector: 'app-campagne-relance-chercheur-list-admin',
  templateUrl: './campagne-relance-chercheur-list-admin.component.html',
  styleUrls: ['./campagne-relance-chercheur-list-admin.component.css']
})
export class CampagneRelanceChercheurListAdminComponent implements OnInit {
   // declarations
