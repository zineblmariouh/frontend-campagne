...
@Component({
  selector: 'app-campagne-relance-chercheur-view-admin',
  templateUrl: './campagne-relance-chercheur-view-admin.component.html',
  styleUrls: ['./campagne-relance-chercheur-view-admin.component.css']
})
export class CampagneRelanceChercheurViewAdminComponent implements OnInit {
