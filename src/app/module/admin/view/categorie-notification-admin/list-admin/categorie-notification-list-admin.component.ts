...
@Component({
  selector: 'app-categorie-notification-list-admin',
  templateUrl: './categorie-notification-list-admin.component.html',
  styleUrls: ['./categorie-notification-list-admin.component.css']
})
export class CategorieNotificationListAdminComponent implements OnInit {
   // declarations
