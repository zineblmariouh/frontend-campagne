...
@Component({
  selector: 'app-categorie-notification-view-admin',
  templateUrl: './categorie-notification-view-admin.component.html',
  styleUrls: ['./categorie-notification-view-admin.component.css']
})
export class CategorieNotificationViewAdminComponent implements OnInit {
