...
@Component({
  selector: 'app-chercheur-email-edit-admin',
  templateUrl: './chercheur-email-edit-admin.component.html',
  styleUrls: ['./chercheur-email-edit-admin.component.css']
})
export class ChercheurEmailEditAdminComponent implements OnInit {
