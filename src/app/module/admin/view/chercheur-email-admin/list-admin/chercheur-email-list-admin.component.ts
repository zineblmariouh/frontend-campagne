...
@Component({
  selector: 'app-chercheur-email-list-admin',
  templateUrl: './chercheur-email-list-admin.component.html',
  styleUrls: ['./chercheur-email-list-admin.component.css']
})
export class ChercheurEmailListAdminComponent implements OnInit {
   // declarations
