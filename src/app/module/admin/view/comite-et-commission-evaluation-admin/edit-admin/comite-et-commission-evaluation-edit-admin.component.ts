...
@Component({
  selector: 'app-comite-et-commission-evaluation-edit-admin',
  templateUrl: './comite-et-commission-evaluation-edit-admin.component.html',
  styleUrls: ['./comite-et-commission-evaluation-edit-admin.component.css']
})
export class ComiteEtCommissionEvaluationEditAdminComponent implements OnInit {
