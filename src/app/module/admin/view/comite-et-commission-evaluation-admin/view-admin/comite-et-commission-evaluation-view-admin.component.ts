...
@Component({
  selector: 'app-comite-et-commission-evaluation-view-admin',
  templateUrl: './comite-et-commission-evaluation-view-admin.component.html',
  styleUrls: ['./comite-et-commission-evaluation-view-admin.component.css']
})
export class ComiteEtCommissionEvaluationViewAdminComponent implements OnInit {
