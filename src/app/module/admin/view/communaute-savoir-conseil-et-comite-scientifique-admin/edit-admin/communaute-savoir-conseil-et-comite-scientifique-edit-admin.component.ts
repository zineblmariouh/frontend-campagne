...
@Component({
  selector: 'app-communaute-savoir-conseil-et-comite-scientifique-edit-admin',
  templateUrl: './communaute-savoir-conseil-et-comite-scientifique-edit-admin.component.html',
  styleUrls: ['./communaute-savoir-conseil-et-comite-scientifique-edit-admin.component.css']
})
export class CommunauteSavoirConseilEtComiteScientifiqueEditAdminComponent implements OnInit {
