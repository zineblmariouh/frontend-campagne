...
@Component({
  selector: 'app-communaute-savoir-conseil-et-comite-scientifique-list-admin',
  templateUrl: './communaute-savoir-conseil-et-comite-scientifique-list-admin.component.html',
  styleUrls: ['./communaute-savoir-conseil-et-comite-scientifique-list-admin.component.css']
})
export class CommunauteSavoirConseilEtComiteScientifiqueListAdminComponent implements OnInit {
   // declarations
