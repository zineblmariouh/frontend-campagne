...
@Component({
  selector: 'app-communaute-savoir-conseil-et-comite-scientifique-view-admin',
  templateUrl: './communaute-savoir-conseil-et-comite-scientifique-view-admin.component.html',
  styleUrls: ['./communaute-savoir-conseil-et-comite-scientifique-view-admin.component.css']
})
export class CommunauteSavoirConseilEtComiteScientifiqueViewAdminComponent implements OnInit {
