...
@Component({
  selector: 'app-communaute-savoir-encadrement-doctorant-edit-admin',
  templateUrl: './communaute-savoir-encadrement-doctorant-edit-admin.component.html',
  styleUrls: ['./communaute-savoir-encadrement-doctorant-edit-admin.component.css']
})
export class CommunauteSavoirEncadrementDoctorantEditAdminComponent implements OnInit {
