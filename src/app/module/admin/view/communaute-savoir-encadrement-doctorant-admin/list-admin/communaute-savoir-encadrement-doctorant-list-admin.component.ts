...
@Component({
  selector: 'app-communaute-savoir-encadrement-doctorant-list-admin',
  templateUrl: './communaute-savoir-encadrement-doctorant-list-admin.component.html',
  styleUrls: ['./communaute-savoir-encadrement-doctorant-list-admin.component.css']
})
export class CommunauteSavoirEncadrementDoctorantListAdminComponent implements OnInit {
   // declarations
