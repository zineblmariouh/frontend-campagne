...
@Component({
  selector: 'app-communaute-savoir-evenement-colloque-scientifique-edit-admin',
  templateUrl: './communaute-savoir-evenement-colloque-scientifique-edit-admin.component.html',
  styleUrls: ['./communaute-savoir-evenement-colloque-scientifique-edit-admin.component.css']
})
export class CommunauteSavoirEvenementColloqueScientifiqueEditAdminComponent implements OnInit {
