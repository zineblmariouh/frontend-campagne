...
@Component({
  selector: 'app-communaute-savoir-evenement-colloque-scientifique-list-admin',
  templateUrl: './communaute-savoir-evenement-colloque-scientifique-list-admin.component.html',
  styleUrls: ['./communaute-savoir-evenement-colloque-scientifique-list-admin.component.css']
})
export class CommunauteSavoirEvenementColloqueScientifiqueListAdminComponent implements OnInit {
   // declarations
