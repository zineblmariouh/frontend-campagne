...
@Component({
  selector: 'app-communaute-savoir-projet-activite-recherche-list-admin',
  templateUrl: './communaute-savoir-projet-activite-recherche-list-admin.component.html',
  styleUrls: ['./communaute-savoir-projet-activite-recherche-list-admin.component.css']
})
export class CommunauteSavoirProjetActiviteRechercheListAdminComponent implements OnInit {
   // declarations
