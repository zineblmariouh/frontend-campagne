...
@Component({
  selector: 'app-communaute-savoir-projet-activite-recherche-view-admin',
  templateUrl: './communaute-savoir-projet-activite-recherche-view-admin.component.html',
  styleUrls: ['./communaute-savoir-projet-activite-recherche-view-admin.component.css']
})
export class CommunauteSavoirProjetActiviteRechercheViewAdminComponent implements OnInit {
