...
@Component({
  selector: 'app-conseils-scientifique-edit-admin',
  templateUrl: './conseils-scientifique-edit-admin.component.html',
  styleUrls: ['./conseils-scientifique-edit-admin.component.css']
})
export class ConseilsScientifiqueEditAdminComponent implements OnInit {
