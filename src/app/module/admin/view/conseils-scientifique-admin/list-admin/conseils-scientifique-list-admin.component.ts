...
@Component({
  selector: 'app-conseils-scientifique-list-admin',
  templateUrl: './conseils-scientifique-list-admin.component.html',
  styleUrls: ['./conseils-scientifique-list-admin.component.css']
})
export class ConseilsScientifiqueListAdminComponent implements OnInit {
   // declarations
