...
@Component({
  selector: 'app-consultance-scientifique-ponctuelle-edit-admin',
  templateUrl: './consultance-scientifique-ponctuelle-edit-admin.component.html',
  styleUrls: ['./consultance-scientifique-ponctuelle-edit-admin.component.css']
})
export class ConsultanceScientifiquePonctuelleEditAdminComponent implements OnInit {
