...
@Component({
  selector: 'app-consultance-scientifique-ponctuelle-list-admin',
  templateUrl: './consultance-scientifique-ponctuelle-list-admin.component.html',
  styleUrls: ['./consultance-scientifique-ponctuelle-list-admin.component.css']
})
export class ConsultanceScientifiquePonctuelleListAdminComponent implements OnInit {
   // declarations
