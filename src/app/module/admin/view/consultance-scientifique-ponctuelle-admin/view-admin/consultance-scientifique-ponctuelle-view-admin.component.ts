...
@Component({
  selector: 'app-consultance-scientifique-ponctuelle-view-admin',
  templateUrl: './consultance-scientifique-ponctuelle-view-admin.component.html',
  styleUrls: ['./consultance-scientifique-ponctuelle-view-admin.component.css']
})
export class ConsultanceScientifiquePonctuelleViewAdminComponent implements OnInit {
