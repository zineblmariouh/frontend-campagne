...
@Component({
  selector: 'app-contrat-et-convention-ird-list-admin',
  templateUrl: './contrat-et-convention-ird-list-admin.component.html',
  styleUrls: ['./contrat-et-convention-ird-list-admin.component.css']
})
export class ContratEtConventionIrdListAdminComponent implements OnInit {
   // declarations
