...
@Component({
  ...
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-view-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-view-admin.component.css']
})
