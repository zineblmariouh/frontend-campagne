...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-communaute-savoir-list-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-communaute-savoir-list-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-communaute-savoir-list-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueCommunauteSavoirListAdminComponent implements OnInit {
   // declarations
