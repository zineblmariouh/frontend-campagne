...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-communaute-savoir-view-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-communaute-savoir-view-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-communaute-savoir-view-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueCommunauteSavoirViewAdminComponent implements OnInit {
