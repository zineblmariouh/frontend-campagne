...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-enjeux-ird-edit-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-enjeux-ird-edit-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-enjeux-ird-edit-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueEnjeuxIrdEditAdminComponent implements OnInit {
