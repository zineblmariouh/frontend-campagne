...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-enjeux-ird-list-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-enjeux-ird-list-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-enjeux-ird-list-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueEnjeuxIrdListAdminComponent implements OnInit {
   // declarations
