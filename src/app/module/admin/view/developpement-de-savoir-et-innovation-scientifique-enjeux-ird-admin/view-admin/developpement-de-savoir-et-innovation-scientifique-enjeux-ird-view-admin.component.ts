...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-enjeux-ird-view-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-enjeux-ird-view-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-enjeux-ird-view-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueEnjeuxIrdViewAdminComponent implements OnInit {
