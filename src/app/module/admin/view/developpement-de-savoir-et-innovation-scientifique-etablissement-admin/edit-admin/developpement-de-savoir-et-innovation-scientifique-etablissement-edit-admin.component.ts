...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-etablissement-edit-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-etablissement-edit-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-etablissement-edit-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueEtablissementEditAdminComponent implements OnInit {
