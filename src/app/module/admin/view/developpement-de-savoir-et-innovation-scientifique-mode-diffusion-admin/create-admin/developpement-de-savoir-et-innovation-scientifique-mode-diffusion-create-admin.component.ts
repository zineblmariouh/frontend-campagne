...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-mode-diffusion-create-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-mode-diffusion-create-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-mode-diffusion-create-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueModeDiffusionCreateAdminComponent implements OnInit {
