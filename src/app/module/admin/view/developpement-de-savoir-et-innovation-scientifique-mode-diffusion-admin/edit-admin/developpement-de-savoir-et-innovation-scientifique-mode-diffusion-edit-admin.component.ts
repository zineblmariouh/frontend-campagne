...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-mode-diffusion-edit-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-mode-diffusion-edit-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-mode-diffusion-edit-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueModeDiffusionEditAdminComponent implements OnInit {
