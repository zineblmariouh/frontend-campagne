...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-mode-diffusion-list-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-mode-diffusion-list-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-mode-diffusion-list-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueModeDiffusionListAdminComponent implements OnInit {
   // declarations
