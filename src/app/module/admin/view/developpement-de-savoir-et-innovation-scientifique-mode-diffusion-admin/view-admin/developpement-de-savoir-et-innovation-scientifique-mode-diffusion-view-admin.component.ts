...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-mode-diffusion-view-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-mode-diffusion-view-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-mode-diffusion-view-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueModeDiffusionViewAdminComponent implements OnInit {
