...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-pays-create-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-pays-create-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-pays-create-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiquePaysCreateAdminComponent implements OnInit {
