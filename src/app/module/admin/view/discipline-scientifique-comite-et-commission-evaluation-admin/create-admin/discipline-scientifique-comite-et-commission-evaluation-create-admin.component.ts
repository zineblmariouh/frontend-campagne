...
@Component({
  selector: 'app-discipline-scientifique-comite-et-commission-evaluation-create-admin',
  templateUrl: './discipline-scientifique-comite-et-commission-evaluation-create-admin.component.html',
  styleUrls: ['./discipline-scientifique-comite-et-commission-evaluation-create-admin.component.css']
})
export class DisciplineScientifiqueComiteEtCommissionEvaluationCreateAdminComponent implements OnInit {
