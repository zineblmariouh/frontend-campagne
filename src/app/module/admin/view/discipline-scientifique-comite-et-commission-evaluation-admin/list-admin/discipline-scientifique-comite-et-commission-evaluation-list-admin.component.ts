...
@Component({
  selector: 'app-discipline-scientifique-comite-et-commission-evaluation-list-admin',
  templateUrl: './discipline-scientifique-comite-et-commission-evaluation-list-admin.component.html',
  styleUrls: ['./discipline-scientifique-comite-et-commission-evaluation-list-admin.component.css']
})
export class DisciplineScientifiqueComiteEtCommissionEvaluationListAdminComponent implements OnInit {
   // declarations
