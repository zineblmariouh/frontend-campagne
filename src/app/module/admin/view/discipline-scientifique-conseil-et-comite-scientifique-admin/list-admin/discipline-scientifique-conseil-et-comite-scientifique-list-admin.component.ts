...
@Component({
  selector: 'app-discipline-scientifique-conseil-et-comite-scientifique-list-admin',
  templateUrl: './discipline-scientifique-conseil-et-comite-scientifique-list-admin.component.html',
  styleUrls: ['./discipline-scientifique-conseil-et-comite-scientifique-list-admin.component.css']
})
export class DisciplineScientifiqueConseilEtComiteScientifiqueListAdminComponent implements OnInit {
   // declarations
