...
@Component({
  selector: 'app-discipline-scientifique-conseils-scientifique-edit-admin',
  templateUrl: './discipline-scientifique-conseils-scientifique-edit-admin.component.html',
  styleUrls: ['./discipline-scientifique-conseils-scientifique-edit-admin.component.css']
})
export class DisciplineScientifiqueConseilsScientifiqueEditAdminComponent implements OnInit {
