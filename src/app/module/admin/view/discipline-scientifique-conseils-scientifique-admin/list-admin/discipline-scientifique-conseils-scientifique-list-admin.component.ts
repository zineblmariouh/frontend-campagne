...
@Component({
  selector: 'app-discipline-scientifique-conseils-scientifique-list-admin',
  templateUrl: './discipline-scientifique-conseils-scientifique-list-admin.component.html',
  styleUrls: ['./discipline-scientifique-conseils-scientifique-list-admin.component.css']
})
export class DisciplineScientifiqueConseilsScientifiqueListAdminComponent implements OnInit {
   // declarations
