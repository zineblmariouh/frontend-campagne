...
@Component({
  selector: 'app-discipline-scientifique-conseils-scientifique-view-admin',
  templateUrl: './discipline-scientifique-conseils-scientifique-view-admin.component.html',
  styleUrls: ['./discipline-scientifique-conseils-scientifique-view-admin.component.css']
})
export class DisciplineScientifiqueConseilsScientifiqueViewAdminComponent implements OnInit {
