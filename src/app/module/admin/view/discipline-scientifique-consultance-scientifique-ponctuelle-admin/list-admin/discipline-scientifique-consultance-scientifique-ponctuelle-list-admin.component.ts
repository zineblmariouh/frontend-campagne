...
@Component({
  selector: 'app-discipline-scientifique-consultance-scientifique-ponctuelle-list-admin',
  templateUrl: './discipline-scientifique-consultance-scientifique-ponctuelle-list-admin.component.html',
  styleUrls: ['./discipline-scientifique-consultance-scientifique-ponctuelle-list-admin.component.css']
})
export class DisciplineScientifiqueConsultanceScientifiquePonctuelleListAdminComponent implements OnInit {
   // declarations
