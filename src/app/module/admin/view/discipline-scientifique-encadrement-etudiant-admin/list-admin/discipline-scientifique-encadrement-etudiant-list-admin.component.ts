...
@Component({
  selector: 'app-discipline-scientifique-encadrement-etudiant-list-admin',
  templateUrl: './discipline-scientifique-encadrement-etudiant-list-admin.component.html',
  styleUrls: ['./discipline-scientifique-encadrement-etudiant-list-admin.component.css']
})
export class DisciplineScientifiqueEncadrementEtudiantListAdminComponent implements OnInit {
   // declarations
