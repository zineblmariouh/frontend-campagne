...
@Component({
  selector: 'app-discipline-scientifique-evenement-colloque-scientifique-create-admin',
  templateUrl: './discipline-scientifique-evenement-colloque-scientifique-create-admin.component.html',
  styleUrls: ['./discipline-scientifique-evenement-colloque-scientifique-create-admin.component.css']
})
export class DisciplineScientifiqueEvenementColloqueScientifiqueCreateAdminComponent implements OnInit {
