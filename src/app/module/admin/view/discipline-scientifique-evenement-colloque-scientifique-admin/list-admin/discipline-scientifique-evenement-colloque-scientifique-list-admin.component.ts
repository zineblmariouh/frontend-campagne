...
@Component({
  selector: 'app-discipline-scientifique-evenement-colloque-scientifique-list-admin',
  templateUrl: './discipline-scientifique-evenement-colloque-scientifique-list-admin.component.html',
  styleUrls: ['./discipline-scientifique-evenement-colloque-scientifique-list-admin.component.css']
})
export class DisciplineScientifiqueEvenementColloqueScientifiqueListAdminComponent implements OnInit {
   // declarations
