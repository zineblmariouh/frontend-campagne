...
@Component({
  selector: 'app-discipline-scientifique-evenement-colloque-scientifique-view-admin',
  templateUrl: './discipline-scientifique-evenement-colloque-scientifique-view-admin.component.html',
  styleUrls: ['./discipline-scientifique-evenement-colloque-scientifique-view-admin.component.css']
})
export class DisciplineScientifiqueEvenementColloqueScientifiqueViewAdminComponent implements OnInit {
