...
@Component({
  selector: 'app-discipline-scientifique-expertise-scientifique-create-admin',
  templateUrl: './discipline-scientifique-expertise-scientifique-create-admin.component.html',
  styleUrls: ['./discipline-scientifique-expertise-scientifique-create-admin.component.css']
})
export class DisciplineScientifiqueExpertiseScientifiqueCreateAdminComponent implements OnInit {
