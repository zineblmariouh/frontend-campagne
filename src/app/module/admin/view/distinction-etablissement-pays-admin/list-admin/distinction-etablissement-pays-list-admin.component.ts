...
@Component({
  selector: 'app-distinction-etablissement-pays-list-admin',
  templateUrl: './distinction-etablissement-pays-list-admin.component.html',
  styleUrls: ['./distinction-etablissement-pays-list-admin.component.css']
})
export class DistinctionEtablissementPaysListAdminComponent implements OnInit {
   // declarations
