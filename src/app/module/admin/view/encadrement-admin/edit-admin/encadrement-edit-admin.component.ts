...
@Component({
  selector: 'app-encadrement-edit-admin',
  templateUrl: './encadrement-edit-admin.component.html',
  styleUrls: ['./encadrement-edit-admin.component.css']
})
export class EncadrementEditAdminComponent implements OnInit {
