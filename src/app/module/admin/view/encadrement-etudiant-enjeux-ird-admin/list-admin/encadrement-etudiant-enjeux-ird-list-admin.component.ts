...
@Component({
  selector: 'app-encadrement-etudiant-enjeux-ird-list-admin',
  templateUrl: './encadrement-etudiant-enjeux-ird-list-admin.component.html',
  styleUrls: ['./encadrement-etudiant-enjeux-ird-list-admin.component.css']
})
export class EncadrementEtudiantEnjeuxIrdListAdminComponent implements OnInit {
   // declarations
