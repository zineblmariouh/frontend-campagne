...
@Component({
  selector: 'app-enjeux-ird-comite-et-commission-evaluation-edit-admin',
  templateUrl: './enjeux-ird-comite-et-commission-evaluation-edit-admin.component.html',
  styleUrls: ['./enjeux-ird-comite-et-commission-evaluation-edit-admin.component.css']
})
export class EnjeuxIrdComiteEtCommissionEvaluationEditAdminComponent implements OnInit {
