...
@Component({
  selector: 'app-enjeux-ird-comite-et-commission-evaluation-view-admin',
  templateUrl: './enjeux-ird-comite-et-commission-evaluation-view-admin.component.html',
  styleUrls: ['./enjeux-ird-comite-et-commission-evaluation-view-admin.component.css']
})
export class EnjeuxIrdComiteEtCommissionEvaluationViewAdminComponent implements OnInit {
