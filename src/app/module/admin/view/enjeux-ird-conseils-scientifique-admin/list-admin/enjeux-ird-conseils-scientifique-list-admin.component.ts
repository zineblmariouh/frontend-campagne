...
@Component({
  selector: 'app-enjeux-ird-conseils-scientifique-list-admin',
  templateUrl: './enjeux-ird-conseils-scientifique-list-admin.component.html',
  styleUrls: ['./enjeux-ird-conseils-scientifique-list-admin.component.css']
})
export class EnjeuxIrdConseilsScientifiqueListAdminComponent implements OnInit {
   // declarations
