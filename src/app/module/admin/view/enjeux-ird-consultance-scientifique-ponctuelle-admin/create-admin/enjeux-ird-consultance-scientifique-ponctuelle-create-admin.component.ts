...
@Component({
  selector: 'app-enjeux-ird-consultance-scientifique-ponctuelle-create-admin',
  templateUrl: './enjeux-ird-consultance-scientifique-ponctuelle-create-admin.component.html',
  styleUrls: ['./enjeux-ird-consultance-scientifique-ponctuelle-create-admin.component.css']
})
export class EnjeuxIrdConsultanceScientifiquePonctuelleCreateAdminComponent implements OnInit {
