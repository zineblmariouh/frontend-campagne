...
@Component({
  selector: 'app-enjeux-ird-consultance-scientifique-ponctuelle-edit-admin',
  templateUrl: './enjeux-ird-consultance-scientifique-ponctuelle-edit-admin.component.html',
  styleUrls: ['./enjeux-ird-consultance-scientifique-ponctuelle-edit-admin.component.css']
})
export class EnjeuxIrdConsultanceScientifiquePonctuelleEditAdminComponent implements OnInit {
