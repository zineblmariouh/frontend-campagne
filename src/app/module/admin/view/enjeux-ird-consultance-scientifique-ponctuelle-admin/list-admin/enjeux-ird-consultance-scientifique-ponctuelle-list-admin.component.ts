...
@Component({
  selector: 'app-enjeux-ird-consultance-scientifique-ponctuelle-list-admin',
  templateUrl: './enjeux-ird-consultance-scientifique-ponctuelle-list-admin.component.html',
  styleUrls: ['./enjeux-ird-consultance-scientifique-ponctuelle-list-admin.component.css']
})
export class EnjeuxIrdConsultanceScientifiquePonctuelleListAdminComponent implements OnInit {
   // declarations
