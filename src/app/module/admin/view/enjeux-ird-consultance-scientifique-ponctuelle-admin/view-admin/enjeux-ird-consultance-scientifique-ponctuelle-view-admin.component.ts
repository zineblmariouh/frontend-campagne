...
@Component({
  selector: 'app-enjeux-ird-consultance-scientifique-ponctuelle-view-admin',
  templateUrl: './enjeux-ird-consultance-scientifique-ponctuelle-view-admin.component.html',
  styleUrls: ['./enjeux-ird-consultance-scientifique-ponctuelle-view-admin.component.css']
})
export class EnjeuxIrdConsultanceScientifiquePonctuelleViewAdminComponent implements OnInit {
