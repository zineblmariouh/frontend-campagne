...
@Component({
  selector: 'app-enjeux-ird-encadrement-doctorant-edit-admin',
  templateUrl: './enjeux-ird-encadrement-doctorant-edit-admin.component.html',
  styleUrls: ['./enjeux-ird-encadrement-doctorant-edit-admin.component.css']
})
export class EnjeuxIrdEncadrementDoctorantEditAdminComponent implements OnInit {
