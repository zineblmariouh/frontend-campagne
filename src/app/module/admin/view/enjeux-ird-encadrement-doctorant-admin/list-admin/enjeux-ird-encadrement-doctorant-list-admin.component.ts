...
@Component({
  selector: 'app-enjeux-ird-encadrement-doctorant-list-admin',
  templateUrl: './enjeux-ird-encadrement-doctorant-list-admin.component.html',
  styleUrls: ['./enjeux-ird-encadrement-doctorant-list-admin.component.css']
})
export class EnjeuxIrdEncadrementDoctorantListAdminComponent implements OnInit {
   // declarations
