...
@Component({
  selector: 'app-enseignement-enjeux-ird-edit-admin',
  templateUrl: './enseignement-enjeux-ird-edit-admin.component.html',
  styleUrls: ['./enseignement-enjeux-ird-edit-admin.component.css']
})
export class EnseignementEnjeuxIrdEditAdminComponent implements OnInit {
