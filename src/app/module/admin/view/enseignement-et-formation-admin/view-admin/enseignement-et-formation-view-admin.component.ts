...
@Component({
  selector: 'app-enseignement-et-formation-view-admin',
  templateUrl: './enseignement-et-formation-view-admin.component.html',
  styleUrls: ['./enseignement-et-formation-view-admin.component.css']
})
export class EnseignementEtFormationViewAdminComponent implements OnInit {
