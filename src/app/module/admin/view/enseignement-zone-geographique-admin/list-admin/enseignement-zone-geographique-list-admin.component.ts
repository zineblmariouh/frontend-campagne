...
@Component({
  selector: 'app-enseignement-zone-geographique-list-admin',
  templateUrl: './enseignement-zone-geographique-list-admin.component.html',
  styleUrls: ['./enseignement-zone-geographique-list-admin.component.css']
})
export class EnseignementZoneGeographiqueListAdminComponent implements OnInit {
   // declarations
