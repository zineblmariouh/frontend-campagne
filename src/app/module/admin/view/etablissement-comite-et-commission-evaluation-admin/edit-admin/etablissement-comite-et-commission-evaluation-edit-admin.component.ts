...
@Component({
  selector: 'app-etablissement-comite-et-commission-evaluation-edit-admin',
  templateUrl: './etablissement-comite-et-commission-evaluation-edit-admin.component.html',
  styleUrls: ['./etablissement-comite-et-commission-evaluation-edit-admin.component.css']
})
export class EtablissementComiteEtCommissionEvaluationEditAdminComponent implements OnInit {
