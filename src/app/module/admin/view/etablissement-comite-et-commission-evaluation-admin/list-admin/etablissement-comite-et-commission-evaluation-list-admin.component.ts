...
@Component({
  selector: 'app-etablissement-comite-et-commission-evaluation-list-admin',
  templateUrl: './etablissement-comite-et-commission-evaluation-list-admin.component.html',
  styleUrls: ['./etablissement-comite-et-commission-evaluation-list-admin.component.css']
})
export class EtablissementComiteEtCommissionEvaluationListAdminComponent implements OnInit {
   // declarations
