...
@Component({
  selector: 'app-etablissement-conseils-scientifique-list-admin',
  templateUrl: './etablissement-conseils-scientifique-list-admin.component.html',
  styleUrls: ['./etablissement-conseils-scientifique-list-admin.component.css']
})
export class EtablissementConseilsScientifiqueListAdminComponent implements OnInit {
   // declarations
