...
@Component({
  selector: 'app-etablissement-consultance-scientifique-ponctuelle-view-admin',
  templateUrl: './etablissement-consultance-scientifique-ponctuelle-view-admin.component.html',
  styleUrls: ['./etablissement-consultance-scientifique-ponctuelle-view-admin.component.css']
})
export class EtablissementConsultanceScientifiquePonctuelleViewAdminComponent implements OnInit {
