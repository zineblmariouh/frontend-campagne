...
@Component({
  selector: 'app-etablissement-enseignement-view-admin',
  templateUrl: './etablissement-enseignement-view-admin.component.html',
  styleUrls: ['./etablissement-enseignement-view-admin.component.css']
})
export class EtablissementEnseignementViewAdminComponent implements OnInit {
