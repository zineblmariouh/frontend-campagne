...
@Component({
  selector: 'app-evenement-colloque-scienntifique-pays-edit-admin',
  templateUrl: './evenement-colloque-scienntifique-pays-edit-admin.component.html',
  styleUrls: ['./evenement-colloque-scienntifique-pays-edit-admin.component.css']
})
export class EvenementColloqueScienntifiquePaysEditAdminComponent implements OnInit {
