...
@Component({
  selector: 'app-evenement-colloque-scienntifique-pays-list-admin',
  templateUrl: './evenement-colloque-scienntifique-pays-list-admin.component.html',
  styleUrls: ['./evenement-colloque-scienntifique-pays-list-admin.component.css']
})
export class EvenementColloqueScienntifiquePaysListAdminComponent implements OnInit {
   // declarations
