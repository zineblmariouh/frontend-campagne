...
@Component({
  selector: 'app-evenement-colloque-scienntifique-pays-view-admin',
  templateUrl: './evenement-colloque-scienntifique-pays-view-admin.component.html',
  styleUrls: ['./evenement-colloque-scienntifique-pays-view-admin.component.css']
})
export class EvenementColloqueScienntifiquePaysViewAdminComponent implements OnInit {
