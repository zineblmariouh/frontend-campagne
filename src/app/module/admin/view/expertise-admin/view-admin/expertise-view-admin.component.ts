...
@Component({
  selector: 'app-expertise-view-admin',
  templateUrl: './expertise-view-admin.component.html',
  styleUrls: ['./expertise-view-admin.component.css']
})
export class ExpertiseViewAdminComponent implements OnInit {
