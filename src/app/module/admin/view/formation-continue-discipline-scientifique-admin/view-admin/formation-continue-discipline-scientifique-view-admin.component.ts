...
@Component({
  selector: 'app-formation-continue-discipline-scientifique-view-admin',
  templateUrl: './formation-continue-discipline-scientifique-view-admin.component.html',
  styleUrls: ['./formation-continue-discipline-scientifique-view-admin.component.css']
})
export class FormationContinueDisciplineScientifiqueViewAdminComponent implements OnInit {
