...
@Component({
  selector: 'app-formation-continue-enjeux-ird-edit-admin',
  templateUrl: './formation-continue-enjeux-ird-edit-admin.component.html',
  styleUrls: ['./formation-continue-enjeux-ird-edit-admin.component.css']
})
export class FormationContinueEnjeuxIrdEditAdminComponent implements OnInit {
