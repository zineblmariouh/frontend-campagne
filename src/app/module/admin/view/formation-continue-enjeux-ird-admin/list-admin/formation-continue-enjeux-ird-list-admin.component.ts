...
@Component({
  selector: 'app-formation-continue-enjeux-ird-list-admin',
  templateUrl: './formation-continue-enjeux-ird-list-admin.component.html',
  styleUrls: ['./formation-continue-enjeux-ird-list-admin.component.css']
})
export class FormationContinueEnjeuxIrdListAdminComponent implements OnInit {
   // declarations
