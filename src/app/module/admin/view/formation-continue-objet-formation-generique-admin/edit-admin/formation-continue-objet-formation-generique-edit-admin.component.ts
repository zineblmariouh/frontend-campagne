...
@Component({
  selector: 'app-formation-continue-objet-formation-generique-edit-admin',
  templateUrl: './formation-continue-objet-formation-generique-edit-admin.component.html',
  styleUrls: ['./formation-continue-objet-formation-generique-edit-admin.component.css']
})
export class FormationContinueObjetFormationGeneriqueEditAdminComponent implements OnInit {
