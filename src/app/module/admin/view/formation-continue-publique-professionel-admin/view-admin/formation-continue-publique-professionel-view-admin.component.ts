...
@Component({
  selector: 'app-formation-continue-publique-professionel-view-admin',
  templateUrl: './formation-continue-publique-professionel-view-admin.component.html',
  styleUrls: ['./formation-continue-publique-professionel-view-admin.component.css']
})
export class FormationContinuePubliqueProfessionelViewAdminComponent implements OnInit {
