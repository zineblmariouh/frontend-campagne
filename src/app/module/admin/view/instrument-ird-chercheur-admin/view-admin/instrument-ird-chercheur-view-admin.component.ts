...
@Component({
  selector: 'app-instrument-ird-chercheur-view-admin',
  templateUrl: './instrument-ird-chercheur-view-admin.component.html',
  styleUrls: ['./instrument-ird-chercheur-view-admin.component.css']
})
export class InstrumentIrdChercheurViewAdminComponent implements OnInit {
