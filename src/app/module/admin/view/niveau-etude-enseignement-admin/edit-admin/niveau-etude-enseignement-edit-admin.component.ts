...
@Component({
  selector: 'app-niveau-etude-enseignement-edit-admin',
  templateUrl: './niveau-etude-enseignement-edit-admin.component.html',
  styleUrls: ['./niveau-etude-enseignement-edit-admin.component.css']
})
export class NiveauEtudeEnseignementEditAdminComponent implements OnInit {
