...
@Component({
  selector: 'app-niveau-etude-enseignement-list-admin',
  templateUrl: './niveau-etude-enseignement-list-admin.component.html',
  styleUrls: ['./niveau-etude-enseignement-list-admin.component.css']
})
export class NiveauEtudeEnseignementListAdminComponent implements OnInit {
   // declarations
