...
@Component({
  selector: 'app-niveau-etude-enseignement-view-admin',
  templateUrl: './niveau-etude-enseignement-view-admin.component.html',
  styleUrls: ['./niveau-etude-enseignement-view-admin.component.css']
})
export class NiveauEtudeEnseignementViewAdminComponent implements OnInit {
