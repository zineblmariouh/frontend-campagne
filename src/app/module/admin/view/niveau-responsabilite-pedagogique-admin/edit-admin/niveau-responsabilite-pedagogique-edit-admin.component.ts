...
@Component({
  ...
  templateUrl: './niveau-responsabilite-pedagogique-edit-admin.component.html',
  styleUrls: ['./niveau-responsabilite-pedagogique-edit-admin.component.css']
})
export class NiveauResponsabilitePedagogiqueEditAdminComponent implements OnInit {
