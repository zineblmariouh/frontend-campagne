...
@Component({
  ...
  templateUrl: './niveau-responsabilite-pedagogique-list-admin.component.html',
  styleUrls: ['./niveau-responsabilite-pedagogique-list-admin.component.css']
})
export class NiveauResponsabilitePedagogiqueListAdminComponent implements OnInit {
   // declarations
