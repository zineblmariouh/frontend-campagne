...
@Component({
  selector: 'app-objet-formation-generique-de-responsabilite-pedagogique-list-admin',
  templateUrl: './objet-formation-generique-de-responsabilite-pedagogique-list-admin.component.html',
  styleUrls: ['./objet-formation-generique-de-responsabilite-pedagogique-list-admin.component.css']
})
export class ObjetFormationGeneriqueDeResponsabilitePedagogiqueListAdminComponent implements OnInit {
   // declarations
