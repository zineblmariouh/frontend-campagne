...
@Component({
  selector: 'app-outil-pedagogique-edit-admin',
  templateUrl: './outil-pedagogique-edit-admin.component.html',
  styleUrls: ['./outil-pedagogique-edit-admin.component.css']
})
export class OutilPedagogiqueEditAdminComponent implements OnInit {
