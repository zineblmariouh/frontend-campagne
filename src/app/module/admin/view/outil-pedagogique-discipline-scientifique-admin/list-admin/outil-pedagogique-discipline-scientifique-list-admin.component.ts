...
@Component({
  selector: 'app-outil-pedagogique-discipline-scientifique-list-admin',
  templateUrl: './outil-pedagogique-discipline-scientifique-list-admin.component.html',
  styleUrls: ['./outil-pedagogique-discipline-scientifique-list-admin.component.css']
})
export class OutilPedagogiqueDisciplineScientifiqueListAdminComponent implements OnInit {
   // declarations
