...
@Component({
  selector: 'app-outil-pedagogique-discipline-scientifique-view-admin',
  templateUrl: './outil-pedagogique-discipline-scientifique-view-admin.component.html',
  styleUrls: ['./outil-pedagogique-discipline-scientifique-view-admin.component.css']
})
export class OutilPedagogiqueDisciplineScientifiqueViewAdminComponent implements OnInit {
