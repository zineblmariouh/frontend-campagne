...
@Component({
  selector: 'app-outil-pedagogique-enjeux-ird-list-admin',
  templateUrl: './outil-pedagogique-enjeux-ird-list-admin.component.html',
  styleUrls: ['./outil-pedagogique-enjeux-ird-list-admin.component.css']
})
export class OutilPedagogiqueEnjeuxIrdListAdminComponent implements OnInit {
   // declarations
