...
@Component({
  selector: 'app-outil-pedagogique-instrument-ird-create-admin',
  templateUrl: './outil-pedagogique-instrument-ird-create-admin.component.html',
  styleUrls: ['./outil-pedagogique-instrument-ird-create-admin.component.css']
})
export class OutilPedagogiqueInstrumentIrdCreateAdminComponent implements OnInit {
