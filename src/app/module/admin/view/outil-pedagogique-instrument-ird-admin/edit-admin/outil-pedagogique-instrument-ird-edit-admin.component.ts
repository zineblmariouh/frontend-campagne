...
@Component({
  selector: 'app-outil-pedagogique-instrument-ird-edit-admin',
  templateUrl: './outil-pedagogique-instrument-ird-edit-admin.component.html',
  styleUrls: ['./outil-pedagogique-instrument-ird-edit-admin.component.css']
})
export class OutilPedagogiqueInstrumentIrdEditAdminComponent implements OnInit {
