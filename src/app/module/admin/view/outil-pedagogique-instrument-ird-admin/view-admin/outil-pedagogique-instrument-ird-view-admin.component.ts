...
@Component({
  selector: 'app-outil-pedagogique-instrument-ird-view-admin',
  templateUrl: './outil-pedagogique-instrument-ird-view-admin.component.html',
  styleUrls: ['./outil-pedagogique-instrument-ird-view-admin.component.css']
})
export class OutilPedagogiqueInstrumentIrdViewAdminComponent implements OnInit {
