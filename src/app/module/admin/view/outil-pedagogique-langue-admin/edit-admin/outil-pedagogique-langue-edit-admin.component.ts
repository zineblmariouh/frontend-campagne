...
@Component({
  selector: 'app-outil-pedagogique-langue-edit-admin',
  templateUrl: './outil-pedagogique-langue-edit-admin.component.html',
  styleUrls: ['./outil-pedagogique-langue-edit-admin.component.css']
})
export class OutilPedagogiqueLangueEditAdminComponent implements OnInit {
