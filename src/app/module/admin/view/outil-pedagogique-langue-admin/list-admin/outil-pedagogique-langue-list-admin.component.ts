...
@Component({
  selector: 'app-outil-pedagogique-langue-list-admin',
  templateUrl: './outil-pedagogique-langue-list-admin.component.html',
  styleUrls: ['./outil-pedagogique-langue-list-admin.component.css']
})
export class OutilPedagogiqueLangueListAdminComponent implements OnInit {
   // declarations
