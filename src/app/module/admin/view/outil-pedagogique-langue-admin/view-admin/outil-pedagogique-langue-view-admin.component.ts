...
@Component({
  selector: 'app-outil-pedagogique-langue-view-admin',
  templateUrl: './outil-pedagogique-langue-view-admin.component.html',
  styleUrls: ['./outil-pedagogique-langue-view-admin.component.css']
})
export class OutilPedagogiqueLangueViewAdminComponent implements OnInit {
