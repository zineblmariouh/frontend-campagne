...
@Component({
  selector: 'app-outil-pedagogique-pays-conception-view-admin',
  templateUrl: './outil-pedagogique-pays-conception-view-admin.component.html',
  styleUrls: ['./outil-pedagogique-pays-conception-view-admin.component.css']
})
export class OutilPedagogiquePaysConceptionViewAdminComponent implements OnInit {
