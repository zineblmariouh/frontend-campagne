...
@Component({
  selector: 'app-outil-pedagogique-pays-diffusion-list-admin',
  templateUrl: './outil-pedagogique-pays-diffusion-list-admin.component.html',
  styleUrls: ['./outil-pedagogique-pays-diffusion-list-admin.component.css']
})
export class OutilPedagogiquePaysDiffusionListAdminComponent implements OnInit {
   // declarations
