...
@Component({
  selector: 'app-outil-pedagogique-publique-cible-create-admin',
  templateUrl: './outil-pedagogique-publique-cible-create-admin.component.html',
  styleUrls: ['./outil-pedagogique-publique-cible-create-admin.component.css']
})
export class OutilPedagogiquePubliqueCibleCreateAdminComponent implements OnInit {
