...
@Component({
  selector: 'app-outil-pedagogique-publique-cible-edit-admin',
  templateUrl: './outil-pedagogique-publique-cible-edit-admin.component.html',
  styleUrls: ['./outil-pedagogique-publique-cible-edit-admin.component.css']
})
export class OutilPedagogiquePubliqueCibleEditAdminComponent implements OnInit {
