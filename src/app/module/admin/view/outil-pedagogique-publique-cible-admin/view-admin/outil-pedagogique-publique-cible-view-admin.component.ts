...
@Component({
  selector: 'app-outil-pedagogique-publique-cible-view-admin',
  templateUrl: './outil-pedagogique-publique-cible-view-admin.component.html',
  styleUrls: ['./outil-pedagogique-publique-cible-view-admin.component.css']
})
export class OutilPedagogiquePubliqueCibleViewAdminComponent implements OnInit {
