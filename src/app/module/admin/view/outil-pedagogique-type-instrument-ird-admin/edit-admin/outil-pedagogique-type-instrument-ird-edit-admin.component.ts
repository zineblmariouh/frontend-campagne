...
@Component({
  selector: 'app-outil-pedagogique-type-instrument-ird-edit-admin',
  templateUrl: './outil-pedagogique-type-instrument-ird-edit-admin.component.html',
  styleUrls: ['./outil-pedagogique-type-instrument-ird-edit-admin.component.css']
})
export class OutilPedagogiqueTypeInstrumentIrdEditAdminComponent implements OnInit {
