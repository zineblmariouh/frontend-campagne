...
@Component({
  selector: 'app-outil-pedagogique-type-instrument-ird-list-admin',
  templateUrl: './outil-pedagogique-type-instrument-ird-list-admin.component.html',
  styleUrls: ['./outil-pedagogique-type-instrument-ird-list-admin.component.css']
})
export class OutilPedagogiqueTypeInstrumentIrdListAdminComponent implements OnInit {
   // declarations
