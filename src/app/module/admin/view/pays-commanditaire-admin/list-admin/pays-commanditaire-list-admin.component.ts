...
@Component({
  selector: 'app-pays-commanditaire-list-admin',
  templateUrl: './pays-commanditaire-list-admin.component.html',
  styleUrls: ['./pays-commanditaire-list-admin.component.css']
})
export class PaysCommanditaireListAdminComponent implements OnInit {
   // declarations
