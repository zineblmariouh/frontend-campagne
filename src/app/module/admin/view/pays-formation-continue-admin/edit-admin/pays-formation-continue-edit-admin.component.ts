...
@Component({
  selector: 'app-pays-formation-continue-edit-admin',
  templateUrl: './pays-formation-continue-edit-admin.component.html',
  styleUrls: ['./pays-formation-continue-edit-admin.component.css']
})
export class PaysFormationContinueEditAdminComponent implements OnInit {
