...
@Component({
  selector: 'app-pays-organisateur-rencontre-grand-publique-jeune-publique-view-admin',
  templateUrl: './pays-organisateur-rencontre-grand-publique-jeune-publique-view-admin.component.html',
  styleUrls: ['./pays-organisateur-rencontre-grand-publique-jeune-publique-view-admin.component.css']
})
export class PaysOrganisateurRencontreGrandPubliqueJeunePubliqueViewAdminComponent implements OnInit {
