...
@Component({
  selector: 'app-pays-rencontre-grand-publique-jeune-publique-edit-admin',
  templateUrl: './pays-rencontre-grand-publique-jeune-publique-edit-admin.component.html',
  styleUrls: ['./pays-rencontre-grand-publique-jeune-publique-edit-admin.component.css']
})
export class PaysRencontreGrandPubliqueJeunePubliqueEditAdminComponent implements OnInit {
