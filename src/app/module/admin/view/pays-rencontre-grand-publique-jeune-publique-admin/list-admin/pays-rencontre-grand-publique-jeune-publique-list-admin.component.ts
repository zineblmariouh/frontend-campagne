...
@Component({
  selector: 'app-pays-rencontre-grand-publique-jeune-publique-list-admin',
  templateUrl: './pays-rencontre-grand-publique-jeune-publique-list-admin.component.html',
  styleUrls: ['./pays-rencontre-grand-publique-jeune-publique-list-admin.component.css']
})
export class PaysRencontreGrandPubliqueJeunePubliqueListAdminComponent implements OnInit {
   // declarations
