...
@Component({
  selector: 'app-pays-zone-geographique-edit-admin',
  templateUrl: './pays-zone-geographique-edit-admin.component.html',
  styleUrls: ['./pays-zone-geographique-edit-admin.component.css']
})
export class PaysZoneGeographiqueEditAdminComponent implements OnInit {
