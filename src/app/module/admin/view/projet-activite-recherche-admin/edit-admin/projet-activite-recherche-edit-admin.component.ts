...
@Component({
  selector: 'app-projet-activite-recherche-edit-admin',
  templateUrl: './projet-activite-recherche-edit-admin.component.html',
  styleUrls: ['./projet-activite-recherche-edit-admin.component.css']
})
export class ProjetActiviteRechercheEditAdminComponent implements OnInit {
