...
@Component({
  selector: 'app-projet-activite-recherche-view-admin',
  templateUrl: './projet-activite-recherche-view-admin.component.html',
  styleUrls: ['./projet-activite-recherche-view-admin.component.css']
})
export class ProjetActiviteRechercheViewAdminComponent implements OnInit {
