...
@Component({
  selector: 'app-projet-activite-recherche-detail-edit-admin',
  templateUrl: './projet-activite-recherche-detail-edit-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-edit-admin.component.css']
})
export class ProjetActiviteRechercheDetailEditAdminComponent implements OnInit {
