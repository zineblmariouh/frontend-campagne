...
@Component({
  selector: 'app-projet-activite-recherche-detail-list-admin',
  templateUrl: './projet-activite-recherche-detail-list-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-list-admin.component.css']
})
export class ProjetActiviteRechercheDetailListAdminComponent implements OnInit {
   // declarations
