...
@Component({
  selector: 'app-projet-activite-recherche-detail-view-admin',
  templateUrl: './projet-activite-recherche-detail-view-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-view-admin.component.css']
})
export class ProjetActiviteRechercheDetailViewAdminComponent implements OnInit {
