...
@Component({
  selector: 'app-projet-activite-recherche-detail-enjeux-ird-edit-admin',
  templateUrl: './projet-activite-recherche-detail-enjeux-ird-edit-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-enjeux-ird-edit-admin.component.css']
})
export class ProjetActiviteRechercheDetailEnjeuxIrdEditAdminComponent implements OnInit {
