...
@Component({
  selector: 'app-projet-activite-recherche-detail-enjeux-ird-list-admin',
  templateUrl: './projet-activite-recherche-detail-enjeux-ird-list-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-enjeux-ird-list-admin.component.css']
})
export class ProjetActiviteRechercheDetailEnjeuxIrdListAdminComponent implements OnInit {
   // declarations
