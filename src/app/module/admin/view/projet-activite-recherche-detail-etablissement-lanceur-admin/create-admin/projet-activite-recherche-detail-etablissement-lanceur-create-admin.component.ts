...
@Component({
  selector: 'app-projet-activite-recherche-detail-etablissement-lanceur-create-admin',
  templateUrl: './projet-activite-recherche-detail-etablissement-lanceur-create-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-etablissement-lanceur-create-admin.component.css']
})
export class ProjetActiviteRechercheDetailEtablissementLanceurCreateAdminComponent implements OnInit {
