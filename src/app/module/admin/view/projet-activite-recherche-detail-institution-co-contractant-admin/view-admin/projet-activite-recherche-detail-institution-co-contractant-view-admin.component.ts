...
@Component({
  selector: 'app-projet-activite-recherche-detail-institution-co-contractant-view-admin',
  templateUrl: './projet-activite-recherche-detail-institution-co-contractant-view-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-institution-co-contractant-view-admin.component.css']
})
export class ProjetActiviteRechercheDetailInstitutionCoContractantViewAdminComponent implements OnInit {
