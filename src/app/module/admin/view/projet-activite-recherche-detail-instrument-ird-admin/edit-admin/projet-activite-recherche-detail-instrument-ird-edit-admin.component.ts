...
@Component({
  selector: 'app-projet-activite-recherche-detail-instrument-ird-edit-admin',
  templateUrl: './projet-activite-recherche-detail-instrument-ird-edit-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-instrument-ird-edit-admin.component.css']
})
export class ProjetActiviteRechercheDetailInstrumentIrdEditAdminComponent implements OnInit {
