...
@Component({
  selector: 'app-projet-activite-recherche-detail-instrument-ird-list-admin',
  templateUrl: './projet-activite-recherche-detail-instrument-ird-list-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-instrument-ird-list-admin.component.css']
})
export class ProjetActiviteRechercheDetailInstrumentIrdListAdminComponent implements OnInit {
   // declarations
