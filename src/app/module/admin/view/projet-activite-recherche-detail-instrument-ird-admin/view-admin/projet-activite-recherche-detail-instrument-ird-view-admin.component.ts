...
@Component({
  selector: 'app-projet-activite-recherche-detail-instrument-ird-view-admin',
  templateUrl: './projet-activite-recherche-detail-instrument-ird-view-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-instrument-ird-view-admin.component.css']
})
export class ProjetActiviteRechercheDetailInstrumentIrdViewAdminComponent implements OnInit {
