...
@Component({
  selector: 'app-projet-activite-recherche-detail-pays-edit-admin',
  templateUrl: './projet-activite-recherche-detail-pays-edit-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-pays-edit-admin.component.css']
})
export class ProjetActiviteRechercheDetailPaysEditAdminComponent implements OnInit {
