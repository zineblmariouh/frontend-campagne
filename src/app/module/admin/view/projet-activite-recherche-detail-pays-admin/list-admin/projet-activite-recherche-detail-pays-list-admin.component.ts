...
@Component({
  selector: 'app-projet-activite-recherche-detail-pays-list-admin',
  templateUrl: './projet-activite-recherche-detail-pays-list-admin.component.html',
  styleUrls: ['./projet-activite-recherche-detail-pays-list-admin.component.css']
})
export class ProjetActiviteRechercheDetailPaysListAdminComponent implements OnInit {
   // declarations
