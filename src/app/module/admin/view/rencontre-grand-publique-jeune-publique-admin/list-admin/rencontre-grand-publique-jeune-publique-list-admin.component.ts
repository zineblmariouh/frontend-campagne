...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-list-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-list-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-list-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueListAdminComponent implements OnInit {
   // declarations
