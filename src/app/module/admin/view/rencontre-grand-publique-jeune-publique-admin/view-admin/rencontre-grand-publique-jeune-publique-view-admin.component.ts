...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-view-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-view-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-view-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueViewAdminComponent implements OnInit {
