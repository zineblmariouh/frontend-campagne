...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-discipline-scientifique-edit-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-discipline-scientifique-edit-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-discipline-scientifique-edit-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueDisciplineScientifiqueEditAdminComponent implements OnInit {
