...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-discipline-scientifique-view-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-discipline-scientifique-view-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-discipline-scientifique-view-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueDisciplineScientifiqueViewAdminComponent implements OnInit {
