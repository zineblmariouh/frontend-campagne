...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-enjeux-ird-edit-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-enjeux-ird-edit-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-enjeux-ird-edit-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueEnjeuxIrdEditAdminComponent implements OnInit {
