...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-enjeux-ird-view-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-enjeux-ird-view-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-enjeux-ird-view-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueEnjeuxIrdViewAdminComponent implements OnInit {
