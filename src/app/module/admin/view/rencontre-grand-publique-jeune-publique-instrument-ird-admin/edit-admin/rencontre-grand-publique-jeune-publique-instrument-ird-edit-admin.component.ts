...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-instrument-ird-edit-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-instrument-ird-edit-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-instrument-ird-edit-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueInstrumentIrdEditAdminComponent implements OnInit {
