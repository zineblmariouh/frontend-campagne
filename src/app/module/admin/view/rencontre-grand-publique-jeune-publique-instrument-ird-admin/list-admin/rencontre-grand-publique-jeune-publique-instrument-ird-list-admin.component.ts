...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-instrument-ird-list-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-instrument-ird-list-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-instrument-ird-list-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueInstrumentIrdListAdminComponent implements OnInit {
   // declarations
