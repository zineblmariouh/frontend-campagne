...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-periode-edit-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-periode-edit-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-periode-edit-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliquePeriodeEditAdminComponent implements OnInit {
