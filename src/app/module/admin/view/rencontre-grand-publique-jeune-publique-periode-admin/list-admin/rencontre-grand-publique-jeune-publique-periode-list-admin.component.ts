...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-periode-list-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-periode-list-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-periode-list-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliquePeriodeListAdminComponent implements OnInit {
   // declarations
