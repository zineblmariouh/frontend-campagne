...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-periode-view-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-periode-view-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-periode-view-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliquePeriodeViewAdminComponent implements OnInit {
