...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-type-instrument-ird-edit-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-type-instrument-ird-edit-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-type-instrument-ird-edit-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueTypeInstrumentIrdEditAdminComponent implements OnInit {
