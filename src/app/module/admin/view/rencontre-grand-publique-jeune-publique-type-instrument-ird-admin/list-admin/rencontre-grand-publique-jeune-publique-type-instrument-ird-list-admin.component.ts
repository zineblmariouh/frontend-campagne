...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-type-instrument-ird-list-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-type-instrument-ird-list-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-type-instrument-ird-list-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueTypeInstrumentIrdListAdminComponent implements OnInit {
   // declarations
