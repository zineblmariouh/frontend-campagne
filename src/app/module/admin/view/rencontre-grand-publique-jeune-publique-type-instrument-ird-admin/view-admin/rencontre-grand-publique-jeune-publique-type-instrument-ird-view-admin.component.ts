...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-type-instrument-ird-view-admin',
  templateUrl: './rencontre-grand-publique-jeune-publique-type-instrument-ird-view-admin.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-type-instrument-ird-view-admin.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueTypeInstrumentIrdViewAdminComponent implements OnInit {
