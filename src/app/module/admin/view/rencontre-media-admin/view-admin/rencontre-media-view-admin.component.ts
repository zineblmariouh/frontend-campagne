...
@Component({
  selector: 'app-rencontre-media-view-admin',
  templateUrl: './rencontre-media-view-admin.component.html',
  styleUrls: ['./rencontre-media-view-admin.component.css']
})
export class RencontreMediaViewAdminComponent implements OnInit {
