...
@Component({
  selector: 'app-rencontre-media-discipline-scientifique-list-admin',
  templateUrl: './rencontre-media-discipline-scientifique-list-admin.component.html',
  styleUrls: ['./rencontre-media-discipline-scientifique-list-admin.component.css']
})
export class RencontreMediaDisciplineScientifiqueListAdminComponent implements OnInit {
   // declarations
