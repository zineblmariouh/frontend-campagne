...
@Component({
  selector: 'app-rencontre-media-discipline-scientifique-view-admin',
  templateUrl: './rencontre-media-discipline-scientifique-view-admin.component.html',
  styleUrls: ['./rencontre-media-discipline-scientifique-view-admin.component.css']
})
export class RencontreMediaDisciplineScientifiqueViewAdminComponent implements OnInit {
