...
@Component({
  selector: 'app-rencontre-media-enjeux-ird-list-admin',
  templateUrl: './rencontre-media-enjeux-ird-list-admin.component.html',
  styleUrls: ['./rencontre-media-enjeux-ird-list-admin.component.css']
})
export class RencontreMediaEnjeuxIrdListAdminComponent implements OnInit {
   // declarations
