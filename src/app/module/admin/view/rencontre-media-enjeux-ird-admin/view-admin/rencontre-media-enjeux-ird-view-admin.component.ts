...
@Component({
  selector: 'app-rencontre-media-enjeux-ird-view-admin',
  templateUrl: './rencontre-media-enjeux-ird-view-admin.component.html',
  styleUrls: ['./rencontre-media-enjeux-ird-view-admin.component.css']
})
export class RencontreMediaEnjeuxIrdViewAdminComponent implements OnInit {
