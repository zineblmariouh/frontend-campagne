...
@Component({
  selector: 'app-rencontre-media-periode-edit-admin',
  templateUrl: './rencontre-media-periode-edit-admin.component.html',
  styleUrls: ['./rencontre-media-periode-edit-admin.component.css']
})
export class RencontreMediaPeriodeEditAdminComponent implements OnInit {
