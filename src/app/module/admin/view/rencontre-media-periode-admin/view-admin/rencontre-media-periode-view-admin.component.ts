...
@Component({
  selector: 'app-rencontre-media-periode-view-admin',
  templateUrl: './rencontre-media-periode-view-admin.component.html',
  styleUrls: ['./rencontre-media-periode-view-admin.component.css']
})
export class RencontreMediaPeriodeViewAdminComponent implements OnInit {
