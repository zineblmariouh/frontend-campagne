...
@Component({
  selector: 'app-responsabilite-pedagogique-edit-admin',
  templateUrl: './responsabilite-pedagogique-edit-admin.component.html',
  styleUrls: ['./responsabilite-pedagogique-edit-admin.component.css']
})
export class ResponsabilitePedagogiqueEditAdminComponent implements OnInit {
