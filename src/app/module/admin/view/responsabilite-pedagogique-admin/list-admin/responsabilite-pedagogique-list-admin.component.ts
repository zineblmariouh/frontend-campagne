...
@Component({
  selector: 'app-responsabilite-pedagogique-list-admin',
  templateUrl: './responsabilite-pedagogique-list-admin.component.html',
  styleUrls: ['./responsabilite-pedagogique-list-admin.component.css']
})
export class ResponsabilitePedagogiqueListAdminComponent implements OnInit {
   // declarations
