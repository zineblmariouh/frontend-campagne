...
@Component({
  selector: 'app-responsabilite-pedagogique-view-admin',
  templateUrl: './responsabilite-pedagogique-view-admin.component.html',
  styleUrls: ['./responsabilite-pedagogique-view-admin.component.css']
})
export class ResponsabilitePedagogiqueViewAdminComponent implements OnInit {
