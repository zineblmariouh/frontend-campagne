...
@Component({
  selector: 'app-responsabilite-pedagogique-enjeux-ird-edit-admin',
  templateUrl: './responsabilite-pedagogique-enjeux-ird-edit-admin.component.html',
  styleUrls: ['./responsabilite-pedagogique-enjeux-ird-edit-admin.component.css']
})
export class ResponsabilitePedagogiqueEnjeuxIrdEditAdminComponent implements OnInit {
