...
@Component({
  selector: 'app-responsabilite-pedagogique-etablissement-view-admin',
  templateUrl: './responsabilite-pedagogique-etablissement-view-admin.component.html',
  styleUrls: ['./responsabilite-pedagogique-etablissement-view-admin.component.css']
})
export class ResponsabilitePedagogiqueEtablissementViewAdminComponent implements OnInit {
