...
@Component({
  selector: 'app-responsabilite-pedagogique-pays-edit-admin',
  templateUrl: './responsabilite-pedagogique-pays-edit-admin.component.html',
  styleUrls: ['./responsabilite-pedagogique-pays-edit-admin.component.css']
})
export class ResponsabilitePedagogiquePaysEditAdminComponent implements OnInit {
