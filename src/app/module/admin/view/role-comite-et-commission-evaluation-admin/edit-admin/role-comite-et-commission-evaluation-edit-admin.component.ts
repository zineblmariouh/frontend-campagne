...
@Component({
  selector: 'app-role-comite-et-commission-evaluation-edit-admin',
  templateUrl: './role-comite-et-commission-evaluation-edit-admin.component.html',
  styleUrls: ['./role-comite-et-commission-evaluation-edit-admin.component.css']
})
export class RoleComiteEtCommissionEvaluationEditAdminComponent implements OnInit {
