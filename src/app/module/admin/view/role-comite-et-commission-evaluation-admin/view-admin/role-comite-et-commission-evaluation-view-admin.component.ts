...
@Component({
  selector: 'app-role-comite-et-commission-evaluation-view-admin',
  templateUrl: './role-comite-et-commission-evaluation-view-admin.component.html',
  styleUrls: ['./role-comite-et-commission-evaluation-view-admin.component.css']
})
export class RoleComiteEtCommissionEvaluationViewAdminComponent implements OnInit {
