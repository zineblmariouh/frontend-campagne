...
@Component({
  selector: 'app-savoir-et-innovation-list-admin',
  templateUrl: './savoir-et-innovation-list-admin.component.html',
  styleUrls: ['./savoir-et-innovation-list-admin.component.css']
})
export class SavoirEtInnovationListAdminComponent implements OnInit {
   // declarations
    ...
    public async loadSavoirEtInnovations(){
       const chercheur = this.authService.authenticatedUserByAdmin();
        ...
        if (chercheur !== null){
            ...
            isPermistted ? this.savoirEtInnovationService.findByChercheurId(chercheur.id).subscribe(savoirEtInnovations => this.savoirEtInnovations = savoirEtInnovations,error => console.log(error))
         ...
         if(isPermistted){
          this.savoirEtInnovationService.findByIdWithAssociatedList(savoirEtInnovation).subscribe(res => {
           this.selectedSavoirEtInnovation = res;
            this.editSavoirEtInnovationDialog = true;
          });
        }else{
