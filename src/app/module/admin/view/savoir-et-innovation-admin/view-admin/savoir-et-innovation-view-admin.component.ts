...
@Component({
  selector: 'app-savoir-et-innovation-view-admin',
  templateUrl: './savoir-et-innovation-view-admin.component.html',
  styleUrls: ['./savoir-et-innovation-view-admin.component.css']
})
export class SavoirEtInnovationViewAdminComponent implements OnInit {
