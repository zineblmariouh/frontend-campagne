...
@Component({
  selector: 'app-type-etude-enseignement-list-admin',
  templateUrl: './type-etude-enseignement-list-admin.component.html',
  styleUrls: ['./type-etude-enseignement-list-admin.component.css']
})
export class TypeEtudeEnseignementListAdminComponent implements OnInit {
   // declarations
