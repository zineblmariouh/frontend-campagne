...
@Component({
  selector: 'app-type-expertise-evaluation-comite-et-commission-evaluation-edit-admin',
  templateUrl: './type-expertise-evaluation-comite-et-commission-evaluation-edit-admin.component.html',
  styleUrls: ['./type-expertise-evaluation-comite-et-commission-evaluation-edit-admin.component.css']
})
export class TypeExpertiseEvaluationComiteEtCommissionEvaluationEditAdminComponent implements OnInit {
