...
@Component({
  selector: 'app-type-instrument-ird-chercheur-list-admin',
  templateUrl: './type-instrument-ird-chercheur-list-admin.component.html',
  styleUrls: ['./type-instrument-ird-chercheur-list-admin.component.css']
})
export class TypeInstrumentIrdChercheurListAdminComponent implements OnInit {
   // declarations
