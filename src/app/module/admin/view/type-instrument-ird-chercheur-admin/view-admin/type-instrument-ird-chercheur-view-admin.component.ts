...
@Component({
  selector: 'app-type-instrument-ird-chercheur-view-admin',
  templateUrl: './type-instrument-ird-chercheur-view-admin.component.html',
  styleUrls: ['./type-instrument-ird-chercheur-view-admin.component.css']
})
export class TypeInstrumentIrdChercheurViewAdminComponent implements OnInit {
