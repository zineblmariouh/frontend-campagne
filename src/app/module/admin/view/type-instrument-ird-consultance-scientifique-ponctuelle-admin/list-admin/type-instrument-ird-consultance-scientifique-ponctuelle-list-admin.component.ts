...
@Component({
  selector: 'app-type-instrument-ird-consultance-scientifique-ponctuelle-list-admin',
  templateUrl: './type-instrument-ird-consultance-scientifique-ponctuelle-list-admin.component.html',
  styleUrls: ['./type-instrument-ird-consultance-scientifique-ponctuelle-list-admin.component.css']
})
export class TypeInstrumentIrdConsultanceScientifiquePonctuelleListAdminComponent implements OnInit {
   // declarations
