...
@Component({
  selector: 'app-type-instrument-ird-consultance-scientifique-ponctuelle-view-admin',
  templateUrl: './type-instrument-ird-consultance-scientifique-ponctuelle-view-admin.component.html',
  styleUrls: ['./type-instrument-ird-consultance-scientifique-ponctuelle-view-admin.component.css']
})
export class TypeInstrumentIrdConsultanceScientifiquePonctuelleViewAdminComponent implements OnInit {
