...
@Component({
  selector: 'app-type-outil-pedagogique-edit-admin',
  templateUrl: './type-outil-pedagogique-edit-admin.component.html',
  styleUrls: ['./type-outil-pedagogique-edit-admin.component.css']
})
export class TypeOutilPedagogiqueEditAdminComponent implements OnInit {
