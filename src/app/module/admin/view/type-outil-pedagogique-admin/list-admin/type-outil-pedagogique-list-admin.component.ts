...
@Component({
  selector: 'app-type-outil-pedagogique-list-admin',
  templateUrl: './type-outil-pedagogique-list-admin.component.html',
  styleUrls: ['./type-outil-pedagogique-list-admin.component.css']
})
export class TypeOutilPedagogiqueListAdminComponent implements OnInit {
   // declarations
