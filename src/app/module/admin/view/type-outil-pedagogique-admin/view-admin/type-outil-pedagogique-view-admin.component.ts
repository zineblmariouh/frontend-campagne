...
@Component({
  selector: 'app-type-outil-pedagogique-view-admin',
  templateUrl: './type-outil-pedagogique-view-admin.component.html',
  styleUrls: ['./type-outil-pedagogique-view-admin.component.css']
})
export class TypeOutilPedagogiqueViewAdminComponent implements OnInit {
