...
@Component({
  selector: 'app-type-publique-rencontre-grand-publique-jeune-publique-edit-admin',
  templateUrl: './type-publique-rencontre-grand-publique-jeune-publique-edit-admin.component.html',
  styleUrls: ['./type-publique-rencontre-grand-publique-jeune-publique-edit-admin.component.css']
})
export class TypePubliqueRencontreGrandPubliqueJeunePubliqueEditAdminComponent implements OnInit {
