...
@Component({
  selector: 'app-type-publique-rencontre-grand-publique-jeune-publique-view-admin',
  templateUrl: './type-publique-rencontre-grand-publique-jeune-publique-view-admin.component.html',
  styleUrls: ['./type-publique-rencontre-grand-publique-jeune-publique-view-admin.component.css']
})
export class TypePubliqueRencontreGrandPubliqueJeunePubliqueViewAdminComponent implements OnInit {
