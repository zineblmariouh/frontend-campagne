...
@Component({
  selector: 'app-type-publique-rencontre-media-view-admin',
  templateUrl: './type-publique-rencontre-media-view-admin.component.html',
  styleUrls: ['./type-publique-rencontre-media-view-admin.component.css']
})
export class TypePubliqueRencontreMediaViewAdminComponent implements OnInit {
