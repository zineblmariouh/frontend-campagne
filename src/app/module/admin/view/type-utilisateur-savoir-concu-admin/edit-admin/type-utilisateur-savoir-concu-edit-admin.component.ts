...
@Component({
  selector: 'app-type-utilisateur-savoir-concu-edit-admin',
  templateUrl: './type-utilisateur-savoir-concu-edit-admin.component.html',
  styleUrls: ['./type-utilisateur-savoir-concu-edit-admin.component.css']
})
export class TypeUtilisateurSavoirConcuEditAdminComponent implements OnInit {
