...
@Component({
  selector: 'app-type-utilisateur-savoir-concu-list-admin',
  templateUrl: './type-utilisateur-savoir-concu-list-admin.component.html',
  styleUrls: ['./type-utilisateur-savoir-concu-list-admin.component.css']
})
export class TypeUtilisateurSavoirConcuListAdminComponent implements OnInit {
   // declarations
