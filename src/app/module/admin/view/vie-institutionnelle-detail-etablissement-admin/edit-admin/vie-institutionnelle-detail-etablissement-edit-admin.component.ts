...
@Component({
  selector: 'app-vie-institutionnelle-detail-etablissement-edit-admin',
  templateUrl: './vie-institutionnelle-detail-etablissement-edit-admin.component.html',
  styleUrls: ['./vie-institutionnelle-detail-etablissement-edit-admin.component.css']
})
export class VieInstitutionnelleDetailEtablissementEditAdminComponent implements OnInit {
