...
@Component({
  selector: 'app-vie-institutionnelle-detail-etablissement-list-admin',
  templateUrl: './vie-institutionnelle-detail-etablissement-list-admin.component.html',
  styleUrls: ['./vie-institutionnelle-detail-etablissement-list-admin.component.css']
})
export class VieInstitutionnelleDetailEtablissementListAdminComponent implements OnInit {
   // declarations
