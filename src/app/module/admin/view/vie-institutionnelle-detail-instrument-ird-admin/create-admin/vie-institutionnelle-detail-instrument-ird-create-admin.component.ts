...
@Component({
  selector: 'app-vie-institutionnelle-detail-instrument-ird-create-admin',
  templateUrl: './vie-institutionnelle-detail-instrument-ird-create-admin.component.html',
  styleUrls: ['./vie-institutionnelle-detail-instrument-ird-create-admin.component.css']
})
export class VieInstitutionnelleDetailInstrumentIrdCreateAdminComponent implements OnInit {
