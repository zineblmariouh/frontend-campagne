...
@Component({
  selector: 'app-vie-institutionnelle-detail-instrument-ird-edit-admin',
  templateUrl: './vie-institutionnelle-detail-instrument-ird-edit-admin.component.html',
  styleUrls: ['./vie-institutionnelle-detail-instrument-ird-edit-admin.component.css']
})
export class VieInstitutionnelleDetailInstrumentIrdEditAdminComponent implements OnInit {
