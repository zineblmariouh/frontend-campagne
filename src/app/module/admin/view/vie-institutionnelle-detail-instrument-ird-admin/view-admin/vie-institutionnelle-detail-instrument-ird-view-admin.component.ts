...
@Component({
  selector: 'app-vie-institutionnelle-detail-instrument-ird-view-admin',
  templateUrl: './vie-institutionnelle-detail-instrument-ird-view-admin.component.html',
  styleUrls: ['./vie-institutionnelle-detail-instrument-ird-view-admin.component.css']
})
export class VieInstitutionnelleDetailInstrumentIrdViewAdminComponent implements OnInit {
