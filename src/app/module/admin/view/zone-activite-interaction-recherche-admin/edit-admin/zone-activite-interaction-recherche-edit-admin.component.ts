...
@Component({
  selector: 'app-zone-activite-interaction-recherche-edit-admin',
  templateUrl: './zone-activite-interaction-recherche-edit-admin.component.html',
  styleUrls: ['./zone-activite-interaction-recherche-edit-admin.component.css']
})
export class ZoneActiviteInteractionRechercheEditAdminComponent implements OnInit {
