...
@Component({
  selector: 'app-zone-activite-interaction-recherche-view-admin',
  templateUrl: './zone-activite-interaction-recherche-view-admin.component.html',
  styleUrls: ['./zone-activite-interaction-recherche-view-admin.component.css']
})
export class ZoneActiviteInteractionRechercheViewAdminComponent implements OnInit {
