...
@Component({
  selector: 'app-zone-geographique-conseils-scientifique-edit-admin',
  templateUrl: './zone-geographique-conseils-scientifique-edit-admin.component.html',
  styleUrls: ['./zone-geographique-conseils-scientifique-edit-admin.component.css']
})
export class ZoneGeographiqueConseilsScientifiqueEditAdminComponent implements OnInit {
