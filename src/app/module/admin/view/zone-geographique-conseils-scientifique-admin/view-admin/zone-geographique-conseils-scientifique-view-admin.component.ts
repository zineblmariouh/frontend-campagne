...
@Component({
  selector: 'app-zone-geographique-conseils-scientifique-view-admin',
  templateUrl: './zone-geographique-conseils-scientifique-view-admin.component.html',
  styleUrls: ['./zone-geographique-conseils-scientifique-view-admin.component.css']
})
export class ZoneGeographiqueConseilsScientifiqueViewAdminComponent implements OnInit {
