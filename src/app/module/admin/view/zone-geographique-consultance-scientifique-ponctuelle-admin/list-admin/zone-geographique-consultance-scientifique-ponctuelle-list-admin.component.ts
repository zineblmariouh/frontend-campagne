...
@Component({
  selector: 'app-zone-geographique-consultance-scientifique-ponctuelle-list-admin',
  templateUrl: './zone-geographique-consultance-scientifique-ponctuelle-list-admin.component.html',
  styleUrls: ['./zone-geographique-consultance-scientifique-ponctuelle-list-admin.component.css']
})
export class ZoneGeographiqueConsultanceScientifiquePonctuelleListAdminComponent implements OnInit {
   // declarations
