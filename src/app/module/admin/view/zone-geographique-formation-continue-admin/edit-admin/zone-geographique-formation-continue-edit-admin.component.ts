...
@Component({
  selector: 'app-zone-geographique-formation-continue-edit-admin',
  templateUrl: './zone-geographique-formation-continue-edit-admin.component.html',
  styleUrls: ['./zone-geographique-formation-continue-edit-admin.component.css']
})
export class ZoneGeographiqueFormationContinueEditAdminComponent implements OnInit {
