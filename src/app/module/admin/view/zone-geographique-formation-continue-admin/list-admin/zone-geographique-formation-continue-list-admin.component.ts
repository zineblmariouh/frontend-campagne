...
@Component({
  selector: 'app-zone-geographique-formation-continue-list-admin',
  templateUrl: './zone-geographique-formation-continue-list-admin.component.html',
  styleUrls: ['./zone-geographique-formation-continue-list-admin.component.css']
})
export class ZoneGeographiqueFormationContinueListAdminComponent implements OnInit {
   // declarations
