...
@Component({
  selector: 'app-zone-geographique-formation-continue-view-admin',
  templateUrl: './zone-geographique-formation-continue-view-admin.component.html',
  styleUrls: ['./zone-geographique-formation-continue-view-admin.component.css']
})
export class ZoneGeographiqueFormationContinueViewAdminComponent implements OnInit {
