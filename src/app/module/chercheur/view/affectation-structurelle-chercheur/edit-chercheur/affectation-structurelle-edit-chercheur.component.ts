...
@Component({
  selector: 'app-affectation-structurelle-edit-chercheur',
  templateUrl: './affectation-structurelle-edit-chercheur.component.html',
  styleUrls: ['./affectation-structurelle-edit-chercheur.component.css']
})
export class AffectationStructurelleEditChercheurComponent implements OnInit {
