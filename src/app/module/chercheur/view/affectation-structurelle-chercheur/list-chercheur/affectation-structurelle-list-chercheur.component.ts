...
@Component({
  selector: 'app-affectation-structurelle-list-chercheur',
  templateUrl: './affectation-structurelle-list-chercheur.component.html',
  styleUrls: ['./affectation-structurelle-list-chercheur.component.css']
})
export class AffectationStructurelleListChercheurComponent implements OnInit {
   // declarations
