...
@Component({
  selector: 'app-caracterisation-list-chercheur',
  templateUrl: './caracterisation-list-chercheur.component.html',
  styleUrls: ['./caracterisation-list-chercheur.component.css']
})
export class CaracterisationListChercheurComponent implements OnInit {
   // declarations
