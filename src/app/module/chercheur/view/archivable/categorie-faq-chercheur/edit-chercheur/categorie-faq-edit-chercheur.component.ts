...
@Component({
  selector: 'app-categorie-faq-edit-chercheur',
  templateUrl: './categorie-faq-edit-chercheur.component.html',
  styleUrls: ['./categorie-faq-edit-chercheur.component.css']
})
export class CategorieFaqEditChercheurComponent implements OnInit {
