...
@Component({
  selector: 'app-categorie-faq-list-chercheur',
  templateUrl: './categorie-faq-list-chercheur.component.html',
  styleUrls: ['./categorie-faq-list-chercheur.component.css']
})
export class CategorieFaqListChercheurComponent implements OnInit {
   // declarations
