...
@Component({
  selector: 'app-commission-scientifique-list-chercheur',
  templateUrl: './commission-scientifique-list-chercheur.component.html',
  styleUrls: ['./commission-scientifique-list-chercheur.component.css']
})
export class CommissionScientifiqueListChercheurComponent implements OnInit {
   // declarations
