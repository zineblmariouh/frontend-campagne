...
@Component({
  selector: 'app-communaute-savoir-create-chercheur',
  templateUrl: './communaute-savoir-create-chercheur.component.html',
  styleUrls: ['./communaute-savoir-create-chercheur.component.css']
})
export class CommunauteSavoirCreateChercheurComponent implements OnInit {
