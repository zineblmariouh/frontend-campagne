...
@Component({
  selector: 'app-communaute-savoir-list-chercheur',
  templateUrl: './communaute-savoir-list-chercheur.component.html',
  styleUrls: ['./communaute-savoir-list-chercheur.component.css']
})
export class CommunauteSavoirListChercheurComponent implements OnInit {
   // declarations
