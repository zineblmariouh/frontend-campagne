...
@Component({
  selector: 'app-contexte-list-chercheur',
  templateUrl: './contexte-list-chercheur.component.html',
  styleUrls: ['./contexte-list-chercheur.component.css']
})
export class ContexteListChercheurComponent implements OnInit {
   // declarations
