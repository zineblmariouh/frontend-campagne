...
@Component({
  selector: 'app-contexte-view-chercheur',
  templateUrl: './contexte-view-chercheur.component.html',
  styleUrls: ['./contexte-view-chercheur.component.css']
})
export class ContexteViewChercheurComponent implements OnInit {
