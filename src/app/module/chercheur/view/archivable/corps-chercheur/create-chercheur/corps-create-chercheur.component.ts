...
@Component({
  selector: 'app-corps-create-chercheur',
  templateUrl: './corps-create-chercheur.component.html',
  styleUrls: ['./corps-create-chercheur.component.css']
})
export class CorpsCreateChercheurComponent implements OnInit {
