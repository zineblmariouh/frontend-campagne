...
@Component({
  selector: 'app-corps-list-chercheur',
  templateUrl: './corps-list-chercheur.component.html',
  styleUrls: ['./corps-list-chercheur.component.css']
})
export class CorpsListChercheurComponent implements OnInit {
   // declarations
