...
@Component({
  selector: 'app-departement-scientifique-view-chercheur',
  templateUrl: './departement-scientifique-view-chercheur.component.html',
  styleUrls: ['./departement-scientifique-view-chercheur.component.css']
})
export class DepartementScientifiqueViewChercheurComponent implements OnInit {
