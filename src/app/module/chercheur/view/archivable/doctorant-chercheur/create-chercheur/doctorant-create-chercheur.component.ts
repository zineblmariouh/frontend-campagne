...
@Component({
  selector: 'app-doctorant-create-chercheur',
  templateUrl: './doctorant-create-chercheur.component.html',
  styleUrls: ['./doctorant-create-chercheur.component.css']
})
export class DoctorantCreateChercheurComponent implements OnInit {
