...
@Component({
  selector: 'app-doctorant-edit-chercheur',
  templateUrl: './doctorant-edit-chercheur.component.html',
  styleUrls: ['./doctorant-edit-chercheur.component.css']
})
export class DoctorantEditChercheurComponent implements OnInit {
