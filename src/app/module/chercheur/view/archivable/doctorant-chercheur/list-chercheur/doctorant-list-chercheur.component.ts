...
@Component({
  selector: 'app-doctorant-list-chercheur',
  templateUrl: './doctorant-list-chercheur.component.html',
  styleUrls: ['./doctorant-list-chercheur.component.css']
})
export class DoctorantListChercheurComponent implements OnInit {
   // declarations
