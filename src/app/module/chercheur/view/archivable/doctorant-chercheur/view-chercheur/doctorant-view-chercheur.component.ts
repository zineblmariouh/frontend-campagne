...
@Component({
  selector: 'app-doctorant-view-chercheur',
  templateUrl: './doctorant-view-chercheur.component.html',
  styleUrls: ['./doctorant-view-chercheur.component.css']
})
export class DoctorantViewChercheurComponent implements OnInit {
