...
@Component({
  selector: 'app-entite-administrative-edit-chercheur',
  templateUrl: './entite-administrative-edit-chercheur.component.html',
  styleUrls: ['./entite-administrative-edit-chercheur.component.css']
})
export class EntiteAdministrativeEditChercheurComponent implements OnInit {
