...
@Component({
  selector: 'app-etablissement-edit-chercheur',
  templateUrl: './etablissement-edit-chercheur.component.html',
  styleUrls: ['./etablissement-edit-chercheur.component.css']
})
export class EtablissementEditChercheurComponent implements OnInit {
