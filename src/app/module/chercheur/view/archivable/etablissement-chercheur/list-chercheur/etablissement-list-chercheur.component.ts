...
@Component({
  selector: 'app-etablissement-list-chercheur',
  templateUrl: './etablissement-list-chercheur.component.html',
  styleUrls: ['./etablissement-list-chercheur.component.css']
})
export class EtablissementListChercheurComponent implements OnInit {
   // declarations
