...
@Component({
  selector: 'app-etablissement-view-chercheur',
  templateUrl: './etablissement-view-chercheur.component.html',
  styleUrls: ['./etablissement-view-chercheur.component.css']
})
export class EtablissementViewChercheurComponent implements OnInit {
