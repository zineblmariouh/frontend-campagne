...
@Component({
  selector: 'app-etablissement-partenaire-create-chercheur',
  templateUrl: './etablissement-partenaire-create-chercheur.component.html',
  styleUrls: ['./etablissement-partenaire-create-chercheur.component.css']
})
export class EtablissementPartenaireCreateChercheurComponent implements OnInit {
