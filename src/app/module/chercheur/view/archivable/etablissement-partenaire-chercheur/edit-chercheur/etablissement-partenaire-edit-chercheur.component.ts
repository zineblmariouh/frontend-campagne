...
@Component({
  selector: 'app-etablissement-partenaire-edit-chercheur',
  templateUrl: './etablissement-partenaire-edit-chercheur.component.html',
  styleUrls: ['./etablissement-partenaire-edit-chercheur.component.css']
})
export class EtablissementPartenaireEditChercheurComponent implements OnInit {
