...
@Component({
  selector: 'app-etablissement-partenaire-list-chercheur',
  templateUrl: './etablissement-partenaire-list-chercheur.component.html',
  styleUrls: ['./etablissement-partenaire-list-chercheur.component.css']
})
export class EtablissementPartenaireListChercheurComponent implements OnInit {
   // declarations
