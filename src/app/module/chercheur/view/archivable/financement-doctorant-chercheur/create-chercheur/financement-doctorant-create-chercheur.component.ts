...
@Component({
  selector: 'app-financement-doctorant-create-chercheur',
  templateUrl: './financement-doctorant-create-chercheur.component.html',
  styleUrls: ['./financement-doctorant-create-chercheur.component.css']
})
export class FinancementDoctorantCreateChercheurComponent implements OnInit {
