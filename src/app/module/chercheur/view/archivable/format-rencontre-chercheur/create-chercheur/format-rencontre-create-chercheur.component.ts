...
@Component({
  selector: 'app-format-rencontre-create-chercheur',
  templateUrl: './format-rencontre-create-chercheur.component.html',
  styleUrls: ['./format-rencontre-create-chercheur.component.css']
})
export class FormatRencontreCreateChercheurComponent implements OnInit {
