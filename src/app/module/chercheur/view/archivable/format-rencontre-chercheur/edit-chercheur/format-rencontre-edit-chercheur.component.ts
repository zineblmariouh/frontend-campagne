...
@Component({
  selector: 'app-format-rencontre-edit-chercheur',
  templateUrl: './format-rencontre-edit-chercheur.component.html',
  styleUrls: ['./format-rencontre-edit-chercheur.component.css']
})
export class FormatRencontreEditChercheurComponent implements OnInit {
