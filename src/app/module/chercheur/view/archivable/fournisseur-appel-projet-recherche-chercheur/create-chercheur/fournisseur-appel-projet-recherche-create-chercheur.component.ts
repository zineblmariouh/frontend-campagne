...
@Component({
  selector: 'app-fournisseur-appel-projet-recherche-create-chercheur',
  templateUrl: './fournisseur-appel-projet-recherche-create-chercheur.component.html',
  styleUrls: ['./fournisseur-appel-projet-recherche-create-chercheur.component.css']
})
export class FournisseurAppelProjetRechercheCreateChercheurComponent implements OnInit {
