...
@Component({
  selector: 'app-grade-list-chercheur',
  templateUrl: './grade-list-chercheur.component.html',
  styleUrls: ['./grade-list-chercheur.component.css']
})
export class GradeListChercheurComponent implements OnInit {
   // declarations
