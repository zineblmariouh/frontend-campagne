...
@Component({
  selector: 'app-grade-view-chercheur',
  templateUrl: './grade-view-chercheur.component.html',
  styleUrls: ['./grade-view-chercheur.component.css']
})
export class GradeViewChercheurComponent implements OnInit {
