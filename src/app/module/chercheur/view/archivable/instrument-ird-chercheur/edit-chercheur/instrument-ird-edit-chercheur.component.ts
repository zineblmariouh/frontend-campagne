...
@Component({
  selector: 'app-instrument-ird-edit-chercheur',
  templateUrl: './instrument-ird-edit-chercheur.component.html',
  styleUrls: ['./instrument-ird-edit-chercheur.component.css']
})
export class InstrumentIrdEditChercheurComponent implements OnInit {
