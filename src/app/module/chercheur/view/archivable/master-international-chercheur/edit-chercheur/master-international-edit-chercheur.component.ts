...
@Component({
  selector: 'app-master-international-edit-chercheur',
  templateUrl: './master-international-edit-chercheur.component.html',
  styleUrls: ['./master-international-edit-chercheur.component.css']
})
export class MasterInternationalEditChercheurComponent implements OnInit {
