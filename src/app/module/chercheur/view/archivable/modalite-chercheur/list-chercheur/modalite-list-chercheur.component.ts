...
@Component({
  selector: 'app-modalite-list-chercheur',
  templateUrl: './modalite-list-chercheur.component.html',
  styleUrls: ['./modalite-list-chercheur.component.css']
})
export class ModaliteListChercheurComponent implements OnInit {
   // declarations
