...
@Component({
  selector: 'app-modalite-etude-list-chercheur',
  templateUrl: './modalite-etude-list-chercheur.component.html',
  styleUrls: ['./modalite-etude-list-chercheur.component.css']
})
export class ModaliteEtudeListChercheurComponent implements OnInit {
   // declarations
