...
@Component({
  selector: 'app-modalite-formation-continue-create-chercheur',
  templateUrl: './modalite-formation-continue-create-chercheur.component.html',
  styleUrls: ['./modalite-formation-continue-create-chercheur.component.css']
})
export class ModaliteFormationContinueCreateChercheurComponent implements OnInit {
