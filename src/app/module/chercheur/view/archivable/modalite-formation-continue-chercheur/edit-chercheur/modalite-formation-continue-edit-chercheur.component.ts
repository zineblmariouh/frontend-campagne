...
@Component({
  selector: 'app-modalite-formation-continue-edit-chercheur',
  templateUrl: './modalite-formation-continue-edit-chercheur.component.html',
  styleUrls: ['./modalite-formation-continue-edit-chercheur.component.css']
})
export class ModaliteFormationContinueEditChercheurComponent implements OnInit {
