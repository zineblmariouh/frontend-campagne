...
@Component({
  selector: 'app-modalite-formation-continue-list-chercheur',
  templateUrl: './modalite-formation-continue-list-chercheur.component.html',
  styleUrls: ['./modalite-formation-continue-list-chercheur.component.css']
})
export class ModaliteFormationContinueListChercheurComponent implements OnInit {
   // declarations
