...
@Component({
  selector: 'app-modalite-formation-continue-view-chercheur',
  templateUrl: './modalite-formation-continue-view-chercheur.component.html',
  styleUrls: ['./modalite-formation-continue-view-chercheur.component.css']
})
export class ModaliteFormationContinueViewChercheurComponent implements OnInit {
