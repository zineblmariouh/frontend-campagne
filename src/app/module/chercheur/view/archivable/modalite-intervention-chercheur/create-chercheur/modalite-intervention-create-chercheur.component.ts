...
@Component({
  selector: 'app-modalite-intervention-create-chercheur',
  templateUrl: './modalite-intervention-create-chercheur.component.html',
  styleUrls: ['./modalite-intervention-create-chercheur.component.css']
})
export class ModaliteInterventionCreateChercheurComponent implements OnInit {
