...
@Component({
  selector: 'app-modalite-intervention-list-chercheur',
  templateUrl: './modalite-intervention-list-chercheur.component.html',
  styleUrls: ['./modalite-intervention-list-chercheur.component.css']
})
export class ModaliteInterventionListChercheurComponent implements OnInit {
   // declarations
