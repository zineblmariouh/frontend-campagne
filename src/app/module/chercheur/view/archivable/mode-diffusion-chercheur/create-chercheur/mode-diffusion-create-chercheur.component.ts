...
@Component({
  selector: 'app-mode-diffusion-create-chercheur',
  templateUrl: './mode-diffusion-create-chercheur.component.html',
  styleUrls: ['./mode-diffusion-create-chercheur.component.css']
})
export class ModeDiffusionCreateChercheurComponent implements OnInit {
