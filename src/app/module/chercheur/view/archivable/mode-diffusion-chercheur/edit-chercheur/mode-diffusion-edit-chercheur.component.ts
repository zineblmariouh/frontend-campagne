...
@Component({
  selector: 'app-mode-diffusion-edit-chercheur',
  templateUrl: './mode-diffusion-edit-chercheur.component.html',
  styleUrls: ['./mode-diffusion-edit-chercheur.component.css']
})
export class ModeDiffusionEditChercheurComponent implements OnInit {
