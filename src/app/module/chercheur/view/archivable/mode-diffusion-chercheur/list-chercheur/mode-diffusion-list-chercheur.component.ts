...
@Component({
  selector: 'app-mode-diffusion-list-chercheur',
  templateUrl: './mode-diffusion-list-chercheur.component.html',
  styleUrls: ['./mode-diffusion-list-chercheur.component.css']
})
export class ModeDiffusionListChercheurComponent implements OnInit {
   // declarations
