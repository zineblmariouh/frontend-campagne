...
@Component({
  selector: 'app-mode-diffusion-view-chercheur',
  templateUrl: './mode-diffusion-view-chercheur.component.html',
  styleUrls: ['./mode-diffusion-view-chercheur.component.css']
})
export class ModeDiffusionViewChercheurComponent implements OnInit {
