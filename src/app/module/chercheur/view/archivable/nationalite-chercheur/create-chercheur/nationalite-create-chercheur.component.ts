...
@Component({
  selector: 'app-nationalite-create-chercheur',
  templateUrl: './nationalite-create-chercheur.component.html',
  styleUrls: ['./nationalite-create-chercheur.component.css']
})
export class NationaliteCreateChercheurComponent implements OnInit {
