...
@Component({
  selector: 'app-nationalite-edit-chercheur',
  templateUrl: './nationalite-edit-chercheur.component.html',
  styleUrls: ['./nationalite-edit-chercheur.component.css']
})
export class NationaliteEditChercheurComponent implements OnInit {
