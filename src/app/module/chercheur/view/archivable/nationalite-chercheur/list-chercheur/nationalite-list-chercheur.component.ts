...
@Component({
  selector: 'app-nationalite-list-chercheur',
  templateUrl: './nationalite-list-chercheur.component.html',
  styleUrls: ['./nationalite-list-chercheur.component.css']
})
export class NationaliteListChercheurComponent implements OnInit {
   // declarations
