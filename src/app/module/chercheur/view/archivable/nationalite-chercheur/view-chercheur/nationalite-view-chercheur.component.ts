...
@Component({
  selector: 'app-nationalite-view-chercheur',
  templateUrl: './nationalite-view-chercheur.component.html',
  styleUrls: ['./nationalite-view-chercheur.component.css']
})
export class NationaliteViewChercheurComponent implements OnInit {
