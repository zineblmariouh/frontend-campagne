...
@Component({
  selector: 'app-nature-enseignement-create-chercheur',
  templateUrl: './nature-enseignement-create-chercheur.component.html',
  styleUrls: ['./nature-enseignement-create-chercheur.component.css']
})
export class NatureEnseignementCreateChercheurComponent implements OnInit {
