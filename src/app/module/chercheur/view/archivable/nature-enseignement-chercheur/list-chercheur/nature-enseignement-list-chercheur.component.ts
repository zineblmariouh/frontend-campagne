...
@Component({
  selector: 'app-nature-enseignement-list-chercheur',
  templateUrl: './nature-enseignement-list-chercheur.component.html',
  styleUrls: ['./nature-enseignement-list-chercheur.component.css']
})
export class NatureEnseignementListChercheurComponent implements OnInit {
   // declarations
