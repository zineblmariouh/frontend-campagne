...
@Component({
  selector: 'app-nature-etude-create-chercheur',
  templateUrl: './nature-etude-create-chercheur.component.html',
  styleUrls: ['./nature-etude-create-chercheur.component.css']
})
export class NatureEtudeCreateChercheurComponent implements OnInit {
