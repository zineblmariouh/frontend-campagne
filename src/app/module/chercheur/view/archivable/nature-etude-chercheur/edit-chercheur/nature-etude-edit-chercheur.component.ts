...
@Component({
  selector: 'app-nature-etude-edit-chercheur',
  templateUrl: './nature-etude-edit-chercheur.component.html',
  styleUrls: ['./nature-etude-edit-chercheur.component.css']
})
export class NatureEtudeEditChercheurComponent implements OnInit {
