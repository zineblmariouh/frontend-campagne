...
@Component({
  selector: 'app-nature-etude-list-chercheur',
  templateUrl: './nature-etude-list-chercheur.component.html',
  styleUrls: ['./nature-etude-list-chercheur.component.css']
})
export class NatureEtudeListChercheurComponent implements OnInit {
   // declarations
