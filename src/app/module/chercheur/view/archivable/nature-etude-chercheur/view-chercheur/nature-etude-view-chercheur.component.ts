...
@Component({
  selector: 'app-nature-etude-view-chercheur',
  templateUrl: './nature-etude-view-chercheur.component.html',
  styleUrls: ['./nature-etude-view-chercheur.component.css']
})
export class NatureEtudeViewChercheurComponent implements OnInit {
