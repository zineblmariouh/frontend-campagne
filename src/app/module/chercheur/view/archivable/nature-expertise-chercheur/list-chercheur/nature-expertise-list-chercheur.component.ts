...
@Component({
  selector: 'app-nature-expertise-list-chercheur',
  templateUrl: './nature-expertise-list-chercheur.component.html',
  styleUrls: ['./nature-expertise-list-chercheur.component.css']
})
export class NatureExpertiseListChercheurComponent implements OnInit {
   // declarations
