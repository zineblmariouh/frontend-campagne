...
@Component({
  selector: 'app-niveau-etude-list-chercheur',
  templateUrl: './niveau-etude-list-chercheur.component.html',
  styleUrls: ['./niveau-etude-list-chercheur.component.css']
})
export class NiveauEtudeListChercheurComponent implements OnInit {
   // declarations
