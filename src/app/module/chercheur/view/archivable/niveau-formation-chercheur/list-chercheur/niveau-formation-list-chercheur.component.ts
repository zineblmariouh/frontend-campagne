...
@Component({
  selector: 'app-niveau-formation-list-chercheur',
  templateUrl: './niveau-formation-list-chercheur.component.html',
  styleUrls: ['./niveau-formation-list-chercheur.component.css']
})
export class NiveauFormationListChercheurComponent implements OnInit {
   // declarations
