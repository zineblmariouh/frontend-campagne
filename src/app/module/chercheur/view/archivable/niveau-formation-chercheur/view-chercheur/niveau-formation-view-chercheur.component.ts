...
@Component({
  selector: 'app-niveau-formation-view-chercheur',
  templateUrl: './niveau-formation-view-chercheur.component.html',
  styleUrls: ['./niveau-formation-view-chercheur.component.css']
})
export class NiveauFormationViewChercheurComponent implements OnInit {
