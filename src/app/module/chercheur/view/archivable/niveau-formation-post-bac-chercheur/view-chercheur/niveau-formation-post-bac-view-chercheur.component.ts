...
@Component({
  selector: 'app-niveau-formation-post-bac-view-chercheur',
  templateUrl: './niveau-formation-post-bac-view-chercheur.component.html',
  styleUrls: ['./niveau-formation-post-bac-view-chercheur.component.css']
})
export class NiveauFormationPostBacViewChercheurComponent implements OnInit {
