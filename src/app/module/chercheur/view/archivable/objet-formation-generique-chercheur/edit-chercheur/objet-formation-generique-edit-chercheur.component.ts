...
@Component({
  selector: 'app-objet-formation-generique-edit-chercheur',
  templateUrl: './objet-formation-generique-edit-chercheur.component.html',
  styleUrls: ['./objet-formation-generique-edit-chercheur.component.css']
})
export class ObjetFormationGeneriqueEditChercheurComponent implements OnInit {
