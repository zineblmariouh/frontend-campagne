...
@Component({
  selector: 'app-objet-formation-generique-list-chercheur',
  templateUrl: './objet-formation-generique-list-chercheur.component.html',
  styleUrls: ['./objet-formation-generique-list-chercheur.component.css']
})
export class ObjetFormationGeneriqueListChercheurComponent implements OnInit {
   // declarations
