...
@Component({
  selector: 'app-pays-create-chercheur',
  templateUrl: './pays-create-chercheur.component.html',
  styleUrls: ['./pays-create-chercheur.component.css']
})
export class PaysCreateChercheurComponent implements OnInit {
