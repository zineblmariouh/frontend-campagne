...
@Component({
  selector: 'app-pays-edit-chercheur',
  templateUrl: './pays-edit-chercheur.component.html',
  styleUrls: ['./pays-edit-chercheur.component.css']
})
export class PaysEditChercheurComponent implements OnInit {
