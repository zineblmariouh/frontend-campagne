...
@Component({
  selector: 'app-pays-list-chercheur',
  templateUrl: './pays-list-chercheur.component.html',
  styleUrls: ['./pays-list-chercheur.component.css']
})
export class PaysListChercheurComponent implements OnInit {
   // declarations
