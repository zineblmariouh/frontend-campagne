...
@Component({
  selector: 'app-pays-view-chercheur',
  templateUrl: './pays-view-chercheur.component.html',
  styleUrls: ['./pays-view-chercheur.component.css']
})
export class PaysViewChercheurComponent implements OnInit {
