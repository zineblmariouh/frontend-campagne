...
@Component({
  selector: 'app-publique-cible-list-chercheur',
  templateUrl: './publique-cible-list-chercheur.component.html',
  styleUrls: ['./publique-cible-list-chercheur.component.css']
})
export class PubliqueCibleListChercheurComponent implements OnInit {
   // declarations
