...
@Component({
  selector: 'app-publique-formation-create-chercheur',
  templateUrl: './publique-formation-create-chercheur.component.html',
  styleUrls: ['./publique-formation-create-chercheur.component.css']
})
export class PubliqueFormationCreateChercheurComponent implements OnInit {
