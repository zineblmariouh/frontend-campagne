...
@Component({
  selector: 'app-publique-formation-edit-chercheur',
  templateUrl: './publique-formation-edit-chercheur.component.html',
  styleUrls: ['./publique-formation-edit-chercheur.component.css']
})
export class PubliqueFormationEditChercheurComponent implements OnInit {
