...
@Component({
  selector: 'app-responsabilite-encadrement-doctorant-create-chercheur',
  templateUrl: './responsabilite-encadrement-doctorant-create-chercheur.component.html',
  styleUrls: ['./responsabilite-encadrement-doctorant-create-chercheur.component.css']
})
export class ResponsabiliteEncadrementDoctorantCreateChercheurComponent implements OnInit {
