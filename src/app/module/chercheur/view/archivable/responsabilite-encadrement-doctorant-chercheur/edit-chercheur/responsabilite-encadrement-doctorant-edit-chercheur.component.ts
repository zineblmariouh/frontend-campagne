...
@Component({
  selector: 'app-responsabilite-encadrement-doctorant-edit-chercheur',
  templateUrl: './responsabilite-encadrement-doctorant-edit-chercheur.component.html',
  styleUrls: ['./responsabilite-encadrement-doctorant-edit-chercheur.component.css']
})
export class ResponsabiliteEncadrementDoctorantEditChercheurComponent implements OnInit {
