...
@Component({
  selector: 'app-responsabilite-encadrement-doctorant-view-chercheur',
  templateUrl: './responsabilite-encadrement-doctorant-view-chercheur.component.html',
  styleUrls: ['./responsabilite-encadrement-doctorant-view-chercheur.component.css']
})
export class ResponsabiliteEncadrementDoctorantViewChercheurComponent implements OnInit {
