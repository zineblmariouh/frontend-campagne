...
@Component({
  selector: 'app-role-evaluation-edit-chercheur',
  templateUrl: './role-evaluation-edit-chercheur.component.html',
  styleUrls: ['./role-evaluation-edit-chercheur.component.css']
})
export class RoleEvaluationEditChercheurComponent implements OnInit {
