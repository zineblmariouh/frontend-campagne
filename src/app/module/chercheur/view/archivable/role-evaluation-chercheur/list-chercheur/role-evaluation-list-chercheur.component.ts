...
@Component({
  selector: 'app-role-evaluation-list-chercheur',
  templateUrl: './role-evaluation-list-chercheur.component.html',
  styleUrls: ['./role-evaluation-list-chercheur.component.css']
})
export class RoleEvaluationListChercheurComponent implements OnInit {
   // declarations
