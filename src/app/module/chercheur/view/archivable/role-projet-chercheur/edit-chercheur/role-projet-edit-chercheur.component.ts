...
@Component({
  selector: 'app-role-projet-edit-chercheur',
  templateUrl: './role-projet-edit-chercheur.component.html',
  styleUrls: ['./role-projet-edit-chercheur.component.css']
})
export class RoleProjetEditChercheurComponent implements OnInit {
