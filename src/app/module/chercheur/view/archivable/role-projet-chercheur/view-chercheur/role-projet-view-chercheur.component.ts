...
@Component({
  selector: 'app-role-projet-view-chercheur',
  templateUrl: './role-projet-view-chercheur.component.html',
  styleUrls: ['./role-projet-view-chercheur.component.css']
})
export class RoleProjetViewChercheurComponent implements OnInit {
