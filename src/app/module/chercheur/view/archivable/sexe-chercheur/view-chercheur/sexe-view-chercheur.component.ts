...
@Component({
  selector: 'app-sexe-view-chercheur',
  templateUrl: './sexe-view-chercheur.component.html',
  styleUrls: ['./sexe-view-chercheur.component.css']
})
export class SexeViewChercheurComponent implements OnInit {
