...
@Component({
  selector: 'app-status-cursus-create-chercheur',
  templateUrl: './status-cursus-create-chercheur.component.html',
  styleUrls: ['./status-cursus-create-chercheur.component.css']
})
export class StatusCursusCreateChercheurComponent implements OnInit {
