...
@Component({
  selector: 'app-status-cursus-edit-chercheur',
  templateUrl: './status-cursus-edit-chercheur.component.html',
  styleUrls: ['./status-cursus-edit-chercheur.component.css']
})
export class StatusCursusEditChercheurComponent implements OnInit {
