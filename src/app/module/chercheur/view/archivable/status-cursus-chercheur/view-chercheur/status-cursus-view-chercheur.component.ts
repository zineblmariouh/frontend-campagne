...
@Component({
  selector: 'app-status-cursus-view-chercheur',
  templateUrl: './status-cursus-view-chercheur.component.html',
  styleUrls: ['./status-cursus-view-chercheur.component.css']
})
export class StatusCursusViewChercheurComponent implements OnInit {
