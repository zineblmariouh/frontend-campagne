...
@Component({
  selector: 'app-status-projet-create-chercheur',
  templateUrl: './status-projet-create-chercheur.component.html',
  styleUrls: ['./status-projet-create-chercheur.component.css']
})
export class StatusProjetCreateChercheurComponent implements OnInit {
