...
@Component({
  selector: 'app-status-projet-edit-chercheur',
  templateUrl: './status-projet-edit-chercheur.component.html',
  styleUrls: ['./status-projet-edit-chercheur.component.css']
})
export class StatusProjetEditChercheurComponent implements OnInit {
