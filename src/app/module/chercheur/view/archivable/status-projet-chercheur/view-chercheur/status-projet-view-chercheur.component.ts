...
@Component({
  selector: 'app-status-projet-view-chercheur',
  templateUrl: './status-projet-view-chercheur.component.html',
  styleUrls: ['./status-projet-view-chercheur.component.css']
})
export class StatusProjetViewChercheurComponent implements OnInit {
