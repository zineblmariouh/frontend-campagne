...
@Component({
  selector: 'app-structure-ird-create-chercheur',
  templateUrl: './structure-ird-create-chercheur.component.html',
  styleUrls: ['./structure-ird-create-chercheur.component.css']
})
export class StructureIrdCreateChercheurComponent implements OnInit {
