...
@Component({
  selector: 'app-structure-ird-edit-chercheur',
  templateUrl: './structure-ird-edit-chercheur.component.html',
  styleUrls: ['./structure-ird-edit-chercheur.component.css']
})
export class StructureIrdEditChercheurComponent implements OnInit {
