...
@Component({
  selector: 'app-template-cloture-edit-chercheur',
  templateUrl: './template-cloture-edit-chercheur.component.html',
  styleUrls: ['./template-cloture-edit-chercheur.component.css']
})
export class TemplateClotureEditChercheurComponent implements OnInit {
