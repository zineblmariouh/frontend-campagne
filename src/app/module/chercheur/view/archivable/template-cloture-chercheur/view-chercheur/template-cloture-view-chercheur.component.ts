...
@Component({
  selector: 'app-template-cloture-view-chercheur',
  templateUrl: './template-cloture-view-chercheur.component.html',
  styleUrls: ['./template-cloture-view-chercheur.component.css']
})
export class TemplateClotureViewChercheurComponent implements OnInit {
