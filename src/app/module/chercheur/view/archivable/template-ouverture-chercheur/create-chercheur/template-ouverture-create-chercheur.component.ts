...
@Component({
  selector: 'app-template-ouverture-create-chercheur',
  templateUrl: './template-ouverture-create-chercheur.component.html',
  styleUrls: ['./template-ouverture-create-chercheur.component.css']
})
export class TemplateOuvertureCreateChercheurComponent implements OnInit {
