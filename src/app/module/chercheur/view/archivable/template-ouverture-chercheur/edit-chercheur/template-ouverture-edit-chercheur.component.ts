...
@Component({
  selector: 'app-template-ouverture-edit-chercheur',
  templateUrl: './template-ouverture-edit-chercheur.component.html',
  styleUrls: ['./template-ouverture-edit-chercheur.component.css']
})
export class TemplateOuvertureEditChercheurComponent implements OnInit {
