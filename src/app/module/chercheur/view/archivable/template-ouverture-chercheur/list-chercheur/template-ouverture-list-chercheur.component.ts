...
@Component({
  selector: 'app-template-ouverture-list-chercheur',
  templateUrl: './template-ouverture-list-chercheur.component.html',
  styleUrls: ['./template-ouverture-list-chercheur.component.css']
})
export class TemplateOuvertureListChercheurComponent implements OnInit {
   // declarations
