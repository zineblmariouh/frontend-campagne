...
@Component({
  selector: 'app-template-rappel-create-chercheur',
  templateUrl: './template-rappel-create-chercheur.component.html',
  styleUrls: ['./template-rappel-create-chercheur.component.css']
})
export class TemplateRappelCreateChercheurComponent implements OnInit {
