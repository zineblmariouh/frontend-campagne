...
@Component({
  selector: 'app-template-rappel-edit-chercheur',
  templateUrl: './template-rappel-edit-chercheur.component.html',
  styleUrls: ['./template-rappel-edit-chercheur.component.css']
})
export class TemplateRappelEditChercheurComponent implements OnInit {
