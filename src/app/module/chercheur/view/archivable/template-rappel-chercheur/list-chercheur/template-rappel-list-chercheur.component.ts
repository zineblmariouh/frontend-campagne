...
@Component({
  selector: 'app-template-rappel-list-chercheur',
  templateUrl: './template-rappel-list-chercheur.component.html',
  styleUrls: ['./template-rappel-list-chercheur.component.css']
})
export class TemplateRappelListChercheurComponent implements OnInit {
   // declarations
