...
@Component({
  selector: 'app-template-relance-create-chercheur',
  templateUrl: './template-relance-create-chercheur.component.html',
  styleUrls: ['./template-relance-create-chercheur.component.css']
})
export class TemplateRelanceCreateChercheurComponent implements OnInit {
