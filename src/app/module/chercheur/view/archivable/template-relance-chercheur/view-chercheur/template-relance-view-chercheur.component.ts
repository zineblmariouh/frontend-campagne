...
@Component({
  selector: 'app-template-relance-view-chercheur',
  templateUrl: './template-relance-view-chercheur.component.html',
  styleUrls: ['./template-relance-view-chercheur.component.css']
})
export class TemplateRelanceViewChercheurComponent implements OnInit {
