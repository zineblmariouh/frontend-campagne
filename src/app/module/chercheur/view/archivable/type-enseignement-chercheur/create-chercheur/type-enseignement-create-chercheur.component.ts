...
@Component({
  selector: 'app-type-enseignement-create-chercheur',
  templateUrl: './type-enseignement-create-chercheur.component.html',
  styleUrls: ['./type-enseignement-create-chercheur.component.css']
})
export class TypeEnseignementCreateChercheurComponent implements OnInit {
