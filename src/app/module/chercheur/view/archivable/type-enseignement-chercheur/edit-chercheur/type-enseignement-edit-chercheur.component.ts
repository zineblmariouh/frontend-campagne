...
@Component({
  selector: 'app-type-enseignement-edit-chercheur',
  templateUrl: './type-enseignement-edit-chercheur.component.html',
  styleUrls: ['./type-enseignement-edit-chercheur.component.css']
})
export class TypeEnseignementEditChercheurComponent implements OnInit {
