...
@Component({
  selector: 'app-type-entite-administrative-create-chercheur',
  templateUrl: './type-entite-administrative-create-chercheur.component.html',
  styleUrls: ['./type-entite-administrative-create-chercheur.component.css']
})
export class TypeEntiteAdministrativeCreateChercheurComponent implements OnInit {
