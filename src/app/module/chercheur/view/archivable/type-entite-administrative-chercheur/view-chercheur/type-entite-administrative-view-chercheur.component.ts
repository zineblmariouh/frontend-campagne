...
@Component({
  selector: 'app-type-entite-administrative-view-chercheur',
  templateUrl: './type-entite-administrative-view-chercheur.component.html',
  styleUrls: ['./type-entite-administrative-view-chercheur.component.css']
})
export class TypeEntiteAdministrativeViewChercheurComponent implements OnInit {
