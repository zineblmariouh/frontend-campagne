...
@Component({
  selector: 'app-type-etude-create-chercheur',
  templateUrl: './type-etude-create-chercheur.component.html',
  styleUrls: ['./type-etude-create-chercheur.component.css']
})
export class TypeEtudeCreateChercheurComponent implements OnInit {
