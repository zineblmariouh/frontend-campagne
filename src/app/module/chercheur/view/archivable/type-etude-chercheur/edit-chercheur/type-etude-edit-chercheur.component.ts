...
@Component({
  selector: 'app-type-etude-edit-chercheur',
  templateUrl: './type-etude-edit-chercheur.component.html',
  styleUrls: ['./type-etude-edit-chercheur.component.css']
})
export class TypeEtudeEditChercheurComponent implements OnInit {
