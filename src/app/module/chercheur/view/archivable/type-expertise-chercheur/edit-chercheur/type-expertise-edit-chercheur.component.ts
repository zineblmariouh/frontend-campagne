...
@Component({
  selector: 'app-type-expertise-edit-chercheur',
  templateUrl: './type-expertise-edit-chercheur.component.html',
  styleUrls: ['./type-expertise-edit-chercheur.component.css']
})
export class TypeExpertiseEditChercheurComponent implements OnInit {
