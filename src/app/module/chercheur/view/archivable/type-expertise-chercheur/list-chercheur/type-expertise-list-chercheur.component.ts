...
@Component({
  selector: 'app-type-expertise-list-chercheur',
  templateUrl: './type-expertise-list-chercheur.component.html',
  styleUrls: ['./type-expertise-list-chercheur.component.css']
})
export class TypeExpertiseListChercheurComponent implements OnInit {
   // declarations
