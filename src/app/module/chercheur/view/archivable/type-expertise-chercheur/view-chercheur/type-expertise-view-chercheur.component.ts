...
@Component({
  selector: 'app-type-expertise-view-chercheur',
  templateUrl: './type-expertise-view-chercheur.component.html',
  styleUrls: ['./type-expertise-view-chercheur.component.css']
})
export class TypeExpertiseViewChercheurComponent implements OnInit {
