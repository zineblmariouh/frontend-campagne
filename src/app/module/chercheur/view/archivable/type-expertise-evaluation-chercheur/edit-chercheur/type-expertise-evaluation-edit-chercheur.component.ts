...
@Component({
  selector: 'app-type-expertise-evaluation-edit-chercheur',
  templateUrl: './type-expertise-evaluation-edit-chercheur.component.html',
  styleUrls: ['./type-expertise-evaluation-edit-chercheur.component.css']
})
export class TypeExpertiseEvaluationEditChercheurComponent implements OnInit {
