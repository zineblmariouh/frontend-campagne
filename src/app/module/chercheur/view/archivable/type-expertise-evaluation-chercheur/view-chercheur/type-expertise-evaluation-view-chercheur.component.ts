...
@Component({
  selector: 'app-type-expertise-evaluation-view-chercheur',
  templateUrl: './type-expertise-evaluation-view-chercheur.component.html',
  styleUrls: ['./type-expertise-evaluation-view-chercheur.component.css']
})
export class TypeExpertiseEvaluationViewChercheurComponent implements OnInit {
