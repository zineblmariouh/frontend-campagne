...
@Component({
  selector: 'app-type-instance-list-chercheur',
  templateUrl: './type-instance-list-chercheur.component.html',
  styleUrls: ['./type-instance-list-chercheur.component.css']
})
export class TypeInstanceListChercheurComponent implements OnInit {
   // declarations
