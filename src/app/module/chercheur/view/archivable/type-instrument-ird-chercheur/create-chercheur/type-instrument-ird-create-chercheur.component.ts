...
@Component({
  selector: 'app-type-instrument-ird-create-chercheur',
  templateUrl: './type-instrument-ird-create-chercheur.component.html',
  styleUrls: ['./type-instrument-ird-create-chercheur.component.css']
})
export class TypeInstrumentIrdCreateChercheurComponent implements OnInit {
