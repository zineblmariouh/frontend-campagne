...
@Component({
  selector: 'app-type-instrument-ird-view-chercheur',
  templateUrl: './type-instrument-ird-view-chercheur.component.html',
  styleUrls: ['./type-instrument-ird-view-chercheur.component.css']
})
export class TypeInstrumentIrdViewChercheurComponent implements OnInit {
