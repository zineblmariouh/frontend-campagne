...
@Component({
  selector: 'app-type-outil-create-chercheur',
  templateUrl: './type-outil-create-chercheur.component.html',
  styleUrls: ['./type-outil-create-chercheur.component.css']
})
export class TypeOutilCreateChercheurComponent implements OnInit {
