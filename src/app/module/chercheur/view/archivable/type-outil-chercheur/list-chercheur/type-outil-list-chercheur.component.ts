...
@Component({
  selector: 'app-type-outil-list-chercheur',
  templateUrl: './type-outil-list-chercheur.component.html',
  styleUrls: ['./type-outil-list-chercheur.component.css']
})
export class TypeOutilListChercheurComponent implements OnInit {
   // declarations
