...
@Component({
  selector: 'app-type-publique-culture-scientifique-edit-chercheur',
  templateUrl: './type-publique-culture-scientifique-edit-chercheur.component.html',
  styleUrls: ['./type-publique-culture-scientifique-edit-chercheur.component.css']
})
export class TypePubliqueCultureScientifiqueEditChercheurComponent implements OnInit {
