...
@Component({
  selector: 'app-type-publique-culture-scientifique-list-chercheur',
  templateUrl: './type-publique-culture-scientifique-list-chercheur.component.html',
  styleUrls: ['./type-publique-culture-scientifique-list-chercheur.component.css']
})
export class TypePubliqueCultureScientifiqueListChercheurComponent implements OnInit {
   // declarations
