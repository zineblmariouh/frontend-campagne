...
@Component({
  selector: 'app-type-publique-culture-scientifique-view-chercheur',
  templateUrl: './type-publique-culture-scientifique-view-chercheur.component.html',
  styleUrls: ['./type-publique-culture-scientifique-view-chercheur.component.css']
})
export class TypePubliqueCultureScientifiqueViewChercheurComponent implements OnInit {
