...
@Component({
  selector: 'app-type-savoir-view-chercheur',
  templateUrl: './type-savoir-view-chercheur.component.html',
  styleUrls: ['./type-savoir-view-chercheur.component.css']
})
export class TypeSavoirViewChercheurComponent implements OnInit {
