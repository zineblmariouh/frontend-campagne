...
@Component({
  selector: 'app-type-utilisateur-edit-chercheur',
  templateUrl: './type-utilisateur-edit-chercheur.component.html',
  styleUrls: ['./type-utilisateur-edit-chercheur.component.css']
})
export class TypeUtilisateurEditChercheurComponent implements OnInit {
