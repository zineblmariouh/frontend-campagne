...
@Component({
  selector: 'app-type-utilisateur-list-chercheur',
  templateUrl: './type-utilisateur-list-chercheur.component.html',
  styleUrls: ['./type-utilisateur-list-chercheur.component.css']
})
export class TypeUtilisateurListChercheurComponent implements OnInit {
   // declarations
