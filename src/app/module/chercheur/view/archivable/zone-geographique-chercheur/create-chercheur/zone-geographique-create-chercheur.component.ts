...
@Component({
  selector: 'app-zone-geographique-create-chercheur',
  templateUrl: './zone-geographique-create-chercheur.component.html',
  styleUrls: ['./zone-geographique-create-chercheur.component.css']
})
export class ZoneGeographiqueCreateChercheurComponent implements OnInit {
