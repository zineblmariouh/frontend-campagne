...
@Component({
  selector: 'app-zone-geographique-view-chercheur',
  templateUrl: './zone-geographique-view-chercheur.component.html',
  styleUrls: ['./zone-geographique-view-chercheur.component.css']
})
export class ZoneGeographiqueViewChercheurComponent implements OnInit {
