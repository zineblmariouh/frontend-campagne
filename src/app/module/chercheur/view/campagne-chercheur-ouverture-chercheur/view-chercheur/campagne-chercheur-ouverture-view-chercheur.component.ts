...
@Component({
  selector: 'app-campagne-chercheur-ouverture-view-chercheur',
  templateUrl: './campagne-chercheur-ouverture-view-chercheur.component.html',
  styleUrls: ['./campagne-chercheur-ouverture-view-chercheur.component.css']
})
export class CampagneChercheurOuvertureViewChercheurComponent implements OnInit {
