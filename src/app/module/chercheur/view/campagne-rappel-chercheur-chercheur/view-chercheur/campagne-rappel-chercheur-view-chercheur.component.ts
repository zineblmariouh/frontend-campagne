...
@Component({
  selector: 'app-campagne-rappel-chercheur-view-chercheur',
  templateUrl: './campagne-rappel-chercheur-view-chercheur.component.html',
  styleUrls: ['./campagne-rappel-chercheur-view-chercheur.component.css']
})
export class CampagneRappelChercheurViewChercheurComponent implements OnInit {
