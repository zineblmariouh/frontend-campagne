...
@Component({
  selector: 'app-campagne-relance-chercheur-edit-chercheur',
  templateUrl: './campagne-relance-chercheur-edit-chercheur.component.html',
  styleUrls: ['./campagne-relance-chercheur-edit-chercheur.component.css']
})
export class CampagneRelanceChercheurEditChercheurComponent implements OnInit {
