...
@Component({
  selector: 'app-campagne-relance-edit-chercheur',
  templateUrl: './campagne-relance-edit-chercheur.component.html',
  styleUrls: ['./campagne-relance-edit-chercheur.component.css']
})
export class CampagneRelanceEditChercheurComponent implements OnInit {
