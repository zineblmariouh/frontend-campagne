...
@Component({
  selector: 'app-campagne-relance-view-chercheur',
  templateUrl: './campagne-relance-view-chercheur.component.html',
  styleUrls: ['./campagne-relance-view-chercheur.component.css']
})
export class CampagneRelanceViewChercheurComponent implements OnInit {
