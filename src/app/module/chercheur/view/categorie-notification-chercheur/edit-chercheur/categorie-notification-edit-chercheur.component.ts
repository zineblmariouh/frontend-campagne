...
@Component({
  selector: 'app-categorie-notification-edit-chercheur',
  templateUrl: './categorie-notification-edit-chercheur.component.html',
  styleUrls: ['./categorie-notification-edit-chercheur.component.css']
})
export class CategorieNotificationEditChercheurComponent implements OnInit {
