...
@Component({
  selector: 'app-chercheur-email-create-chercheur',
  templateUrl: './chercheur-email-create-chercheur.component.html',
  styleUrls: ['./chercheur-email-create-chercheur.component.css']
})
export class ChercheurEmailCreateChercheurComponent implements OnInit {
