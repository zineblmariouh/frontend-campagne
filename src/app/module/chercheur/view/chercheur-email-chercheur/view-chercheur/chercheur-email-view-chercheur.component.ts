...
@Component({
  selector: 'app-chercheur-email-view-chercheur',
  templateUrl: './chercheur-email-view-chercheur.component.html',
  styleUrls: ['./chercheur-email-view-chercheur.component.css']
})
export class ChercheurEmailViewChercheurComponent implements OnInit {
