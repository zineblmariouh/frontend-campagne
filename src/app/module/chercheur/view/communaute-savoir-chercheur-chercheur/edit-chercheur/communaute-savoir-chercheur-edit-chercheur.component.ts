...
@Component({
  selector: 'app-communaute-savoir-chercheur-edit-chercheur',
  templateUrl: './communaute-savoir-chercheur-edit-chercheur.component.html',
  styleUrls: ['./communaute-savoir-chercheur-edit-chercheur.component.css']
})
export class CommunauteSavoirChercheurEditChercheurComponent implements OnInit {
