...
@Component({
  selector: 'app-communaute-savoir-chercheur-view-chercheur',
  templateUrl: './communaute-savoir-chercheur-view-chercheur.component.html',
  styleUrls: ['./communaute-savoir-chercheur-view-chercheur.component.css']
})
export class CommunauteSavoirChercheurViewChercheurComponent implements OnInit {
