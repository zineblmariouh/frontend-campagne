...
@Component({
  selector: 'app-communaute-savoir-encadrement-doctorant-view-chercheur',
  templateUrl: './communaute-savoir-encadrement-doctorant-view-chercheur.component.html',
  styleUrls: ['./communaute-savoir-encadrement-doctorant-view-chercheur.component.css']
})
export class CommunauteSavoirEncadrementDoctorantViewChercheurComponent implements OnInit {
