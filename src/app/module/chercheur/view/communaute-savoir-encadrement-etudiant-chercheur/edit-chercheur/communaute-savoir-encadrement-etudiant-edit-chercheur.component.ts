...
@Component({
  selector: 'app-communaute-savoir-encadrement-etudiant-edit-chercheur',
  templateUrl: './communaute-savoir-encadrement-etudiant-edit-chercheur.component.html',
  styleUrls: ['./communaute-savoir-encadrement-etudiant-edit-chercheur.component.css']
})
export class CommunauteSavoirEncadrementEtudiantEditChercheurComponent implements OnInit {
