...
@Component({
  selector: 'app-communaute-savoir-encadrement-etudiant-list-chercheur',
  templateUrl: './communaute-savoir-encadrement-etudiant-list-chercheur.component.html',
  styleUrls: ['./communaute-savoir-encadrement-etudiant-list-chercheur.component.css']
})
export class CommunauteSavoirEncadrementEtudiantListChercheurComponent implements OnInit {
   // declarations
