...
@Component({
  selector: 'app-communaute-savoir-encadrement-etudiant-view-chercheur',
  templateUrl: './communaute-savoir-encadrement-etudiant-view-chercheur.component.html',
  styleUrls: ['./communaute-savoir-encadrement-etudiant-view-chercheur.component.css']
})
export class CommunauteSavoirEncadrementEtudiantViewChercheurComponent implements OnInit {
