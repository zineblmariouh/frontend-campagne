...
@Component({
  selector: 'app-communaute-savoir-evenement-colloque-scientifique-view-chercheur',
  templateUrl: './communaute-savoir-evenement-colloque-scientifique-view-chercheur.component.html',
  styleUrls: ['./communaute-savoir-evenement-colloque-scientifique-view-chercheur.component.css']
})
export class CommunauteSavoirEvenementColloqueScientifiqueViewChercheurComponent implements OnInit {
