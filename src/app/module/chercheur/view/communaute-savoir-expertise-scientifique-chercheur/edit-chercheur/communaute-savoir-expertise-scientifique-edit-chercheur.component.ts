...
@Component({
  selector: 'app-communaute-savoir-expertise-scientifique-edit-chercheur',
  templateUrl: './communaute-savoir-expertise-scientifique-edit-chercheur.component.html',
  styleUrls: ['./communaute-savoir-expertise-scientifique-edit-chercheur.component.css']
})
export class CommunauteSavoirExpertiseScientifiqueEditChercheurComponent implements OnInit {
