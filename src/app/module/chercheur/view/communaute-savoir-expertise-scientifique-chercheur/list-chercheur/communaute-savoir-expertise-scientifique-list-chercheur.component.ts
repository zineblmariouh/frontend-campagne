...
@Component({
  selector: 'app-communaute-savoir-expertise-scientifique-list-chercheur',
  templateUrl: './communaute-savoir-expertise-scientifique-list-chercheur.component.html',
  styleUrls: ['./communaute-savoir-expertise-scientifique-list-chercheur.component.css']
})
export class CommunauteSavoirExpertiseScientifiqueListChercheurComponent implements OnInit {
   // declarations
