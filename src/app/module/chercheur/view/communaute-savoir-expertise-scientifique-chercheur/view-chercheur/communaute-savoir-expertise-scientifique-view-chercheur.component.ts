...
@Component({
  selector: 'app-communaute-savoir-expertise-scientifique-view-chercheur',
  templateUrl: './communaute-savoir-expertise-scientifique-view-chercheur.component.html',
  styleUrls: ['./communaute-savoir-expertise-scientifique-view-chercheur.component.css']
})
export class CommunauteSavoirExpertiseScientifiqueViewChercheurComponent implements OnInit {
