...
@Component({
  selector: 'app-communaute-savoir-projet-activite-recherche-edit-chercheur',
  templateUrl: './communaute-savoir-projet-activite-recherche-edit-chercheur.component.html',
  styleUrls: ['./communaute-savoir-projet-activite-recherche-edit-chercheur.component.css']
})
export class CommunauteSavoirProjetActiviteRechercheEditChercheurComponent implements OnInit {
