...
@Component({
  selector: 'app-conseil-et-comite-scientifique-edit-chercheur',
  templateUrl: './conseil-et-comite-scientifique-edit-chercheur.component.html',
  styleUrls: ['./conseil-et-comite-scientifique-edit-chercheur.component.css']
})
export class ConseilEtComiteScientifiqueEditChercheurComponent implements OnInit {
