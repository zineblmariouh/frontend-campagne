...
@Component({
  selector: 'app-conseil-et-comite-scientifique-list-chercheur',
  templateUrl: './conseil-et-comite-scientifique-list-chercheur.component.html',
  styleUrls: ['./conseil-et-comite-scientifique-list-chercheur.component.css']
})
export class ConseilEtComiteScientifiqueListChercheurComponent implements OnInit {
   // declarations
