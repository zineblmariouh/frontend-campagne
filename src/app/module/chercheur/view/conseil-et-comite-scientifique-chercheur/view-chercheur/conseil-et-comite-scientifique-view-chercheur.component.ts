...
@Component({
  selector: 'app-conseil-et-comite-scientifique-view-chercheur',
  templateUrl: './conseil-et-comite-scientifique-view-chercheur.component.html',
  styleUrls: ['./conseil-et-comite-scientifique-view-chercheur.component.css']
})
export class ConseilEtComiteScientifiqueViewChercheurComponent implements OnInit {
