...
@Component({
  selector: 'app-conseils-scientifique-view-chercheur',
  templateUrl: './conseils-scientifique-view-chercheur.component.html',
  styleUrls: ['./conseils-scientifique-view-chercheur.component.css']
})
export class ConseilsScientifiqueViewChercheurComponent implements OnInit {
