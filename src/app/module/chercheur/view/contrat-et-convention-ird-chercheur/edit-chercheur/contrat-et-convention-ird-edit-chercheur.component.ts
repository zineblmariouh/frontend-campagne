...
@Component({
  selector: 'app-contrat-et-convention-ird-edit-chercheur',
  templateUrl: './contrat-et-convention-ird-edit-chercheur.component.html',
  styleUrls: ['./contrat-et-convention-ird-edit-chercheur.component.css']
})
export class ContratEtConventionIrdEditChercheurComponent implements OnInit {
