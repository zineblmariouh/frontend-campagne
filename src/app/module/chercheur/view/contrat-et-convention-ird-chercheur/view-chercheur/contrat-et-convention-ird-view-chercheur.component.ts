...
@Component({
  selector: 'app-contrat-et-convention-ird-view-chercheur',
  templateUrl: './contrat-et-convention-ird-view-chercheur.component.html',
  styleUrls: ['./contrat-et-convention-ird-view-chercheur.component.css']
})
export class ContratEtConventionIrdViewChercheurComponent implements OnInit {
