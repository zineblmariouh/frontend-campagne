...
@Component({
  selector: 'app-culture-scientifique-edit-chercheur',
  templateUrl: './culture-scientifique-edit-chercheur.component.html',
  styleUrls: ['./culture-scientifique-edit-chercheur.component.css']
})
export class CultureScientifiqueEditChercheurComponent implements OnInit {
