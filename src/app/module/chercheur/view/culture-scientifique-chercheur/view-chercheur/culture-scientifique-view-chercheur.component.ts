...
@Component({
  selector: 'app-culture-scientifique-view-chercheur',
  templateUrl: './culture-scientifique-view-chercheur.component.html',
  styleUrls: ['./culture-scientifique-view-chercheur.component.css']
})
export class CultureScientifiqueViewChercheurComponent implements OnInit {
