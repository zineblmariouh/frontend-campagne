...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-list-chercheur',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-list-chercheur.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-list-chercheur.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueListChercheurComponent implements OnInit {
   // declarations
