...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-communaute-savoir-view-chercheur',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-communaute-savoir-view-chercheur.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-communaute-savoir-view-chercheur.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueCommunauteSavoirViewChercheurComponent implements OnInit {
...
hideViewDialog(){
    this.viewDeveloppementDeSavoirEtInnovationScientifiqueCommunauteSavoirDialog  = false;
}
