...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-discipline-scientifique-list-chercheur',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-discipline-scientifique-list-chercheur.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-discipline-scientifique-list-chercheur.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueDisciplineScientifiqueListChercheurComponent implements OnInit {
   // declarations
