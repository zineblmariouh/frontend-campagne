...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-etablissement-list-chercheur',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-etablissement-list-chercheur.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-etablissement-list-chercheur.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueEtablissementListChercheurComponent implements OnInit {
   // declarations
