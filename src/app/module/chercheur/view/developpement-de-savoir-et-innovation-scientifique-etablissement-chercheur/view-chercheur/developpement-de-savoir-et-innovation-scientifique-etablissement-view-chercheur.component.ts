...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-etablissement-view-chercheur',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-etablissement-view-chercheur.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-etablissement-view-chercheur.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueEtablissementViewChercheurComponent implements OnInit {
