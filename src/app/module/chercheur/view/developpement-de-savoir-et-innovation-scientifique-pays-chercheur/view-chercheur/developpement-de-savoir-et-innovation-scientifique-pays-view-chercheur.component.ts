...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-pays-view-chercheur',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-pays-view-chercheur.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-pays-view-chercheur.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiquePaysViewChercheurComponent implements OnInit {
