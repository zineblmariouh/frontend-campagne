...
@Component({
  selector: 'app-discipline-scientifique-comite-et-commission-evaluation-edit-chercheur',
  templateUrl: './discipline-scientifique-comite-et-commission-evaluation-edit-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-comite-et-commission-evaluation-edit-chercheur.component.css']
})
export class DisciplineScientifiqueComiteEtCommissionEvaluationEditChercheurComponent implements OnInit {
