...
@Component({
  selector: 'app-discipline-scientifique-comite-et-commission-evaluation-view-chercheur',
  templateUrl: './discipline-scientifique-comite-et-commission-evaluation-view-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-comite-et-commission-evaluation-view-chercheur.component.css']
})
export class DisciplineScientifiqueComiteEtCommissionEvaluationViewChercheurComponent implements OnInit {
