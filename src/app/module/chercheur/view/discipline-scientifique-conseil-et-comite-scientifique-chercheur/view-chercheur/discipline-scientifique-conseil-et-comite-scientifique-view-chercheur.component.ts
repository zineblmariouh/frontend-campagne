...
@Component({
  selector: 'app-discipline-scientifique-conseil-et-comite-scientifique-view-chercheur',
  templateUrl: './discipline-scientifique-conseil-et-comite-scientifique-view-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-conseil-et-comite-scientifique-view-chercheur.component.css']
})
export class DisciplineScientifiqueConseilEtComiteScientifiqueViewChercheurComponent implements OnInit {
