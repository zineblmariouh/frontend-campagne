...
@Component({
  selector: 'app-discipline-scientifique-consultance-scientifique-ponctuelle-view-chercheur',
  templateUrl: './discipline-scientifique-consultance-scientifique-ponctuelle-view-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-consultance-scientifique-ponctuelle-view-chercheur.component.css']
})
export class DisciplineScientifiqueConsultanceScientifiquePonctuelleViewChercheurComponent implements OnInit {
