...
@Component({
  selector: 'app-discipline-scientifique-encadrement-doctorant-edit-chercheur',
  templateUrl: './discipline-scientifique-encadrement-doctorant-edit-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-encadrement-doctorant-edit-chercheur.component.css']
})
export class DisciplineScientifiqueEncadrementDoctorantEditChercheurComponent implements OnInit {
