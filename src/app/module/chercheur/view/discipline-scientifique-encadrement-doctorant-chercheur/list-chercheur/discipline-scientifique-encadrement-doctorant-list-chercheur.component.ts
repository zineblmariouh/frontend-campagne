...
@Component({
  selector: 'app-discipline-scientifique-encadrement-doctorant-list-chercheur',
  templateUrl: './discipline-scientifique-encadrement-doctorant-list-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-encadrement-doctorant-list-chercheur.component.css']
})
export class DisciplineScientifiqueEncadrementDoctorantListChercheurComponent implements OnInit {
   // declarations
