...
@Component({
  selector: 'app-discipline-scientifique-encadrement-doctorant-view-chercheur',
  templateUrl: './discipline-scientifique-encadrement-doctorant-view-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-encadrement-doctorant-view-chercheur.component.css']
})
export class DisciplineScientifiqueEncadrementDoctorantViewChercheurComponent implements OnInit {
