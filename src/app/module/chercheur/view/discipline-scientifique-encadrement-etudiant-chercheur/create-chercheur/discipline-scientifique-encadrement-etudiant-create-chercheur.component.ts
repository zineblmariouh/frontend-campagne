...
@Component({
  selector: 'app-discipline-scientifique-encadrement-etudiant-create-chercheur',
  templateUrl: './discipline-scientifique-encadrement-etudiant-create-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-encadrement-etudiant-create-chercheur.component.css']
})
export class DisciplineScientifiqueEncadrementEtudiantCreateChercheurComponent implements OnInit {
