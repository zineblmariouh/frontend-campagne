...
@Component({
  selector: 'app-discipline-scientifique-encadrement-etudiant-edit-chercheur',
  templateUrl: './discipline-scientifique-encadrement-etudiant-edit-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-encadrement-etudiant-edit-chercheur.component.css']
})
export class DisciplineScientifiqueEncadrementEtudiantEditChercheurComponent implements OnInit {
