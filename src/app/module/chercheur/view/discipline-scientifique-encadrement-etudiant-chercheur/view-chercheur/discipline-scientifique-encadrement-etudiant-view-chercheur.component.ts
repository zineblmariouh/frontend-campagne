...
@Component({
  selector: 'app-discipline-scientifique-encadrement-etudiant-view-chercheur',
  templateUrl: './discipline-scientifique-encadrement-etudiant-view-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-encadrement-etudiant-view-chercheur.component.css']
})
export class DisciplineScientifiqueEncadrementEtudiantViewChercheurComponent implements OnInit {
