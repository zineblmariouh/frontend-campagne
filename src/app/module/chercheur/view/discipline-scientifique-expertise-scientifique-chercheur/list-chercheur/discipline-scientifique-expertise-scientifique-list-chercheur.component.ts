...
@Component({
  selector: 'app-discipline-scientifique-expertise-scientifique-list-chercheur',
  templateUrl: './discipline-scientifique-expertise-scientifique-list-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-expertise-scientifique-list-chercheur.component.css']
})
export class DisciplineScientifiqueExpertiseScientifiqueListChercheurComponent implements OnInit {
   // declarations
