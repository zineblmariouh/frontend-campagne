...
@Component({
  selector: 'app-discipline-scientifique-expertise-scientifique-view-chercheur',
  templateUrl: './discipline-scientifique-expertise-scientifique-view-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-expertise-scientifique-view-chercheur.component.css']
})
export class DisciplineScientifiqueExpertiseScientifiqueViewChercheurComponent implements OnInit {
