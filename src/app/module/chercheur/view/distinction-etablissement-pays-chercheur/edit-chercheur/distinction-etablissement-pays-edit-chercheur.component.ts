...
@Component({
  selector: 'app-distinction-etablissement-pays-edit-chercheur',
  templateUrl: './distinction-etablissement-pays-edit-chercheur.component.html',
  styleUrls: ['./distinction-etablissement-pays-edit-chercheur.component.css']
})
export class DistinctionEtablissementPaysEditChercheurComponent implements OnInit {
