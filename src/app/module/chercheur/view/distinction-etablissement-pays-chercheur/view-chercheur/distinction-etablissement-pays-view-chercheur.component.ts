...
@Component({
  selector: 'app-distinction-etablissement-pays-view-chercheur',
  templateUrl: './distinction-etablissement-pays-view-chercheur.component.html',
  styleUrls: ['./distinction-etablissement-pays-view-chercheur.component.css']
})
export class DistinctionEtablissementPaysViewChercheurComponent implements OnInit {
