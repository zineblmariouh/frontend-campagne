...
@Component({
  selector: 'app-encadrement-view-chercheur',
  templateUrl: './encadrement-view-chercheur.component.html',
  styleUrls: ['./encadrement-view-chercheur.component.css']
})
export class EncadrementViewChercheurComponent implements OnInit {
