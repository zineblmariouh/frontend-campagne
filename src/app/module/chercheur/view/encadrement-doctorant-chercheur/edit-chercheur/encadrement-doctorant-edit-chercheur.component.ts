...
@Component({
  selector: 'app-encadrement-doctorant-edit-chercheur',
  templateUrl: './encadrement-doctorant-edit-chercheur.component.html',
  styleUrls: ['./encadrement-doctorant-edit-chercheur.component.css']
})
export class EncadrementDoctorantEditChercheurComponent implements OnInit {
