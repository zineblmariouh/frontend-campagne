...
@Component({
  selector: 'app-encadrement-doctorant-list-chercheur',
  templateUrl: './encadrement-doctorant-list-chercheur.component.html',
  styleUrls: ['./encadrement-doctorant-list-chercheur.component.css']
})
export class EncadrementDoctorantListChercheurComponent implements OnInit {
   // declarations
