...
@Component({
  selector: 'app-encadrement-doctorant-view-chercheur',
  templateUrl: './encadrement-doctorant-view-chercheur.component.html',
  styleUrls: ['./encadrement-doctorant-view-chercheur.component.css']
})
export class EncadrementDoctorantViewChercheurComponent implements OnInit {
