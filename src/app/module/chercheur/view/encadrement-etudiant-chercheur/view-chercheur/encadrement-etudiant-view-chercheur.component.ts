...
@Component({
  selector: 'app-encadrement-etudiant-view-chercheur',
  templateUrl: './encadrement-etudiant-view-chercheur.component.html',
  styleUrls: ['./encadrement-etudiant-view-chercheur.component.css']
})
export class EncadrementEtudiantViewChercheurComponent implements OnInit {
