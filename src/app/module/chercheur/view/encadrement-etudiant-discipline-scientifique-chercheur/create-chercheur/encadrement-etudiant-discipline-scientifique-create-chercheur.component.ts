...
@Component({
  selector: 'app-encadrement-etudiant-discipline-scientifique-create-chercheur',
  templateUrl: './encadrement-etudiant-discipline-scientifique-create-chercheur.component.html',
  styleUrls: ['./encadrement-etudiant-discipline-scientifique-create-chercheur.component.css']
})
export class EncadrementEtudiantDisciplineScientifiqueCreateChercheurComponent implements OnInit {
