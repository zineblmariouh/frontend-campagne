...
@Component({
  selector: 'app-encadrement-etudiant-discipline-scientifique-edit-chercheur',
  templateUrl: './encadrement-etudiant-discipline-scientifique-edit-chercheur.component.html',
  styleUrls: ['./encadrement-etudiant-discipline-scientifique-edit-chercheur.component.css']
})
export class EncadrementEtudiantDisciplineScientifiqueEditChercheurComponent implements OnInit {
