...
@Component({
  selector: 'app-encadrement-etudiant-discipline-scientifique-list-chercheur',
  templateUrl: './encadrement-etudiant-discipline-scientifique-list-chercheur.component.html',
  styleUrls: ['./encadrement-etudiant-discipline-scientifique-list-chercheur.component.css']
})
export class EncadrementEtudiantDisciplineScientifiqueListChercheurComponent implements OnInit {
   // declarations
