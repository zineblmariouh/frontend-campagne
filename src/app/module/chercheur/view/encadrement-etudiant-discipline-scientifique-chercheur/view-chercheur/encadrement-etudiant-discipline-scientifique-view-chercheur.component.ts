...
@Component({
  selector: 'app-encadrement-etudiant-discipline-scientifique-view-chercheur',
  templateUrl: './encadrement-etudiant-discipline-scientifique-view-chercheur.component.html',
  styleUrls: ['./encadrement-etudiant-discipline-scientifique-view-chercheur.component.css']
})
export class EncadrementEtudiantDisciplineScientifiqueViewChercheurComponent implements OnInit {
