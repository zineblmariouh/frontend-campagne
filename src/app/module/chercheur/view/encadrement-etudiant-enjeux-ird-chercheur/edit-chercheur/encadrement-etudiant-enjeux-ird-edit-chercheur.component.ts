...
@Component({
  selector: 'app-encadrement-etudiant-enjeux-ird-edit-chercheur',
  templateUrl: './encadrement-etudiant-enjeux-ird-edit-chercheur.component.html',
  styleUrls: ['./encadrement-etudiant-enjeux-ird-edit-chercheur.component.css']
})
export class EncadrementEtudiantEnjeuxIrdEditChercheurComponent implements OnInit {
