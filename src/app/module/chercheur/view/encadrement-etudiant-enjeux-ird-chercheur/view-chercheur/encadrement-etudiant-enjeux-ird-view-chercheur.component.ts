...
@Component({
  selector: 'app-encadrement-etudiant-enjeux-ird-view-chercheur',
  templateUrl: './encadrement-etudiant-enjeux-ird-view-chercheur.component.html',
  styleUrls: ['./encadrement-etudiant-enjeux-ird-view-chercheur.component.css']
})
export class EncadrementEtudiantEnjeuxIrdViewChercheurComponent implements OnInit {
