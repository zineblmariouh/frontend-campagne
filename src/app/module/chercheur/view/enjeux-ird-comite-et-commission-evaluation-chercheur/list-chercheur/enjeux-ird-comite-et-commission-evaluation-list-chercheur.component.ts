...
@Component({
  selector: 'app-enjeux-ird-comite-et-commission-evaluation-list-chercheur',
  templateUrl: './enjeux-ird-comite-et-commission-evaluation-list-chercheur.component.html',
  styleUrls: ['./enjeux-ird-comite-et-commission-evaluation-list-chercheur.component.css']
})
export class EnjeuxIrdComiteEtCommissionEvaluationListChercheurComponent implements OnInit {
   // declarations
