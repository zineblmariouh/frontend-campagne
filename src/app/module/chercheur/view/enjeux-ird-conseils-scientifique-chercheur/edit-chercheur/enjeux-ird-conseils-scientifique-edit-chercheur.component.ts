...
@Component({
  selector: 'app-enjeux-ird-conseils-scientifique-edit-chercheur',
  templateUrl: './enjeux-ird-conseils-scientifique-edit-chercheur.component.html',
  styleUrls: ['./enjeux-ird-conseils-scientifique-edit-chercheur.component.css']
})
export class EnjeuxIrdConseilsScientifiqueEditChercheurComponent implements OnInit {
