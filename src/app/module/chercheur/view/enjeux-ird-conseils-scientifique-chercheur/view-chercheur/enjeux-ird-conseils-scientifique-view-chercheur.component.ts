...
@Component({
  selector: 'app-enjeux-ird-conseils-scientifique-view-chercheur',
  templateUrl: './enjeux-ird-conseils-scientifique-view-chercheur.component.html',
  styleUrls: ['./enjeux-ird-conseils-scientifique-view-chercheur.component.css']
})
export class EnjeuxIrdConseilsScientifiqueViewChercheurComponent implements OnInit {
