...
@Component({
  selector: 'app-enjeux-ird-encadrement-doctorant-view-chercheur',
  templateUrl: './enjeux-ird-encadrement-doctorant-view-chercheur.component.html',
  styleUrls: ['./enjeux-ird-encadrement-doctorant-view-chercheur.component.css']
})
export class EnjeuxIrdEncadrementDoctorantViewChercheurComponent implements OnInit {
