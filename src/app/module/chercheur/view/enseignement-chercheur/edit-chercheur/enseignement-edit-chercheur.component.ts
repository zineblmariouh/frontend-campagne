...
@Component({
  selector: 'app-enseignement-edit-chercheur',
  templateUrl: './enseignement-edit-chercheur.component.html',
  styleUrls: ['./enseignement-edit-chercheur.component.css']
})
export class EnseignementEditChercheurComponent implements OnInit {
