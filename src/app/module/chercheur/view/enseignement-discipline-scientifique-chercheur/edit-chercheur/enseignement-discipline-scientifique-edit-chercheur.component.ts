...
@Component({
  selector: 'app-enseignement-discipline-scientifique-edit-chercheur',
  templateUrl: './enseignement-discipline-scientifique-edit-chercheur.component.html',
  styleUrls: ['./enseignement-discipline-scientifique-edit-chercheur.component.css']
})
export class EnseignementDisciplineScientifiqueEditChercheurComponent implements OnInit {
