...
@Component({
  selector: 'app-enseignement-discipline-scientifique-list-chercheur',
  templateUrl: './enseignement-discipline-scientifique-list-chercheur.component.html',
  styleUrls: ['./enseignement-discipline-scientifique-list-chercheur.component.css']
})
export class EnseignementDisciplineScientifiqueListChercheurComponent implements OnInit {
   // declarations
