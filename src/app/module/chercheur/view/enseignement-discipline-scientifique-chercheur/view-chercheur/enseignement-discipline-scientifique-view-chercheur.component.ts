...
@Component({
  selector: 'app-enseignement-discipline-scientifique-view-chercheur',
  templateUrl: './enseignement-discipline-scientifique-view-chercheur.component.html',
  styleUrls: ['./enseignement-discipline-scientifique-view-chercheur.component.css']
})
export class EnseignementDisciplineScientifiqueViewChercheurComponent implements OnInit {
