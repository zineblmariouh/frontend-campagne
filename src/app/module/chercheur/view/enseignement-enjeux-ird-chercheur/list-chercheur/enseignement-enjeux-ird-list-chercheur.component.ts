...
@Component({
  selector: 'app-enseignement-enjeux-ird-list-chercheur',
  templateUrl: './enseignement-enjeux-ird-list-chercheur.component.html',
  styleUrls: ['./enseignement-enjeux-ird-list-chercheur.component.css']
})
export class EnseignementEnjeuxIrdListChercheurComponent implements OnInit {
   // declarations
