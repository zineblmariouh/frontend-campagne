...
@Component({
  selector: 'app-enseignement-enjeux-ird-view-chercheur',
  templateUrl: './enseignement-enjeux-ird-view-chercheur.component.html',
  styleUrls: ['./enseignement-enjeux-ird-view-chercheur.component.css']
})
export class EnseignementEnjeuxIrdViewChercheurComponent implements OnInit {
