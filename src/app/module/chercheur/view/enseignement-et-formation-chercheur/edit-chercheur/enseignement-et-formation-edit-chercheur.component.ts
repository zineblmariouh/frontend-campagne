...
@Component({
  selector: 'app-enseignement-et-formation-edit-chercheur',
  templateUrl: './enseignement-et-formation-edit-chercheur.component.html',
  styleUrls: ['./enseignement-et-formation-edit-chercheur.component.css']
})
export class EnseignementEtFormationEditChercheurComponent implements OnInit {
