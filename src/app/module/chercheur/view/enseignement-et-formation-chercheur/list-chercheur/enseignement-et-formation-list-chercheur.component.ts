...
@Component({
  selector: 'app-enseignement-et-formation-list-chercheur',
  templateUrl: './enseignement-et-formation-list-chercheur.component.html',
  styleUrls: ['./enseignement-et-formation-list-chercheur.component.css']
})
export class EnseignementEtFormationListChercheurComponent implements OnInit {
   // declarations
...
navigateToEnseignementEtFormationCreate(){
this.router.navigate(['/app/chercheur/enseignementEtFormation/create']);
}
         ...
         if(isPermistted){
          this.enseignementEtFormationService.findByIdWithAssociatedList(enseignementEtFormation).subscribe(res => {
           this.selectedEnseignementEtFormation = res;
            this.navigateToEnseignementEtFormationCreate() ;
          });
        }else{
