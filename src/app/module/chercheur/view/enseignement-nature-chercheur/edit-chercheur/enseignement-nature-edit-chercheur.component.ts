...
@Component({
  selector: 'app-enseignement-nature-edit-chercheur',
  templateUrl: './enseignement-nature-edit-chercheur.component.html',
  styleUrls: ['./enseignement-nature-edit-chercheur.component.css']
})
export class EnseignementNatureEditChercheurComponent implements OnInit {
