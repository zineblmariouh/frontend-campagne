...
@Component({
  selector: 'app-enseignement-nature-list-chercheur',
  templateUrl: './enseignement-nature-list-chercheur.component.html',
  styleUrls: ['./enseignement-nature-list-chercheur.component.css']
})
export class EnseignementNatureListChercheurComponent implements OnInit {
   // declarations
