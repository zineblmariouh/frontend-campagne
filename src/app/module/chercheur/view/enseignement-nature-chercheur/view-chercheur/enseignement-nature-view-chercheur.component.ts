...
@Component({
  selector: 'app-enseignement-nature-view-chercheur',
  templateUrl: './enseignement-nature-view-chercheur.component.html',
  styleUrls: ['./enseignement-nature-view-chercheur.component.css']
})
export class EnseignementNatureViewChercheurComponent implements OnInit {
