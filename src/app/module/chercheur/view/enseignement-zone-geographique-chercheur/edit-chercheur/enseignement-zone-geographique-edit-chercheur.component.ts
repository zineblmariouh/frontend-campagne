...
@Component({
  selector: 'app-enseignement-zone-geographique-edit-chercheur',
  templateUrl: './enseignement-zone-geographique-edit-chercheur.component.html',
  styleUrls: ['./enseignement-zone-geographique-edit-chercheur.component.css']
})
export class EnseignementZoneGeographiqueEditChercheurComponent implements OnInit {
