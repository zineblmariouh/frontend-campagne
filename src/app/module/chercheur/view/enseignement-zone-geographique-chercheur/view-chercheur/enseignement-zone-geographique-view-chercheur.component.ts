...
@Component({
  selector: 'app-enseignement-zone-geographique-view-chercheur',
  templateUrl: './enseignement-zone-geographique-view-chercheur.component.html',
  styleUrls: ['./enseignement-zone-geographique-view-chercheur.component.css']
})
export class EnseignementZoneGeographiqueViewChercheurComponent implements OnInit {
