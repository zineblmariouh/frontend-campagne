...
@Component({
  selector: 'app-etablissement-comite-et-commission-evaluation-view-chercheur',
  templateUrl: './etablissement-comite-et-commission-evaluation-view-chercheur.component.html',
  styleUrls: ['./etablissement-comite-et-commission-evaluation-view-chercheur.component.css']
})
export class EtablissementComiteEtCommissionEvaluationViewChercheurComponent implements OnInit {
