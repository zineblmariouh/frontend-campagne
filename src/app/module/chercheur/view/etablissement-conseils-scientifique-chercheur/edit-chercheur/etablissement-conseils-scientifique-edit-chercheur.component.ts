...
@Component({
  selector: 'app-etablissement-conseils-scientifique-edit-chercheur',
  templateUrl: './etablissement-conseils-scientifique-edit-chercheur.component.html',
  styleUrls: ['./etablissement-conseils-scientifique-edit-chercheur.component.css']
})
export class EtablissementConseilsScientifiqueEditChercheurComponent implements OnInit {
