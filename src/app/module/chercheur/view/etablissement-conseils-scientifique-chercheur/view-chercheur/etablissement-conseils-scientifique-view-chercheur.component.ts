...
@Component({
  selector: 'app-etablissement-conseils-scientifique-view-chercheur',
  templateUrl: './etablissement-conseils-scientifique-view-chercheur.component.html',
  styleUrls: ['./etablissement-conseils-scientifique-view-chercheur.component.css']
})
export class EtablissementConseilsScientifiqueViewChercheurComponent implements OnInit {
