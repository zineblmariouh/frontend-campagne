...
@Component({
  selector: 'app-etablissement-consultance-scientifique-ponctuelle-edit-chercheur',
  templateUrl: './etablissement-consultance-scientifique-ponctuelle-edit-chercheur.component.html',
  styleUrls: ['./etablissement-consultance-scientifique-ponctuelle-edit-chercheur.component.css']
})
export class EtablissementConsultanceScientifiquePonctuelleEditChercheurComponent implements OnInit {
