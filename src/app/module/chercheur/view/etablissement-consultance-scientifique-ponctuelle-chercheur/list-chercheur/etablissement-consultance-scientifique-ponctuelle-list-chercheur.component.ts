...
@Component({
  selector: 'app-etablissement-consultance-scientifique-ponctuelle-list-chercheur',
  templateUrl: './etablissement-consultance-scientifique-ponctuelle-list-chercheur.component.html',
  styleUrls: ['./etablissement-consultance-scientifique-ponctuelle-list-chercheur.component.css']
})
export class EtablissementConsultanceScientifiquePonctuelleListChercheurComponent implements OnInit {
   // declarations
