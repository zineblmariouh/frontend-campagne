...
@Component({
  selector: 'app-etablissement-enseignement-edit-chercheur',
  templateUrl: './etablissement-enseignement-edit-chercheur.component.html',
  styleUrls: ['./etablissement-enseignement-edit-chercheur.component.css']
})
export class EtablissementEnseignementEditChercheurComponent implements OnInit {
