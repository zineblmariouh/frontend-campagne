...
@Component({
  selector: 'app-etablissement-enseignement-list-chercheur',
  templateUrl: './etablissement-enseignement-list-chercheur.component.html',
  styleUrls: ['./etablissement-enseignement-list-chercheur.component.css']
})
export class EtablissementEnseignementListChercheurComponent implements OnInit {
   // declarations
