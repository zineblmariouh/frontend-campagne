...
@Component({
  selector: 'app-etat-campagne-chercheur-edit-chercheur',
  templateUrl: './etat-campagne-chercheur-edit-chercheur.component.html',
  styleUrls: ['./etat-campagne-chercheur-edit-chercheur.component.css']
})
export class EtatCampagneChercheurEditChercheurComponent implements OnInit {
