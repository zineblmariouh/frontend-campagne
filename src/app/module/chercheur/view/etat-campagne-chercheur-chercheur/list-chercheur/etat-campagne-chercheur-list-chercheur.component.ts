...
@Component({
  selector: 'app-etat-campagne-chercheur-list-chercheur',
  templateUrl: './etat-campagne-chercheur-list-chercheur.component.html',
  styleUrls: ['./etat-campagne-chercheur-list-chercheur.component.css']
})
export class EtatCampagneChercheurListChercheurComponent implements OnInit {
   // declarations
