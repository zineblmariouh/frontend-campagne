...
@Component({
  selector: 'app-evenement-colloque-scienntifique-list-chercheur',
  templateUrl: './evenement-colloque-scienntifique-list-chercheur.component.html',
  styleUrls: ['./evenement-colloque-scienntifique-list-chercheur.component.css']
})
export class EvenementColloqueScienntifiqueListChercheurComponent implements OnInit {
   // declarations
