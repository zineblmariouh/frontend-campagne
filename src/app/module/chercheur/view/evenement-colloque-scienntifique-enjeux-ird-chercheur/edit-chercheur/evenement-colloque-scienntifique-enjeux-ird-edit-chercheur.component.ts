...
@Component({
  selector: 'app-evenement-colloque-scienntifique-enjeux-ird-edit-chercheur',
  templateUrl: './evenement-colloque-scienntifique-enjeux-ird-edit-chercheur.component.html',
  styleUrls: ['./evenement-colloque-scienntifique-enjeux-ird-edit-chercheur.component.css']
})
export class EvenementColloqueScienntifiqueEnjeuxIrdEditChercheurComponent implements OnInit {
