...
@Component({
  selector: 'app-evenement-colloque-scienntifique-enjeux-ird-list-chercheur',
  templateUrl: './evenement-colloque-scienntifique-enjeux-ird-list-chercheur.component.html',
  styleUrls: ['./evenement-colloque-scienntifique-enjeux-ird-list-chercheur.component.css']
})
export class EvenementColloqueScienntifiqueEnjeuxIrdListChercheurComponent implements OnInit {
   // declarations
