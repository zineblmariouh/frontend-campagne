...
@Component({
  selector: 'app-evenement-colloque-scienntifique-enjeux-ird-view-chercheur',
  templateUrl: './evenement-colloque-scienntifique-enjeux-ird-view-chercheur.component.html',
  styleUrls: ['./evenement-colloque-scienntifique-enjeux-ird-view-chercheur.component.css']
})
export class EvenementColloqueScienntifiqueEnjeuxIrdViewChercheurComponent implements OnInit {
