...
@Component({
  selector: 'app-expertise-scientifique-edit-chercheur',
  templateUrl: './expertise-scientifique-edit-chercheur.component.html',
  styleUrls: ['./expertise-scientifique-edit-chercheur.component.css']
})
export class ExpertiseScientifiqueEditChercheurComponent implements OnInit {
