...
@Component({
  selector: 'app-expertise-scientifique-view-chercheur',
  templateUrl: './expertise-scientifique-view-chercheur.component.html',
  styleUrls: ['./expertise-scientifique-view-chercheur.component.css']
})
export class ExpertiseScientifiqueViewChercheurComponent implements OnInit {
