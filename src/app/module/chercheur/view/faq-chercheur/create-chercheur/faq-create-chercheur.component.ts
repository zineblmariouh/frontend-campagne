...
@Component({
  selector: 'app-faq-create-chercheur',
  templateUrl: './faq-create-chercheur.component.html',
  styleUrls: ['./faq-create-chercheur.component.css']
})
export class FaqCreateChercheurComponent implements OnInit {
