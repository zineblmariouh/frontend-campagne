...
@Component({
  selector: 'app-faq-edit-chercheur',
  templateUrl: './faq-edit-chercheur.component.html',
  styleUrls: ['./faq-edit-chercheur.component.css']
})
export class FaqEditChercheurComponent implements OnInit {
