...
@Component({
  selector: 'app-formation-continue-list-chercheur',
  templateUrl: './formation-continue-list-chercheur.component.html',
  styleUrls: ['./formation-continue-list-chercheur.component.css']
})
export class FormationContinueListChercheurComponent implements OnInit {
   // declarations
