...
@Component({
  selector: 'app-formation-continue-view-chercheur',
  templateUrl: './formation-continue-view-chercheur.component.html',
  styleUrls: ['./formation-continue-view-chercheur.component.css']
})
export class FormationContinueViewChercheurComponent implements OnInit {
