...
@Component({
  selector: 'app-formation-continue-commanditaire-edit-chercheur',
  templateUrl: './formation-continue-commanditaire-edit-chercheur.component.html',
  styleUrls: ['./formation-continue-commanditaire-edit-chercheur.component.css']
})
export class FormationContinueCommanditaireEditChercheurComponent implements OnInit {
