...
@Component({
  selector: 'app-formation-continue-commanditaire-list-chercheur',
  templateUrl: './formation-continue-commanditaire-list-chercheur.component.html',
  styleUrls: ['./formation-continue-commanditaire-list-chercheur.component.css']
})
export class FormationContinueCommanditaireListChercheurComponent implements OnInit {
   // declarations
