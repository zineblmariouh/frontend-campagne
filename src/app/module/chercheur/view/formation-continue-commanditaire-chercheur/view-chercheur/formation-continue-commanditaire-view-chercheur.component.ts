...
@Component({
  selector: 'app-formation-continue-commanditaire-view-chercheur',
  templateUrl: './formation-continue-commanditaire-view-chercheur.component.html',
  styleUrls: ['./formation-continue-commanditaire-view-chercheur.component.css']
})
export class FormationContinueCommanditaireViewChercheurComponent implements OnInit {
