...
@Component({
  selector: 'app-formation-continue-discipline-scientifique-edit-chercheur',
  templateUrl: './formation-continue-discipline-scientifique-edit-chercheur.component.html',
  styleUrls: ['./formation-continue-discipline-scientifique-edit-chercheur.component.css']
})
export class FormationContinueDisciplineScientifiqueEditChercheurComponent implements OnInit {
