...
@Component({
  selector: 'app-formation-continue-discipline-scientifique-list-chercheur',
  templateUrl: './formation-continue-discipline-scientifique-list-chercheur.component.html',
  styleUrls: ['./formation-continue-discipline-scientifique-list-chercheur.component.css']
})
export class FormationContinueDisciplineScientifiqueListChercheurComponent implements OnInit {
   // declarations
