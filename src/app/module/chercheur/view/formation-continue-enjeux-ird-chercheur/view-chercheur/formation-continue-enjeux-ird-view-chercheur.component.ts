...
@Component({
  selector: 'app-formation-continue-enjeux-ird-view-chercheur',
  templateUrl: './formation-continue-enjeux-ird-view-chercheur.component.html',
  styleUrls: ['./formation-continue-enjeux-ird-view-chercheur.component.css']
})
export class FormationContinueEnjeuxIrdViewChercheurComponent implements OnInit {
