...
@Component({
  selector: 'app-formation-continue-objet-formation-generique-list-chercheur',
  templateUrl: './formation-continue-objet-formation-generique-list-chercheur.component.html',
  styleUrls: ['./formation-continue-objet-formation-generique-list-chercheur.component.css']
})
export class FormationContinueObjetFormationGeneriqueListChercheurComponent implements OnInit {
   // declarations
