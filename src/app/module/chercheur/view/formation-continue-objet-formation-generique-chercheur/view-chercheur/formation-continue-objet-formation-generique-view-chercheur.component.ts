...
@Component({
  selector: 'app-formation-continue-objet-formation-generique-view-chercheur',
  templateUrl: './formation-continue-objet-formation-generique-view-chercheur.component.html',
  styleUrls: ['./formation-continue-objet-formation-generique-view-chercheur.component.css']
})
export class FormationContinueObjetFormationGeneriqueViewChercheurComponent implements OnInit {
