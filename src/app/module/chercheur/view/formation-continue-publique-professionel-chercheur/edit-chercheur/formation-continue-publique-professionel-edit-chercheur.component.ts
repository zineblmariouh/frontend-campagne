...
@Component({
  selector: 'app-formation-continue-publique-professionel-edit-chercheur',
  templateUrl: './formation-continue-publique-professionel-edit-chercheur.component.html',
  styleUrls: ['./formation-continue-publique-professionel-edit-chercheur.component.css']
})
export class FormationContinuePubliqueProfessionelEditChercheurComponent implements OnInit {
