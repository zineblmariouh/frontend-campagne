...
@Component({
  selector: 'app-formation-continue-publique-professionel-list-chercheur',
  templateUrl: './formation-continue-publique-professionel-list-chercheur.component.html',
  styleUrls: ['./formation-continue-publique-professionel-list-chercheur.component.css']
})
export class FormationContinuePubliqueProfessionelListChercheurComponent implements OnInit {
   // declarations
