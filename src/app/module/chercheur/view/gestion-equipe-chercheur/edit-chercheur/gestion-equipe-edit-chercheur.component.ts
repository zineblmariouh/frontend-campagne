...
@Component({
  selector: 'app-gestion-equipe-edit-chercheur',
  templateUrl: './gestion-equipe-edit-chercheur.component.html',
  styleUrls: ['./gestion-equipe-edit-chercheur.component.css']
})
export class GestionEquipeEditChercheurComponent implements OnInit {
