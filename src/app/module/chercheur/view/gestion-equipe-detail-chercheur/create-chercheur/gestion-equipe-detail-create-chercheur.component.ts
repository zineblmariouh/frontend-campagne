...
@Component({
  selector: 'app-gestion-equipe-detail-create-chercheur',
  templateUrl: './gestion-equipe-detail-create-chercheur.component.html',
  styleUrls: ['./gestion-equipe-detail-create-chercheur.component.css']
})
export class GestionEquipeDetailCreateChercheurComponent implements OnInit {
