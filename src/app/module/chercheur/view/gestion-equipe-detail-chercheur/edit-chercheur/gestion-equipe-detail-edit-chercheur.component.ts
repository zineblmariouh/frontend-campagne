...
@Component({
  selector: 'app-gestion-equipe-detail-edit-chercheur',
  templateUrl: './gestion-equipe-detail-edit-chercheur.component.html',
  styleUrls: ['./gestion-equipe-detail-edit-chercheur.component.css']
})
export class GestionEquipeDetailEditChercheurComponent implements OnInit {
