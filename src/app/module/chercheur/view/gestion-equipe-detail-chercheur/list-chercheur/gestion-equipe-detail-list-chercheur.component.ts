...
@Component({
  selector: 'app-gestion-equipe-detail-list-chercheur',
  templateUrl: './gestion-equipe-detail-list-chercheur.component.html',
  styleUrls: ['./gestion-equipe-detail-list-chercheur.component.css']
})
export class GestionEquipeDetailListChercheurComponent implements OnInit {
   // declarations
