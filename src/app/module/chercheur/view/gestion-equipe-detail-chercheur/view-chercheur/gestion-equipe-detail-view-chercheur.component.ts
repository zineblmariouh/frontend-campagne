...
@Component({
  selector: 'app-gestion-equipe-detail-view-chercheur',
  templateUrl: './gestion-equipe-detail-view-chercheur.component.html',
  styleUrls: ['./gestion-equipe-detail-view-chercheur.component.css']
})
export class GestionEquipeDetailViewChercheurComponent implements OnInit {
