...
@Component({
  selector: 'app-instrument-ird-chercheur-edit-chercheur',
  templateUrl: './instrument-ird-chercheur-edit-chercheur.component.html',
  styleUrls: ['./instrument-ird-chercheur-edit-chercheur.component.css']
})
export class InstrumentIrdChercheurEditChercheurComponent implements OnInit {
