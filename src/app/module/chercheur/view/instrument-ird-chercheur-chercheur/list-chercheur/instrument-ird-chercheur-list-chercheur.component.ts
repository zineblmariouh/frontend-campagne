...
@Component({
  selector: 'app-instrument-ird-chercheur-list-chercheur',
  templateUrl: './instrument-ird-chercheur-list-chercheur.component.html',
  styleUrls: ['./instrument-ird-chercheur-list-chercheur.component.css']
})
export class InstrumentIrdChercheurListChercheurComponent implements OnInit {
   // declarations
