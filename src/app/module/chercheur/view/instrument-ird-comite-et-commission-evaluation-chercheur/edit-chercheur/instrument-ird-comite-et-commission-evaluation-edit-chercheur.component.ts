...
@Component({
  selector: 'app-instrument-ird-comite-et-commission-evaluation-edit-chercheur',
  templateUrl: './instrument-ird-comite-et-commission-evaluation-edit-chercheur.component.html',
  styleUrls: ['./instrument-ird-comite-et-commission-evaluation-edit-chercheur.component.css']
})
export class InstrumentIrdComiteEtCommissionEvaluationEditChercheurComponent implements OnInit {
