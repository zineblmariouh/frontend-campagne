...
@Component({
  selector: 'app-instrument-ird-comite-et-commission-evaluation-list-chercheur',
  templateUrl: './instrument-ird-comite-et-commission-evaluation-list-chercheur.component.html',
  styleUrls: ['./instrument-ird-comite-et-commission-evaluation-list-chercheur.component.css']
})
export class InstrumentIrdComiteEtCommissionEvaluationListChercheurComponent implements OnInit {
   // declarations
