...
@Component({
  selector: 'app-instrument-ird-comite-et-commission-evaluation-view-chercheur',
  templateUrl: './instrument-ird-comite-et-commission-evaluation-view-chercheur.component.html',
  styleUrls: ['./instrument-ird-comite-et-commission-evaluation-view-chercheur.component.css']
})
export class InstrumentIrdComiteEtCommissionEvaluationViewChercheurComponent implements OnInit {
