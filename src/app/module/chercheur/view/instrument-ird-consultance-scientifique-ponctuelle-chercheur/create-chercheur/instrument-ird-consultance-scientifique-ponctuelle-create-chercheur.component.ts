...
@Component({
  selector: 'app-instrument-ird-consultance-scientifique-ponctuelle-create-chercheur',
  templateUrl: './instrument-ird-consultance-scientifique-ponctuelle-create-chercheur.component.html',
  styleUrls: ['./instrument-ird-consultance-scientifique-ponctuelle-create-chercheur.component.css']
})
export class InstrumentIrdConsultanceScientifiquePonctuelleCreateChercheurComponent implements OnInit {
