...
@Component({
  selector: 'app-instrument-ird-consultance-scientifique-ponctuelle-edit-chercheur',
  templateUrl: './instrument-ird-consultance-scientifique-ponctuelle-edit-chercheur.component.html',
  styleUrls: ['./instrument-ird-consultance-scientifique-ponctuelle-edit-chercheur.component.css']
})
export class InstrumentIrdConsultanceScientifiquePonctuelleEditChercheurComponent implements OnInit {
