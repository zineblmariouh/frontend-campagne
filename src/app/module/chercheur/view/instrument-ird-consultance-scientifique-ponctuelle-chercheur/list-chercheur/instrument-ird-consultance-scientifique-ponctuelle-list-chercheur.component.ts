...
@Component({
  selector: 'app-instrument-ird-consultance-scientifique-ponctuelle-list-chercheur',
  templateUrl: './instrument-ird-consultance-scientifique-ponctuelle-list-chercheur.component.html',
  styleUrls: ['./instrument-ird-consultance-scientifique-ponctuelle-list-chercheur.component.css']
})
export class InstrumentIrdConsultanceScientifiquePonctuelleListChercheurComponent implements OnInit {
   // declarations
