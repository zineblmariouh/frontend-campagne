...
@Component({
  selector: 'app-instrument-ird-consultance-scientifique-ponctuelle-view-chercheur',
  templateUrl: './instrument-ird-consultance-scientifique-ponctuelle-view-chercheur.component.html',
  styleUrls: ['./instrument-ird-consultance-scientifique-ponctuelle-view-chercheur.component.css']
})
export class InstrumentIrdConsultanceScientifiquePonctuelleViewChercheurComponent implements OnInit {
