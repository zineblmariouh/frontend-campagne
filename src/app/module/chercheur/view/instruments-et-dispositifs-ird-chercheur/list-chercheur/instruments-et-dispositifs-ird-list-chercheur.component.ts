...
@Component({
  selector: 'app-instruments-et-dispositifs-ird-list-chercheur',
  templateUrl: './instruments-et-dispositifs-ird-list-chercheur.component.html',
  styleUrls: ['./instruments-et-dispositifs-ird-list-chercheur.component.css']
})
export class InstrumentsEtDispositifsIrdListChercheurComponent implements OnInit {
   // declarations
