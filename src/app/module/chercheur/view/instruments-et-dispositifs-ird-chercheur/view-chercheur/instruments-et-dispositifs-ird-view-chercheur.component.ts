...
@Component({
  selector: 'app-instruments-et-dispositifs-ird-view-chercheur',
  templateUrl: './instruments-et-dispositifs-ird-view-chercheur.component.html',
  styleUrls: ['./instruments-et-dispositifs-ird-view-chercheur.component.css']
})
export class InstrumentsEtDispositifsIrdViewChercheurComponent implements OnInit {
