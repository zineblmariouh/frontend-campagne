...
@Component({
  selector: 'app-langue-edit-chercheur',
  templateUrl: './langue-edit-chercheur.component.html',
  styleUrls: ['./langue-edit-chercheur.component.css']
})
export class LangueEditChercheurComponent implements OnInit {
