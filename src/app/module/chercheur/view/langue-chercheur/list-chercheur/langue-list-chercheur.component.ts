...
@Component({
  selector: 'app-langue-list-chercheur',
  templateUrl: './langue-list-chercheur.component.html',
  styleUrls: ['./langue-list-chercheur.component.css']
})
export class LangueListChercheurComponent implements OnInit {
   // declarations
