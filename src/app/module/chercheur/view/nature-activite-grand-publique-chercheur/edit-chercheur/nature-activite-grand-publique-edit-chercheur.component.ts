...
@Component({
  selector: 'app-nature-activite-grand-publique-edit-chercheur',
  templateUrl: './nature-activite-grand-publique-edit-chercheur.component.html',
  styleUrls: ['./nature-activite-grand-publique-edit-chercheur.component.css']
})
export class NatureActiviteGrandPubliqueEditChercheurComponent implements OnInit {
