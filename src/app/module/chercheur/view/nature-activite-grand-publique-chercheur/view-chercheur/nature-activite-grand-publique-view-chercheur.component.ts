...
@Component({
  selector: 'app-nature-activite-grand-publique-view-chercheur',
  templateUrl: './nature-activite-grand-publique-view-chercheur.component.html',
  styleUrls: ['./nature-activite-grand-publique-view-chercheur.component.css']
})
export class NatureActiviteGrandPubliqueViewChercheurComponent implements OnInit {
