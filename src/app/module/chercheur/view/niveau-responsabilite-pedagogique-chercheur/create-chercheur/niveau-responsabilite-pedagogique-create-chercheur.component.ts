...
@Component({
  selector: 'app-niveau-responsabilite-pedagogique-create-chercheur',
  templateUrl: './niveau-responsabilite-pedagogique-create-chercheur.component.html',
  styleUrls: ['./niveau-responsabilite-pedagogique-create-chercheur.component.css']
})
export class NiveauResponsabilitePedagogiqueCreateChercheurComponent implements OnInit {
