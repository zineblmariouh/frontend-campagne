...
@Component({
  selector: 'app-niveau-responsabilite-pedagogique-view-chercheur',
  templateUrl: './niveau-responsabilite-pedagogique-view-chercheur.component.html',
  styleUrls: ['./niveau-responsabilite-pedagogique-view-chercheur.component.css']
})
export class NiveauResponsabilitePedagogiqueViewChercheurComponent implements OnInit {
