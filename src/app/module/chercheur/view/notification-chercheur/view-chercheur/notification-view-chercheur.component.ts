...
@Component({
  selector: 'app-notification-view-chercheur',
  templateUrl: './notification-view-chercheur.component.html',
  styleUrls: ['./notification-view-chercheur.component.css']
})
export class NotificationViewChercheurComponent implements OnInit {
