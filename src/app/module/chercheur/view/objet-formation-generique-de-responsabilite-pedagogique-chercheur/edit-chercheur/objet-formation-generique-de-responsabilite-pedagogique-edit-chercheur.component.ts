...
@Component({
  selector: 'app-objet-formation-generique-de-responsabilite-pedagogique-edit-chercheur',
  templateUrl: './objet-formation-generique-de-responsabilite-pedagogique-edit-chercheur.component.html',
  styleUrls: ['./objet-formation-generique-de-responsabilite-pedagogique-edit-chercheur.component.css']
})
export class ObjetFormationGeneriqueDeResponsabilitePedagogiqueEditChercheurComponent implements OnInit {
