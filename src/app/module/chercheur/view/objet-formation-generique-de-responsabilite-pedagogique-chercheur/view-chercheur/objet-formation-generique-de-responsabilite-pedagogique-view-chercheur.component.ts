...
@Component({
  selector: 'app-objet-formation-generique-de-responsabilite-pedagogique-view-chercheur',
  templateUrl: './objet-formation-generique-de-responsabilite-pedagogique-view-chercheur.component.html',
  styleUrls: ['./objet-formation-generique-de-responsabilite-pedagogique-view-chercheur.component.css']
})
export class ObjetFormationGeneriqueDeResponsabilitePedagogiqueViewChercheurComponent implements OnInit {
