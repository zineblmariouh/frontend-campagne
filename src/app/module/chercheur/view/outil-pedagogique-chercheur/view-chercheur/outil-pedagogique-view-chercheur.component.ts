...
@Component({
  selector: 'app-outil-pedagogique-view-chercheur',
  templateUrl: './outil-pedagogique-view-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-view-chercheur.component.css']
})
export class OutilPedagogiqueViewChercheurComponent implements OnInit {
