...
@Component({
  selector: 'app-outil-pedagogique-discipline-scientifique-edit-chercheur',
  templateUrl: './outil-pedagogique-discipline-scientifique-edit-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-discipline-scientifique-edit-chercheur.component.css']
})
export class OutilPedagogiqueDisciplineScientifiqueEditChercheurComponent implements OnInit {
