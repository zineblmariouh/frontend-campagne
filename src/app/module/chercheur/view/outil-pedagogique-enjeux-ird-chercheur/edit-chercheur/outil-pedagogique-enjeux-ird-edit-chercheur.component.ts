...
@Component({
  selector: 'app-outil-pedagogique-enjeux-ird-edit-chercheur',
  templateUrl: './outil-pedagogique-enjeux-ird-edit-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-enjeux-ird-edit-chercheur.component.css']
})
export class OutilPedagogiqueEnjeuxIrdEditChercheurComponent implements OnInit {
