...
@Component({
  selector: 'app-outil-pedagogique-enjeux-ird-view-chercheur',
  templateUrl: './outil-pedagogique-enjeux-ird-view-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-enjeux-ird-view-chercheur.component.css']
})
export class OutilPedagogiqueEnjeuxIrdViewChercheurComponent implements OnInit {
