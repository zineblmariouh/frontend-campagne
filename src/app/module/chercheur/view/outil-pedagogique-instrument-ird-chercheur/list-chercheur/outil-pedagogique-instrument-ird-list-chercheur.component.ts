...
@Component({
  selector: 'app-outil-pedagogique-instrument-ird-list-chercheur',
  templateUrl: './outil-pedagogique-instrument-ird-list-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-instrument-ird-list-chercheur.component.css']
})
export class OutilPedagogiqueInstrumentIrdListChercheurComponent implements OnInit {
   // declarations
