...
@Component({
  selector: 'app-outil-pedagogique-pays-conception-edit-chercheur',
  templateUrl: './outil-pedagogique-pays-conception-edit-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-pays-conception-edit-chercheur.component.css']
})
export class OutilPedagogiquePaysConceptionEditChercheurComponent implements OnInit {
