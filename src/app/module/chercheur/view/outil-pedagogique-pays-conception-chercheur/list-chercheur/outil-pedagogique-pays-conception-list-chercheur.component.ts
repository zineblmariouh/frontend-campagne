...
@Component({
  selector: 'app-outil-pedagogique-pays-conception-list-chercheur',
  templateUrl: './outil-pedagogique-pays-conception-list-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-pays-conception-list-chercheur.component.css']
})
export class OutilPedagogiquePaysConceptionListChercheurComponent implements OnInit {
   // declarations
