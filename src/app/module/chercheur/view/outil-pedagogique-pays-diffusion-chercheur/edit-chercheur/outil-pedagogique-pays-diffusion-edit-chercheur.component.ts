...
@Component({
  selector: 'app-outil-pedagogique-pays-diffusion-edit-chercheur',
  templateUrl: './outil-pedagogique-pays-diffusion-edit-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-pays-diffusion-edit-chercheur.component.css']
})
export class OutilPedagogiquePaysDiffusionEditChercheurComponent implements OnInit {
