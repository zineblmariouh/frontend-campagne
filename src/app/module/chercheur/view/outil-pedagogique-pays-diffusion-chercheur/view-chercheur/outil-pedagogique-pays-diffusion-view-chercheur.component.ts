...
@Component({
  selector: 'app-outil-pedagogique-pays-diffusion-view-chercheur',
  templateUrl: './outil-pedagogique-pays-diffusion-view-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-pays-diffusion-view-chercheur.component.css']
})
export class OutilPedagogiquePaysDiffusionViewChercheurComponent implements OnInit {
