...
@Component({
  selector: 'app-outil-pedagogique-publique-cible-list-chercheur',
  templateUrl: './outil-pedagogique-publique-cible-list-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-publique-cible-list-chercheur.component.css']
})
export class OutilPedagogiquePubliqueCibleListChercheurComponent implements OnInit {
   // declarations
