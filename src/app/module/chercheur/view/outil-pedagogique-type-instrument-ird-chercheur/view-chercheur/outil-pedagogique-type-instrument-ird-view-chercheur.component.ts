...
@Component({
  selector: 'app-outil-pedagogique-type-instrument-ird-view-chercheur',
  templateUrl: './outil-pedagogique-type-instrument-ird-view-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-type-instrument-ird-view-chercheur.component.css']
})
export class OutilPedagogiqueTypeInstrumentIrdViewChercheurComponent implements OnInit {
