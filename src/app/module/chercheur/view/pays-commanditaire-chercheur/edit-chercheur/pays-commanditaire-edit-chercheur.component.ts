...
@Component({
  selector: 'app-pays-commanditaire-edit-chercheur',
  templateUrl: './pays-commanditaire-edit-chercheur.component.html',
  styleUrls: ['./pays-commanditaire-edit-chercheur.component.css']
})
export class PaysCommanditaireEditChercheurComponent implements OnInit {
