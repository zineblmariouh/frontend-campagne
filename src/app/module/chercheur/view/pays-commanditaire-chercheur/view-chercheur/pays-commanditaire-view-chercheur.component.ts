...
@Component({
  selector: 'app-pays-commanditaire-view-chercheur',
  templateUrl: './pays-commanditaire-view-chercheur.component.html',
  styleUrls: ['./pays-commanditaire-view-chercheur.component.css']
})
export class PaysCommanditaireViewChercheurComponent implements OnInit {
