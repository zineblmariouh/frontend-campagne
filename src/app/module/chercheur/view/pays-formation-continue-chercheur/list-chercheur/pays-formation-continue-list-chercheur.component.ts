...
@Component({
  selector: 'app-pays-formation-continue-list-chercheur',
  templateUrl: './pays-formation-continue-list-chercheur.component.html',
  styleUrls: ['./pays-formation-continue-list-chercheur.component.css']
})
export class PaysFormationContinueListChercheurComponent implements OnInit {
   // declarations
