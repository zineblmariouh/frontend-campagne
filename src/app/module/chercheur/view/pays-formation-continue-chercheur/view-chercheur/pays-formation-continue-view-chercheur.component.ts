...
@Component({
  selector: 'app-pays-formation-continue-view-chercheur',
  templateUrl: './pays-formation-continue-view-chercheur.component.html',
  styleUrls: ['./pays-formation-continue-view-chercheur.component.css']
})
export class PaysFormationContinueViewChercheurComponent implements OnInit {
