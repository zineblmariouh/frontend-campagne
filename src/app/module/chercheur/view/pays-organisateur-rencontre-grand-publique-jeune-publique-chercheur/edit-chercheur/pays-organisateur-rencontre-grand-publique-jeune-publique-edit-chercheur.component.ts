...
@Component({
  selector: 'app-pays-organisateur-rencontre-grand-publique-jeune-publique-edit-chercheur',
  templateUrl: './pays-organisateur-rencontre-grand-publique-jeune-publique-edit-chercheur.component.html',
  styleUrls: ['./pays-organisateur-rencontre-grand-publique-jeune-publique-edit-chercheur.component.css']
})
export class PaysOrganisateurRencontreGrandPubliqueJeunePubliqueEditChercheurComponent implements OnInit {
