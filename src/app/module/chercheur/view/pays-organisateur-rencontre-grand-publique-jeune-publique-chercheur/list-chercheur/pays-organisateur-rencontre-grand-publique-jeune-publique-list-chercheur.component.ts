...
@Component({
  selector: 'app-pays-organisateur-rencontre-grand-publique-jeune-publique-list-chercheur',
  templateUrl: './pays-organisateur-rencontre-grand-publique-jeune-publique-list-chercheur.component.html',
  styleUrls: ['./pays-organisateur-rencontre-grand-publique-jeune-publique-list-chercheur.component.css']
})
export class PaysOrganisateurRencontreGrandPubliqueJeunePubliqueListChercheurComponent implements OnInit {
   // declarations
