...
@Component({
  selector: 'app-pays-rencontre-grand-publique-jeune-publique-view-chercheur',
  templateUrl: './pays-rencontre-grand-publique-jeune-publique-view-chercheur.component.html',
  styleUrls: ['./pays-rencontre-grand-publique-jeune-publique-view-chercheur.component.css']
})
export class PaysRencontreGrandPubliqueJeunePubliqueViewChercheurComponent implements OnInit {
