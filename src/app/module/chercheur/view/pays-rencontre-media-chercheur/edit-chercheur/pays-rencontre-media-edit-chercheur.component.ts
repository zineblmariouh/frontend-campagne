...
@Component({
  selector: 'app-pays-rencontre-media-edit-chercheur',
  templateUrl: './pays-rencontre-media-edit-chercheur.component.html',
  styleUrls: ['./pays-rencontre-media-edit-chercheur.component.css']
})
export class PaysRencontreMediaEditChercheurComponent implements OnInit {
