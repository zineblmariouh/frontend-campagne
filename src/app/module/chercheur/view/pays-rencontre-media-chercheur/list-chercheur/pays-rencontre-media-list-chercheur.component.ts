...
@Component({
  selector: 'app-pays-rencontre-media-list-chercheur',
  templateUrl: './pays-rencontre-media-list-chercheur.component.html',
  styleUrls: ['./pays-rencontre-media-list-chercheur.component.css']
})
export class PaysRencontreMediaListChercheurComponent implements OnInit {
   // declarations
