...
@Component({
  selector: 'app-pays-rencontre-media-view-chercheur',
  templateUrl: './pays-rencontre-media-view-chercheur.component.html',
  styleUrls: ['./pays-rencontre-media-view-chercheur.component.css']
})
export class PaysRencontreMediaViewChercheurComponent implements OnInit {
