...
@Component({
  selector: 'app-pays-zone-geographique-list-chercheur',
  templateUrl: './pays-zone-geographique-list-chercheur.component.html',
  styleUrls: ['./pays-zone-geographique-list-chercheur.component.css']
})
export class PaysZoneGeographiqueListChercheurComponent implements OnInit {
   // declarations
