...
@Component({
  selector: 'app-pays-zone-geographique-view-chercheur',
  templateUrl: './pays-zone-geographique-view-chercheur.component.html',
  styleUrls: ['./pays-zone-geographique-view-chercheur.component.css']
})
export class PaysZoneGeographiqueViewChercheurComponent implements OnInit {
