...
@Component({
  selector: 'app-projet-activite-recherche-list-chercheur',
  templateUrl: './projet-activite-recherche-list-chercheur.component.html',
  styleUrls: ['./projet-activite-recherche-list-chercheur.component.css']
})
export class ProjetActiviteRechercheListChercheurComponent implements OnInit {
   // declarations
...
navigateToProjetActiviteRechercheCreate(){
this.router.navigate(['/app/chercheur/projetActiviteRecherche/create']);
}
         ...
         if(isPermistted){
          this.projetActiviteRechercheService.findByIdWithAssociatedList(projetActiviteRecherche).subscribe(res => {
           this.selectedProjetActiviteRecherche = res;
            this.navigateToProjetActiviteRechercheCreate() ;
          });
        }else{
