...
@Component({
  selector: 'app-projet-activite-recherche-detail-enjeux-ird-view-chercheur',
  templateUrl: './projet-activite-recherche-detail-enjeux-ird-view-chercheur.component.html',
  styleUrls: ['./projet-activite-recherche-detail-enjeux-ird-view-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailEnjeuxIrdViewChercheurComponent implements OnInit {
