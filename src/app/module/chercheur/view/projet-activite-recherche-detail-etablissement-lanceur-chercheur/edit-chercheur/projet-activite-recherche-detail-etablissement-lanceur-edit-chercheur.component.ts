...
@Component({
  selector: 'app-projet-activite-recherche-detail-etablissement-lanceur-edit-chercheur',
  templateUrl: './projet-activite-recherche-detail-etablissement-lanceur-edit-chercheur.component.html',
  styleUrls: ['./projet-activite-recherche-detail-etablissement-lanceur-edit-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailEtablissementLanceurEditChercheurComponent implements OnInit {
