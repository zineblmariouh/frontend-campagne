...
@Component({
  selector: 'app-projet-activite-recherche-detail-etablissement-lanceur-list-chercheur',
  templateUrl: './projet-activite-recherche-detail-etablissement-lanceur-list-chercheur.component.html',
  styleUrls: ['./projet-activite-recherche-detail-etablissement-lanceur-list-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailEtablissementLanceurListChercheurComponent implements OnInit {
   // declarations
