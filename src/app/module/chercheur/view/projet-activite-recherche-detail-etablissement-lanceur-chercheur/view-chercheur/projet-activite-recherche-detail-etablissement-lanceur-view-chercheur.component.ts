...
@Component({
  selector: 'app-projet-activite-recherche-detail-etablissement-lanceur-view-chercheur',
  templateUrl: './projet-activite-recherche-detail-etablissement-lanceur-view-chercheur.component.html',
  styleUrls: ['./projet-activite-recherche-detail-etablissement-lanceur-view-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailEtablissementLanceurViewChercheurComponent implements OnInit {
