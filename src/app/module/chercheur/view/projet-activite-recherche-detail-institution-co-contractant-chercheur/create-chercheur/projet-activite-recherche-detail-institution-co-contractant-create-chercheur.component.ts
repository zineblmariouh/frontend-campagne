...
@Component({
  selector: 'app-projet-activite-recherche-detail-institution-co-contractant-create-chercheur',
  templateUrl: './projet-activite-recherche-detail-institution-co-contractant-create-chercheur.component.html',
  styleUrls: ['./projet-activite-recherche-detail-institution-co-contractant-create-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailInstitutionCoContractantCreateChercheurComponent implements OnInit {
