...
@Component({
  selector: 'app-projet-activite-recherche-detail-institution-co-contractant-edit-chercheur',
  templateUrl: './projet-activite-recherche-detail-institution-co-contractant-edit-chercheur.component.html',
  styleUrls: ['./projet-activite-recherche-detail-institution-co-contractant-edit-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailInstitutionCoContractantEditChercheurComponent implements OnInit {
