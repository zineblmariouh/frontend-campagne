...
@Component({
  selector: 'app-projet-activite-recherche-detail-institution-co-contractant-list-chercheur',
  templateUrl: './projet-activite-recherche-detail-institution-co-contractant-list-chercheur.component.html',
  styleUrls: ['./projet-activite-recherche-detail-institution-co-contractant-list-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailInstitutionCoContractantListChercheurComponent implements OnInit {
   // declarations
