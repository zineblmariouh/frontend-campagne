...
@Component({
  selector: 'app-projet-activite-recherche-detail-pays-create-chercheur',
  templateUrl: './projet-activite-recherche-detail-pays-create-chercheur.component.html',
  styleUrls: ['./projet-activite-recherche-detail-pays-create-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailPaysCreateChercheurComponent implements OnInit {
