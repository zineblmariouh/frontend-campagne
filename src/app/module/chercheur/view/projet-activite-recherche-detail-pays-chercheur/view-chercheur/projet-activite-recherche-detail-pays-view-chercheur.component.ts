...
@Component({
  selector: 'app-projet-activite-recherche-detail-pays-view-chercheur',
  templateUrl: './projet-activite-recherche-detail-pays-view-chercheur.component.html',
  styleUrls: ['./projet-activite-recherche-detail-pays-view-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailPaysViewChercheurComponent implements OnInit {
