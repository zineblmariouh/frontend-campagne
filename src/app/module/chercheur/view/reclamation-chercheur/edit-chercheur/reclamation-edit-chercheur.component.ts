...
@Component({
  selector: 'app-reclamation-edit-chercheur',
  templateUrl: './reclamation-edit-chercheur.component.html',
  styleUrls: ['./reclamation-edit-chercheur.component.css']
})
export class ReclamationEditChercheurComponent implements OnInit {
