...
@Component({
  selector: 'app-reclamation-list-chercheur',
  templateUrl: './reclamation-list-chercheur.component.html',
  styleUrls: ['./reclamation-list-chercheur.component.css']
})
export class ReclamationListChercheurComponent implements OnInit {
   // declarations
