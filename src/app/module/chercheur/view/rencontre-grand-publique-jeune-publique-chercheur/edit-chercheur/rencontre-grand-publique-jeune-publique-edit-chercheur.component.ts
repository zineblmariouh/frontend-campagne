...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-edit-chercheur',
  templateUrl: './rencontre-grand-publique-jeune-publique-edit-chercheur.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-edit-chercheur.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueEditChercheurComponent implements OnInit {
