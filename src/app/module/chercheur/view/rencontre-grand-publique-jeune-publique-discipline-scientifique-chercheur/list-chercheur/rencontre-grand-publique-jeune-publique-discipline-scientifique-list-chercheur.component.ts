...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-discipline-scientifique-list-chercheur',
  templateUrl: './rencontre-grand-publique-jeune-publique-discipline-scientifique-list-chercheur.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-discipline-scientifique-list-chercheur.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueDisciplineScientifiqueListChercheurComponent implements OnInit {
   // declarations
