...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-enjeux-ird-list-chercheur',
  templateUrl: './rencontre-grand-publique-jeune-publique-enjeux-ird-list-chercheur.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-enjeux-ird-list-chercheur.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueEnjeuxIrdListChercheurComponent implements OnInit {
   // declarations
