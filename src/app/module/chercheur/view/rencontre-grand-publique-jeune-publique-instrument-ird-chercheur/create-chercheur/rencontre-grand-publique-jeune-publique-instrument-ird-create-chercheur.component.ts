...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-instrument-ird-create-chercheur',
  templateUrl: './rencontre-grand-publique-jeune-publique-instrument-ird-create-chercheur.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-instrument-ird-create-chercheur.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueInstrumentIrdCreateChercheurComponent implements OnInit {
