...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-periode-create-chercheur',
  templateUrl: './rencontre-grand-publique-jeune-publique-periode-create-chercheur.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-periode-create-chercheur.component.css']
})
export class RencontreGrandPubliqueJeunePubliquePeriodeCreateChercheurComponent implements OnInit {
