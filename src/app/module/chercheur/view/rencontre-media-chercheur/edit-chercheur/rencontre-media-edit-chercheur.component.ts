...
@Component({
  selector: 'app-rencontre-media-edit-chercheur',
  templateUrl: './rencontre-media-edit-chercheur.component.html',
  styleUrls: ['./rencontre-media-edit-chercheur.component.css']
})
export class RencontreMediaEditChercheurComponent implements OnInit {
