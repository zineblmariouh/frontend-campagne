...
@Component({
  selector: 'app-rencontre-media-discipline-scientifique-create-chercheur',
  templateUrl: './rencontre-media-discipline-scientifique-create-chercheur.component.html',
  styleUrls: ['./rencontre-media-discipline-scientifique-create-chercheur.component.css']
})
export class RencontreMediaDisciplineScientifiqueCreateChercheurComponent implements OnInit {
