...
@Component({
  selector: 'app-rencontre-media-discipline-scientifique-edit-chercheur',
  templateUrl: './rencontre-media-discipline-scientifique-edit-chercheur.component.html',
  styleUrls: ['./rencontre-media-discipline-scientifique-edit-chercheur.component.css']
})
export class RencontreMediaDisciplineScientifiqueEditChercheurComponent implements OnInit {
