...
@Component({
  selector: 'app-rencontre-media-enjeux-ird-create-chercheur',
  templateUrl: './rencontre-media-enjeux-ird-create-chercheur.component.html',
  styleUrls: ['./rencontre-media-enjeux-ird-create-chercheur.component.css']
})
export class RencontreMediaEnjeuxIrdCreateChercheurComponent implements OnInit {
