...
@Component({
  selector: 'app-rencontre-media-enjeux-ird-edit-chercheur',
  templateUrl: './rencontre-media-enjeux-ird-edit-chercheur.component.html',
  styleUrls: ['./rencontre-media-enjeux-ird-edit-chercheur.component.css']
})
export class RencontreMediaEnjeuxIrdEditChercheurComponent implements OnInit {
