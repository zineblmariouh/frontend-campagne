...
@Component({
  selector: 'app-rencontre-media-periode-create-chercheur',
  templateUrl: './rencontre-media-periode-create-chercheur.component.html',
  styleUrls: ['./rencontre-media-periode-create-chercheur.component.css']
})
export class RencontreMediaPeriodeCreateChercheurComponent implements OnInit {
