...
@Component({
  selector: 'app-rencontre-media-periode-list-chercheur',
  templateUrl: './rencontre-media-periode-list-chercheur.component.html',
  styleUrls: ['./rencontre-media-periode-list-chercheur.component.css']
})
export class RencontreMediaPeriodeListChercheurComponent implements OnInit {
   // declarations
