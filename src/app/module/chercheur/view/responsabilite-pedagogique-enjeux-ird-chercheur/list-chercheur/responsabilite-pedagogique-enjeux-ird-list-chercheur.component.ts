...
@Component({
  selector: 'app-responsabilite-pedagogique-enjeux-ird-list-chercheur',
  templateUrl: './responsabilite-pedagogique-enjeux-ird-list-chercheur.component.html',
  styleUrls: ['./responsabilite-pedagogique-enjeux-ird-list-chercheur.component.css']
})
export class ResponsabilitePedagogiqueEnjeuxIrdListChercheurComponent implements OnInit {
   // declarations
