...
@Component({
  selector: 'app-responsabilite-pedagogique-enjeux-ird-view-chercheur',
  templateUrl: './responsabilite-pedagogique-enjeux-ird-view-chercheur.component.html',
  styleUrls: ['./responsabilite-pedagogique-enjeux-ird-view-chercheur.component.css']
})
export class ResponsabilitePedagogiqueEnjeuxIrdViewChercheurComponent implements OnInit {
