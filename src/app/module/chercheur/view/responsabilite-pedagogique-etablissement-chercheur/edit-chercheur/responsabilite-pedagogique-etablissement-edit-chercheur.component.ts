...
@Component({
  selector: 'app-responsabilite-pedagogique-etablissement-edit-chercheur',
  templateUrl: './responsabilite-pedagogique-etablissement-edit-chercheur.component.html',
  styleUrls: ['./responsabilite-pedagogique-etablissement-edit-chercheur.component.css']
})
export class ResponsabilitePedagogiqueEtablissementEditChercheurComponent implements OnInit {
