...
@Component({
  selector: 'app-responsabilite-pedagogique-etablissement-list-chercheur',
  templateUrl: './responsabilite-pedagogique-etablissement-list-chercheur.component.html',
  styleUrls: ['./responsabilite-pedagogique-etablissement-list-chercheur.component.css']
})
export class ResponsabilitePedagogiqueEtablissementListChercheurComponent implements OnInit {
   // declarations
