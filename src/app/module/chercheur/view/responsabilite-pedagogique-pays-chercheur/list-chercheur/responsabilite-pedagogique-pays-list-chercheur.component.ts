...
@Component({
  selector: 'app-responsabilite-pedagogique-pays-list-chercheur',
  templateUrl: './responsabilite-pedagogique-pays-list-chercheur.component.html',
  styleUrls: ['./responsabilite-pedagogique-pays-list-chercheur.component.css']
})
export class ResponsabilitePedagogiquePaysListChercheurComponent implements OnInit {
   // declarations
