...
@Component({
  selector: 'app-responsabilite-pedagogique-pays-view-chercheur',
  templateUrl: './responsabilite-pedagogique-pays-view-chercheur.component.html',
  styleUrls: ['./responsabilite-pedagogique-pays-view-chercheur.component.css']
})
export class ResponsabilitePedagogiquePaysViewChercheurComponent implements OnInit {
