...
@Component({
  selector: 'app-role-comite-et-commission-evaluation-list-chercheur',
  templateUrl: './role-comite-et-commission-evaluation-list-chercheur.component.html',
  styleUrls: ['./role-comite-et-commission-evaluation-list-chercheur.component.css']
})
export class RoleComiteEtCommissionEvaluationListChercheurComponent implements OnInit {
   // declarations
