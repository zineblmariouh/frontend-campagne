...
@Component({
  selector: 'app-role-developpement-de-savoir-create-chercheur',
  templateUrl: './role-developpement-de-savoir-create-chercheur.component.html',
  styleUrls: ['./role-developpement-de-savoir-create-chercheur.component.css']
})
export class RoleDeveloppementDeSavoirCreateChercheurComponent implements OnInit {
