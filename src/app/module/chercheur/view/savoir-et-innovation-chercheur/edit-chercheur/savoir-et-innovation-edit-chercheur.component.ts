...
@Component({
  selector: 'app-savoir-et-innovation-edit-chercheur',
  templateUrl: './savoir-et-innovation-edit-chercheur.component.html',
  styleUrls: ['./savoir-et-innovation-edit-chercheur.component.css']
})
export class SavoirEtInnovationEditChercheurComponent implements OnInit {
