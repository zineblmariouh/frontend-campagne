...
@Component({
  selector: 'app-status-contrat-et-convention-create-chercheur',
  templateUrl: './status-contrat-et-convention-create-chercheur.component.html',
  styleUrls: ['./status-contrat-et-convention-create-chercheur.component.css']
})
export class StatusContratEtConventionCreateChercheurComponent implements OnInit {
