...
@Component({
  selector: 'app-status-contrat-et-convention-view-chercheur',
  templateUrl: './status-contrat-et-convention-view-chercheur.component.html',
  styleUrls: ['./status-contrat-et-convention-view-chercheur.component.css']
})
export class StatusContratEtConventionViewChercheurComponent implements OnInit {
