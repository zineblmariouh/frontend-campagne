...
@Component({
  selector: 'app-structure-oganisatrice-edit-chercheur',
  templateUrl: './structure-oganisatrice-edit-chercheur.component.html',
  styleUrls: ['./structure-oganisatrice-edit-chercheur.component.css']
})
export class StructureOganisatriceEditChercheurComponent implements OnInit {
