...
@Component({
  selector: 'app-structure-oganisatrice-list-chercheur',
  templateUrl: './structure-oganisatrice-list-chercheur.component.html',
  styleUrls: ['./structure-oganisatrice-list-chercheur.component.css']
})
export class StructureOganisatriceListChercheurComponent implements OnInit {
   // declarations
