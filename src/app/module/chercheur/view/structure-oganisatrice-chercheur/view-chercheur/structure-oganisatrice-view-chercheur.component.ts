...
@Component({
  selector: 'app-structure-oganisatrice-view-chercheur',
  templateUrl: './structure-oganisatrice-view-chercheur.component.html',
  styleUrls: ['./structure-oganisatrice-view-chercheur.component.css']
})
export class StructureOganisatriceViewChercheurComponent implements OnInit {
