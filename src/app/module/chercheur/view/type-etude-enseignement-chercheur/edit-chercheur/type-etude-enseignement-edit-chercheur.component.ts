...
@Component({
  selector: 'app-type-etude-enseignement-edit-chercheur',
  templateUrl: './type-etude-enseignement-edit-chercheur.component.html',
  styleUrls: ['./type-etude-enseignement-edit-chercheur.component.css']
})
export class TypeEtudeEnseignementEditChercheurComponent implements OnInit {
