...
@Component({
  selector: 'app-type-etude-enseignement-view-chercheur',
  templateUrl: './type-etude-enseignement-view-chercheur.component.html',
  styleUrls: ['./type-etude-enseignement-view-chercheur.component.css']
})
export class TypeEtudeEnseignementViewChercheurComponent implements OnInit {
