...
@Component({
  selector: 'app-type-expertise-evaluation-comite-et-commission-evaluation-list-chercheur',
  templateUrl: './type-expertise-evaluation-comite-et-commission-evaluation-list-chercheur.component.html',
  styleUrls: ['./type-expertise-evaluation-comite-et-commission-evaluation-list-chercheur.component.css']
})
export class TypeExpertiseEvaluationComiteEtCommissionEvaluationListChercheurComponent implements OnInit {
   // declarations
