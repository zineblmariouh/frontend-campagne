...
@Component({
  selector: 'app-type-expertise-evaluation-comite-et-commission-evaluation-view-chercheur',
  templateUrl: './type-expertise-evaluation-comite-et-commission-evaluation-view-chercheur.component.html',
  styleUrls: ['./type-expertise-evaluation-comite-et-commission-evaluation-view-chercheur.component.css']
})
export class TypeExpertiseEvaluationComiteEtCommissionEvaluationViewChercheurComponent implements OnInit {
