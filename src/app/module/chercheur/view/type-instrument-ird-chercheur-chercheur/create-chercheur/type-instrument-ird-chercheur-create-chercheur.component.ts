...
@Component({
  selector: 'app-type-instrument-ird-chercheur-create-chercheur',
  templateUrl: './type-instrument-ird-chercheur-create-chercheur.component.html',
  styleUrls: ['./type-instrument-ird-chercheur-create-chercheur.component.css']
})
export class TypeInstrumentIrdChercheurCreateChercheurComponent implements OnInit {
