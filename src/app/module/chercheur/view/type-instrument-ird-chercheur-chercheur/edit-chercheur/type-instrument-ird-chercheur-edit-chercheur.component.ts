...
@Component({
  selector: 'app-type-instrument-ird-chercheur-edit-chercheur',
  templateUrl: './type-instrument-ird-chercheur-edit-chercheur.component.html',
  styleUrls: ['./type-instrument-ird-chercheur-edit-chercheur.component.css']
})
export class TypeInstrumentIrdChercheurEditChercheurComponent implements OnInit {
