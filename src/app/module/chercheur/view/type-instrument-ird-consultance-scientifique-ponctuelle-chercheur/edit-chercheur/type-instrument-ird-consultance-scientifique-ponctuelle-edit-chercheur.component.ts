...
@Component({
  selector: 'app-type-instrument-ird-consultance-scientifique-ponctuelle-edit-chercheur',
  templateUrl: './type-instrument-ird-consultance-scientifique-ponctuelle-edit-chercheur.component.html',
  styleUrls: ['./type-instrument-ird-consultance-scientifique-ponctuelle-edit-chercheur.component.css']
})
export class TypeInstrumentIrdConsultanceScientifiquePonctuelleEditChercheurComponent implements OnInit {
