...
@Component({
  selector: 'app-type-participation-create-chercheur',
  templateUrl: './type-participation-create-chercheur.component.html',
  styleUrls: ['./type-participation-create-chercheur.component.css']
})
export class TypeParticipationCreateChercheurComponent implements OnInit {
