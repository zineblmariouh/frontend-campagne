...
@Component({
  selector: 'app-type-participation-edit-chercheur',
  templateUrl: './type-participation-edit-chercheur.component.html',
  styleUrls: ['./type-participation-edit-chercheur.component.css']
})
export class TypeParticipationEditChercheurComponent implements OnInit {
