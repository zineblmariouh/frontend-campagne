...
@Component({
  selector: 'app-type-participation-view-chercheur',
  templateUrl: './type-participation-view-chercheur.component.html',
  styleUrls: ['./type-participation-view-chercheur.component.css']
})
export class TypeParticipationViewChercheurComponent implements OnInit {
