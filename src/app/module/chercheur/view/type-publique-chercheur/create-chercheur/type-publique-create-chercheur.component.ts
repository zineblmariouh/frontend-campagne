...
@Component({
  selector: 'app-type-publique-create-chercheur',
  templateUrl: './type-publique-create-chercheur.component.html',
  styleUrls: ['./type-publique-create-chercheur.component.css']
})
export class TypePubliqueCreateChercheurComponent implements OnInit {
