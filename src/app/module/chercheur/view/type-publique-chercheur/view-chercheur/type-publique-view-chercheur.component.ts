...
@Component({
  selector: 'app-type-publique-view-chercheur',
  templateUrl: './type-publique-view-chercheur.component.html',
  styleUrls: ['./type-publique-view-chercheur.component.css']
})
export class TypePubliqueViewChercheurComponent implements OnInit {
