...
@Component({
  selector: 'app-type-publique-rencontre-grand-publique-jeune-publique-list-chercheur',
  templateUrl: './type-publique-rencontre-grand-publique-jeune-publique-list-chercheur.component.html',
  styleUrls: ['./type-publique-rencontre-grand-publique-jeune-publique-list-chercheur.component.css']
})
export class TypePubliqueRencontreGrandPubliqueJeunePubliqueListChercheurComponent implements OnInit {
   // declarations
