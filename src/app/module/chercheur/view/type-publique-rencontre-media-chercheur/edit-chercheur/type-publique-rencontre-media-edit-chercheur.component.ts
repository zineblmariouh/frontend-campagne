...
@Component({
  selector: 'app-type-publique-rencontre-media-edit-chercheur',
  templateUrl: './type-publique-rencontre-media-edit-chercheur.component.html',
  styleUrls: ['./type-publique-rencontre-media-edit-chercheur.component.css']
})
export class TypePubliqueRencontreMediaEditChercheurComponent implements OnInit {
