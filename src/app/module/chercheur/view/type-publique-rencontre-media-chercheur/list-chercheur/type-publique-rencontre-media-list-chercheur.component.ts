...
@Component({
  selector: 'app-type-publique-rencontre-media-list-chercheur',
  templateUrl: './type-publique-rencontre-media-list-chercheur.component.html',
  styleUrls: ['./type-publique-rencontre-media-list-chercheur.component.css']
})
export class TypePubliqueRencontreMediaListChercheurComponent implements OnInit {
   // declarations
