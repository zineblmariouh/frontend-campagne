...
@Component({
  selector: 'app-type-savoir-developpement-de-savoir-et-innovation-scientifique-create-chercheur',
  templateUrl: './type-savoir-developpement-de-savoir-et-innovation-scientifique-create-chercheur.component.html',
  styleUrls: ['./type-savoir-developpement-de-savoir-et-innovation-scientifique-create-chercheur.component.css']
})
export class TypeSavoirDeveloppementDeSavoirEtInnovationScientifiqueCreateChercheurComponent implements OnInit {
