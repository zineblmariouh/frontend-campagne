...
@Component({
  selector: 'app-type-savoir-developpement-de-savoir-et-innovation-scientifique-list-chercheur',
  templateUrl: './type-savoir-developpement-de-savoir-et-innovation-scientifique-list-chercheur.component.html',
  styleUrls: ['./type-savoir-developpement-de-savoir-et-innovation-scientifique-list-chercheur.component.css']
})
export class TypeSavoirDeveloppementDeSavoirEtInnovationScientifiqueListChercheurComponent implements OnInit {
   // declarations
