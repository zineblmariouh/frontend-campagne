...
@Component({
  selector: 'app-type-utilisateur-savoir-concu-view-chercheur',
  templateUrl: './type-utilisateur-savoir-concu-view-chercheur.component.html',
  styleUrls: ['./type-utilisateur-savoir-concu-view-chercheur.component.css']
})
export class TypeUtilisateurSavoirConcuViewChercheurComponent implements OnInit {
