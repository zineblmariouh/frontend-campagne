...
@Component({
  selector: 'app-vie-institutionnelle-edit-chercheur',
  templateUrl: './vie-institutionnelle-edit-chercheur.component.html',
  styleUrls: ['./vie-institutionnelle-edit-chercheur.component.css']
})
export class VieInstitutionnelleEditChercheurComponent implements OnInit {
