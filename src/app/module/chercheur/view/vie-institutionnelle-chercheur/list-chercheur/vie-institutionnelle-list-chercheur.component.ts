...
@Component({
  selector: 'app-vie-institutionnelle-list-chercheur',
  templateUrl: './vie-institutionnelle-list-chercheur.component.html',
  styleUrls: ['./vie-institutionnelle-list-chercheur.component.css']
})
export class VieInstitutionnelleListChercheurComponent implements OnInit {
   // declarations
...
navigateToVieInstitutionnelleCreate(){
this.router.navigate(['/app/chercheur/vieInstitutionnelle/create']);
}
         ...
         if(isPermistted){
          this.vieInstitutionnelleService.findByIdWithAssociatedList(vieInstitutionnelle).subscribe(res => {
           this.selectedVieInstitutionnelle = res;
            this.navigateToVieInstitutionnelleCreate() ;
          });
        }else{
