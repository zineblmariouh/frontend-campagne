...
@Component({
  selector: 'app-vie-institutionnelle-detail-edit-chercheur',
  templateUrl: './vie-institutionnelle-detail-edit-chercheur.component.html',
  styleUrls: ['./vie-institutionnelle-detail-edit-chercheur.component.css']
})
export class VieInstitutionnelleDetailEditChercheurComponent implements OnInit {
