...
@Component({
  selector: 'app-vie-institutionnelle-detail-list-chercheur',
  templateUrl: './vie-institutionnelle-detail-list-chercheur.component.html',
  styleUrls: ['./vie-institutionnelle-detail-list-chercheur.component.css']
})
export class VieInstitutionnelleDetailListChercheurComponent implements OnInit {
   // declarations
