...
@Component({
  selector: 'app-vie-institutionnelle-detail-etablissement-view-chercheur',
  templateUrl: './vie-institutionnelle-detail-etablissement-view-chercheur.component.html',
  styleUrls: ['./vie-institutionnelle-detail-etablissement-view-chercheur.component.css']
})
export class VieInstitutionnelleDetailEtablissementViewChercheurComponent implements OnInit {
