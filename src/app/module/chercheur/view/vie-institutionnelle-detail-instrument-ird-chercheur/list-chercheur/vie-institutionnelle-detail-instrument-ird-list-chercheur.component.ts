...
@Component({
  selector: 'app-vie-institutionnelle-detail-instrument-ird-list-chercheur',
  templateUrl: './vie-institutionnelle-detail-instrument-ird-list-chercheur.component.html',
  styleUrls: ['./vie-institutionnelle-detail-instrument-ird-list-chercheur.component.css']
})
export class VieInstitutionnelleDetailInstrumentIrdListChercheurComponent implements OnInit {
   // declarations
