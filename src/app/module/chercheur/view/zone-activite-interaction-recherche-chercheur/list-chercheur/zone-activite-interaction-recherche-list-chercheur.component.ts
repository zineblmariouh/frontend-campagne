...
@Component({
  selector: 'app-zone-activite-interaction-recherche-list-chercheur',
  templateUrl: './zone-activite-interaction-recherche-list-chercheur.component.html',
  styleUrls: ['./zone-activite-interaction-recherche-list-chercheur.component.css']
})
export class ZoneActiviteInteractionRechercheListChercheurComponent implements OnInit {
   // declarations
