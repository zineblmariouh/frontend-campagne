...
@Component({
  selector: 'app-zone-geographique-conseils-scientifique-list-chercheur',
  templateUrl: './zone-geographique-conseils-scientifique-list-chercheur.component.html',
  styleUrls: ['./zone-geographique-conseils-scientifique-list-chercheur.component.css']
})
export class ZoneGeographiqueConseilsScientifiqueListChercheurComponent implements OnInit {
   // declarations
