...
@Component({
  selector: 'app-zone-geographique-consultance-scientifique-ponctuelle-edit-chercheur',
  templateUrl: './zone-geographique-consultance-scientifique-ponctuelle-edit-chercheur.component.html',
  styleUrls: ['./zone-geographique-consultance-scientifique-ponctuelle-edit-chercheur.component.css']
})
export class ZoneGeographiqueConsultanceScientifiquePonctuelleEditChercheurComponent implements OnInit {
