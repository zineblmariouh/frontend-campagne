...
@Component({
  selector: 'app-zone-geographique-consultance-scientifique-ponctuelle-view-chercheur',
  templateUrl: './zone-geographique-consultance-scientifique-ponctuelle-view-chercheur.component.html',
  styleUrls: ['./zone-geographique-consultance-scientifique-ponctuelle-view-chercheur.component.css']
})
export class ZoneGeographiqueConsultanceScientifiquePonctuelleViewChercheurComponent implements OnInit {
